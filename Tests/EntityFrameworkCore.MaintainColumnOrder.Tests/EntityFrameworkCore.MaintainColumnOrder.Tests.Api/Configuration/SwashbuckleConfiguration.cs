...
using EntityFrameworkCore.MaintainColumnOrder.Tests.Api.Filters;
using EntityFrameworkCore.MaintainColumnOrder.Tests.Application;
using EntityFrameworkCore.MaintainColumnOrder.Tests.Domain.Common.Exceptions;
...
namespace EntityFrameworkCore.MaintainColumnOrder.Tests.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("EntityFrameworkCore.MaintainColumnOrder.Tests API");
