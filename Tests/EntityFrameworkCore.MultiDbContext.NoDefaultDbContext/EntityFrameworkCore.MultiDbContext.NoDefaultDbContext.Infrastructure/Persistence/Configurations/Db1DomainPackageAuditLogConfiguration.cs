...
{
    public class Db1DomainPackageAuditLogConfiguration : IEntityTypeConfiguration<Db1DomainPackageAuditLog>
    {
        public void Configure(EntityTypeBuilder<Db1DomainPackageAuditLog> builder)
        {
