...
namespace EntityFrameworkCore.Repositories.TestApplication.Application.OperationInvocation.CustomRepoOperationParams3Async
{
    ...
    public class CustomRepoOperationParams3AsyncQueryHandler : IRequestHandler<CustomRepoOperationParams3AsyncQuery, SpResultDto>
    {
        private readonly ICustomRepository _customRepository;
        private readonly IMapper _mapper;

        [IntentManaged(Mode.Merge)]
        public CustomRepoOperationParams3AsyncQueryHandler(ICustomRepository customRepository, IMapper mapper)
        {
        ...
        public async Task<SpResultDto> Handle(
            CustomRepoOperationParams3AsyncQuery request,
