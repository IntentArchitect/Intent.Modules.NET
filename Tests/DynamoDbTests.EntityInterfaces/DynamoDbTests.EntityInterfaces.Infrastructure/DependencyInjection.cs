...
using DynamoDbTests.EntityInterfaces.Infrastructure.Configuration;
using DynamoDbTests.EntityInterfaces.Infrastructure.Persistence;
using DynamoDbTests.EntityInterfaces.Infrastructure.Repositories;
using DynamoDbTests.EntityInterfaces.Infrastructure.Repositories.Folder;
using DynamoDbTests.EntityInterfaces.Infrastructure.Repositories.Throughput;
using DynamoDbTests.EntityInterfaces.Infrastructure.Services;
...
namespace DynamoDbTests.EntityInterfaces.Infrastructure
{
