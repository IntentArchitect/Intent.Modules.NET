...
namespace EntityFrameworkCore.Repositories.TestApplication.Application.CustomRepoOperationInvocation.Operation_Params3_ReturnsE_Collection0
{
    ...
    public class Operation_Params3_ReturnsE_Collection0QueryHandler : IRequestHandler<Operation_Params3_ReturnsE_Collection0Query, AggregateRoot1Dto>
    {
        ...
        public Operation_Params3_ReturnsE_Collection0QueryHandler(ICustomRepository customRepository, IMapper mapper)
        {
        ...
        {
            var result = _customRepository.Operation_Params3_ReturnsE_Collection0(new SpParameter(
