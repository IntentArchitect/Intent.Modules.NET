...
namespace Intent.Modules.VisualStudio.Projects.Api
{
    public static class ConsoleAppNETFrameworkModelExtensions
    {
        ...
        public static ProjectOptions GetProjectOptions(this ConsoleAppNETFrameworkModel model)
        {
            var stereotype = model.GetStereotype("Project Options");
            return stereotype != null ? new ProjectOptions(stereotype) : null;
        }

        public static bool HasProjectOptions(this ConsoleAppNETFrameworkModel model)
        {
