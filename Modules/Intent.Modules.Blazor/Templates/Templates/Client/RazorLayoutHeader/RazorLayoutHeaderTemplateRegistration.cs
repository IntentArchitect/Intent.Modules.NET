...
namespace Intent.Modules.Blazor.Templates.Templates.Client.RazorLayoutHeader
{
    ...
    public class RazorLayoutHeaderTemplateRegistration : FilePerModelTemplateRegistration<LayoutHeaderModel>
    {
        private readonly IMetadataManager _metadataManager;

        public RazorLayoutHeaderTemplateRegistration(IMetadataManager metadataManager)
        {
            _metadataManager = metadataManager;
        }

        public override string TemplateId => RazorLayoutHeaderTemplate.TemplateId;

        [IntentManaged(Mode.Fully)]
        public override ITemplate CreateTemplateInstance(IOutputTarget outputTarget, LayoutHeaderModel model)
        {
            return new RazorLayoutHeaderTemplate(outputTarget, model);
        }
