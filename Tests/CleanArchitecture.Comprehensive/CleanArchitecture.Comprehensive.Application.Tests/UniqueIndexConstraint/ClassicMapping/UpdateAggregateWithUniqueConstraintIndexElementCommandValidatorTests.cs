...
{
    public class UpdateAggregateWithUniqueConstraintIndexElementCommandValidatorTests
    {
        ...
        public async Task Validate_WithValidCommand_PassesValidation(UpdateAggregateWithUniqueConstraintIndexElementCommand testCommand)
        {
            // Arrange
        ...
        {
            var fixture = new Fixture();
            fixture.Customize<UpdateAggregateWithUniqueConstraintIndexElementCommand>(comp => comp
            ...
            fixture.Customize<UpdateAggregateWithUniqueConstraintIndexElementCommand>(comp => comp
                ...
                .With(x => x.CompUniqueFieldA, () => $"{string.Join(string.Empty, fixture.CreateMany<char>(255))}")
                .With(x => x.CompUniqueFieldB, () => $"{string.Join(string.Empty, fixture.CreateMany<char>(255))}"));
            testCommand = fixture.Create<UpdateAggregateWithUniqueConstraintIndexElementCommand>();
