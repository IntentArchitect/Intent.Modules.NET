...
#line hidden
        ...
        public override string TransformText()
        {
            ...
            #line 13 "C:\Dev\Intent.Modules.NET\Modules\Intent.Modules.Eventing.MassTransit\Templates\WrapperConsumer\WrapperConsumerTemplate.tt"
            ...
            #line 15 "C:\Dev\Intent.Modules.NET\Modules\Intent.Modules.Eventing.MassTransit\Templates\WrapperConsumer\WrapperConsumerTemplate.tt"
            ...
            #line 20 "C:\Dev\Intent.Modules.NET\Modules\Intent.Modules.Eventing.MassTransit\Templates\WrapperConsumer\WrapperConsumerTemplate.tt"
            ...
            #line 25 "C:\Dev\Intent.Modules.NET\Modules\Intent.Modules.Eventing.MassTransit\Templates\WrapperConsumer\WrapperConsumerTemplate.tt"
            ...
            #line default
            #line hidden
            this.Write(";            \r\n            await handler.HandleAsync(context.Message, context.Can" +
                    "cellationToken);");
            
            #line 29 "C:\Dev\Intent.Modules.NET\Modules\Intent.Modules.Eventing.MassTransit\Templates\WrapperConsumer\WrapperConsumerTemplate.tt"
            ...
            #line 33 "C:\Dev\Intent.Modules.NET\Modules\Intent.Modules.Eventing.MassTransit\Templates\WrapperConsumer\WrapperConsumerTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(ClassName));
            ...
            this.Write("<THandler, TMessage>>\r\n        where TMessage : class\r\n        where THandler : I" +
                    "IntegrationEventHandler<TMessage>\r\n    {\r\n        private readonly IServiceProvi" +
                    "der _serviceProvider;\r\n\r\n        public ");
            
            #line 39 "C:\Dev\Intent.Modules.NET\Modules\Intent.Modules.Eventing.MassTransit\Templates\WrapperConsumer\WrapperConsumerTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(ClassName));
            
            #line default
            #line hidden
            this.Write("Definition(IServiceProvider serviceProvider)\r\n        {\r\n            _serviceProv" +
                    "ider = serviceProvider;\r\n        }\r\n\r\n        protected override void ConfigureC" +
                    "onsumer(IReceiveEndpointConfigurator endpointConfigurator, IConsumerConfigurator" +
                    "<");
            ...
            #line 45 "C:\Dev\Intent.Modules.NET\Modules\Intent.Modules.Eventing.MassTransit\Templates\WrapperConsumer\WrapperConsumerTemplate.tt"
