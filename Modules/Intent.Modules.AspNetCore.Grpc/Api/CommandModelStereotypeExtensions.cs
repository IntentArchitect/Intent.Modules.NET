...
namespace Intent.Modules.AspNetCore.Grpc.Api
{
    ...
    {
        public static ExposeWithGRPC GetExposeWithGRPC(this CommandModel model)
        {
        ...
        public static bool HasExposeWithGRPC(this CommandModel model)
        {
            return model.HasStereotype(ExposeWithGRPC.DefinitionId);
        }

        public static bool TryGetExposeWithGRPC(this CommandModel model, out ExposeWithGRPC stereotype)
        {
