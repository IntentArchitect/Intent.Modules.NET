...
namespace EntityFrameworkCore.MySql.Domain.Repositories.TPH.InheritanceAssociations
{
    ...
    public interface ITPH_DerivedClassForAbstractAssociatedRepository : IEFRepository<TPH_DerivedClassForAbstractAssociated, TPH_DerivedClassForAbstractAssociated>
    {
        ...
        [IntentManaged(Mode.Fully)]
        Task<TPH_DerivedClassForAbstractAssociated?> FindByIdAsync(Guid id, Func<IQueryable<TPH_DerivedClassForAbstractAssociated>, IQueryable<TPH_DerivedClassForAbstractAssociated>> queryOptions, CancellationToken cancellationToken = default);
        [IntentManaged(Mode.Fully)]
