...
namespace AdvancedMappingCrud.RichDomain.SeparatedEntityState.Tests.Application.Hierarchy.CreateChild2
{
    ...
    public class CreateChild2CommandHandler : IRequestHandler<CreateChild2Command, Guid>
    {
        ...
        public async Task<Guid> Handle(CreateChild2Command request, CancellationToken cancellationToken)
        {
            ...
            {
                ChildParentExcluded = request.Dto.ChildName,
                ChildParentExcluded = request.Dto.ParentAge
            };
