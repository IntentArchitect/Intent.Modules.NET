...
{
    public class CompoundIndexEntityMultiParentMapping : IMongoMappingConfiguration<CompoundIndexEntityMultiParent>
    {
        public string CollectionName => "CompoundIndexEntityMultiParents";

        public void RegisterCollectionMap()
        {
            if (!BsonClassMap.IsClassMapRegistered(typeof(CompoundIndexEntityMultiParent)))
            {
                BsonClassMap.RegisterClassMap<CompoundIndexEntityMultiParent>(
                    mapping =>
                    {
                        mapping.AutoMap();
