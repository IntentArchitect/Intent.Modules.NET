...
namespace AspNetCoreCleanArchitecture.Sample.Application.Common.Behaviours
{
        ...
        where TRequest : notnull
    {
        ...
        public Task Process(TRequest request, CancellationToken cancellationToken)
        {
            ...
            {
                _logger.LogInformation("Intent.Sample.AspNetCore.CleanArchitecture Request: {Name} {@UserId} {@UserName} {@Request}", requestName, userId, userName, request);
            }
            else
            {
                _logger.LogInformation("Intent.Sample.AspNetCore.CleanArchitecture Request: {Name} {@UserId} {@UserName}", requestName, userId, userName);
            }
