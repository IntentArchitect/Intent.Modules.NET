...
namespace Intent.Eventing.MassTransit.RequestResponse.Api
{
    ...
    {
        public static MessageRequestEndpoint GetMessageRequestEndpoint(this QueryModel model)
        {
        ...
        public static bool HasMessageRequestEndpoint(this QueryModel model)
        {
            return model.HasStereotype("5150384d-18a3-4c7e-a716-599e6658abde");
        }

        public static bool TryGetMessageRequestEndpoint(this QueryModel model, out MessageRequestEndpoint stereotype)
        {
