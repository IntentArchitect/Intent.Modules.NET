using AzureIdentityManagement.Api.Configuration;
using AzureIdentityManagement.Api.Filters;
using AzureIdentityManagement.Api.Logging;
using AzureIdentityManagement.Api.Services;
using AzureIdentityManagement.Application;
using AzureIdentityManagement.Infrastructure;
...
namespace AzureIdentityManagement.Api
{
