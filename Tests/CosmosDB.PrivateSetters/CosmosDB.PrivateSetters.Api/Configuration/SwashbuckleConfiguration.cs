...
using CosmosDB.PrivateSetters.Api.Filters;
using CosmosDB.PrivateSetters.Application;
...
namespace CosmosDB.PrivateSetters.Api.Configuration
{
            ...
            services.AddSwaggerGen(
                options =>
                {
                    options.SwaggerDoc(
                        ...
                        {
                            Version = "v1",
                            Title = "CosmosDB.PrivateSetters API"
                        });
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.SwaggerEndpoint("/swagger/v1/swagger.json", "CosmosDB.PrivateSetters API V1");
                    options.OAuthAppName("CosmosDB.PrivateSetters API");
