...
namespace Publish.CleanArch.MassTransit.OutboxEF.TestApplication.Application.Common.Behaviours
{
        ...
        where TRequest : notnull
    {
        ...
        public Task Process(TRequest request, CancellationToken cancellationToken)
        {
            ...
            {
                _logger.LogInformation("Publish.CleanArch.MassTransit.OutboxEF.TestApplication Request: {Name} {@UserId} {@UserName} {@Request}", requestName, userId, userName, request);
            }
            else
            {
                _logger.LogInformation("Publish.CleanArch.MassTransit.OutboxEF.TestApplication Request: {Name} {@UserId} {@UserName}", requestName, userId, userName);
            }
