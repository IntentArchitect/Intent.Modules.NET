...
namespace Intent.Modules.IntegrationTesting.Templates.ProxyServiceContract
{
    [IntentManaged(Mode.Ignore)]
    public partial class ProxyServiceContractTemplate : CSharpTemplateBase<IServiceProxyModel>, ICSharpFileBuilderTemplate
    {
        public const string TemplateId = "Intent.IntegrationTesting.ProxyServiceContract";
