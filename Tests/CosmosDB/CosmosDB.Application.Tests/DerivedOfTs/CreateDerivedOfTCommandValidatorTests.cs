...
{
    public class CreateDerivedOfTCommandValidatorTests
    {
        public static IEnumerable<object[]> GetSuccessfulResultTestData()
        {
            var fixture = new Fixture();
            var testCommand = fixture.Create<CreateDerivedOfTCommand>();
            yield return new object[] { testCommand };
        }

        [Theory]
        [MemberData(nameof(GetSuccessfulResultTestData))]
        public async Task Validate_WithValidCommand_PassesValidation(CreateDerivedOfTCommand testCommand)
        {
            // Arrange
        ...
        {
            var fixture = new Fixture();
            fixture.Customize<CreateDerivedOfTCommand>(comp => comp.With(x => x.DerivedAttribute, () => default));
            var testCommand = fixture.Create<CreateDerivedOfTCommand>();
        ...
        public async Task Validate_WithInvalidCommand_FailsValidation(
            CreateDerivedOfTCommand testCommand,
        ...
        private ValidationBehaviour<CreateDerivedOfTCommand, string> GetValidationBehaviour()
        {
            return new ValidationBehaviour<CreateDerivedOfTCommand, string>(new[] { new CreateDerivedOfTCommandValidator() });
        }
    }
}