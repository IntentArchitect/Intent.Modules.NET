...
using EntityFramework.SynchronousRepositories.Api.Filters;
using EntityFramework.SynchronousRepositories.Application;
using EntityFramework.SynchronousRepositories.Domain.Common.Exceptions;
...
namespace EntityFramework.SynchronousRepositories.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("EntityFramework.SynchronousRepositories API");
