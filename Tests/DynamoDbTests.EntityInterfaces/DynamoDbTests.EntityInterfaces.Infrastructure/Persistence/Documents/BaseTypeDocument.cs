...
namespace DynamoDbTests.EntityInterfaces.Infrastructure.Persistence.Documents
{
    ...
    internal class BaseTypeDocument : IDynamoDBDocument<IBaseType, BaseType, BaseTypeDocument>
    {
        [DynamoDBHashKey]
        ...
        public BaseTypeDocument PopulateFromEntity(IBaseType entity, Func<object, int?> getVersion)
        {
            Id = entity.Id;
        ...
        public static BaseTypeDocument? FromEntity(IBaseType? entity, Func<object, int?> getVersion)
        {
            if (entity is null)
            {
                return null;
