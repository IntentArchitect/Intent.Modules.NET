...
using SqlDbProject.Infrastructure.Persistence.Configurations.PK;
...
namespace SqlDbProject.Infrastructure.Persistence
{
    public class ApplicationDbContext : DbContext, IUnitOfWork
    {
        ...
        public DbSet<AutoGeneratedKey> AutoGeneratedKeys { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfiguration(new AutoGeneratedKeyConfiguration());
        }
