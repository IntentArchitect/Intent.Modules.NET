...
namespace CosmosDB.EntityInterfaces.Domain.Repositories.Throughput
{
    ...
    public interface IAutoscaleRepository : ICosmosDBRepository<IAutoscale, IAutoscaleDocument>
    {
        [IntentManaged(Mode.Fully)]
        Task<IAutoscale?> FindByIdAsync(string id, CancellationToken cancellationToken = default);
    }
}