...
using AdvancedMappingCrud.Repositories.Tests.Application.Implementation.ManyToMany;
using AdvancedMappingCrud.Repositories.Tests.Application.Implementation.OperationMapping;
using AdvancedMappingCrud.Repositories.Tests.Application.Implementation.ServiceToServiceInvocation;
...
namespace AdvancedMappingCrud.Repositories.Tests.Application
{
    public static class DependencyInjection
    {
        public static IServiceCollection AddApplication(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddTransient<IExposedStoredProcService, ExposedStoredProcService>();
            services.AddTransient<IStoredProcService, StoredProcService>();
