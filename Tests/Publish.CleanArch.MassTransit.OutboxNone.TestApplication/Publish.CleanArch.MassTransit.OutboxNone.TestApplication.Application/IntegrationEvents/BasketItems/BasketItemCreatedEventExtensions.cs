...
{
    public static class BasketItemCreatedEventExtensions
    {
        public static BasketItemCreatedEvent MapToBasketItemCreatedEvent(this BasketItem projectFrom)
        {
            return new BasketItemCreatedEvent
            {
                Id = projectFrom.Id,
