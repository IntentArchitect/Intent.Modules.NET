...
#line hidden
        ...
        public override string TransformText()
        {
            ...
            #line 17 "C:\Dev\Intent.Modules.NET\Modules\Intent.Modules.Application.DependencyInjection\Templates\DependencyInjection\DependencyInjectionTemplate.tt"
            ...
            #line 21 "C:\Dev\Intent.Modules.NET\Modules\Intent.Modules.Application.DependencyInjection\Templates\DependencyInjection\DependencyInjectionTemplate.tt"
  ...
  foreach(var registration in _containerRegistrationRequests.OrderBy(x => x.Priority)) { 
    ...
    foreach (var registration in _serviceConfigurationRequests.OrderBy(x => x.Priority))
    {
            ...
            #line 30 "C:\Dev\Intent.Modules.NET\Modules\Intent.Modules.Application.DependencyInjection\Templates\DependencyInjection\DependencyInjectionTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(ServiceConfigurationRegistration(registration)));
            
            #line default
            #line hidden
            this.Write("        \r\n");
            
            #line 31 "C:\Dev\Intent.Modules.NET\Modules\Intent.Modules.Application.DependencyInjection\Templates\DependencyInjection\DependencyInjectionTemplate.tt"
