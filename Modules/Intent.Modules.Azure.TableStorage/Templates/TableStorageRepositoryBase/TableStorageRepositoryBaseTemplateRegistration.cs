...
namespace Intent.Modules.Azure.TableStorage.Templates.TableStorageRepositoryBase
{
    ...
    public class TableStorageRepositoryBaseTemplateRegistration : SingleFileListModelTemplateRegistration<ClassModel>
    {
        private readonly IMetadataManager _metadataManager;

        public TableStorageRepositoryBaseTemplateRegistration(IMetadataManager metadataManager)
        {
            _metadataManager = metadataManager;
        }

        public override string TemplateId => TableStorageRepositoryBaseTemplate.TemplateId;

        [IntentManaged(Mode.Fully)]
        public override ITemplate CreateTemplateInstance(IOutputTarget outputTarget, IList<ClassModel> model)
        {
            return new TableStorageRepositoryBaseTemplate(outputTarget, model);
        }
