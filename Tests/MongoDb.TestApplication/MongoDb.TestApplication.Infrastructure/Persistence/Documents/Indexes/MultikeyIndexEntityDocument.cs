...
{
    [BsonDiscriminator(nameof(MultikeyIndexEntity), Required = true)]
    internal class MultikeyIndexEntityDocument : IMultikeyIndexEntityDocument, IMongoDbDocument<MultikeyIndexEntity, MultikeyIndexEntityDocument, string>
    {
        ...
        public static Expression<Func<MultikeyIndexEntityDocument, bool>> GetIdFilterPredicate(string id)
        {
            return x => x.Id == id;
        }

        public static Expression<Func<MultikeyIndexEntityDocument, bool>> GetIdsFilterPredicate(string[] ids)
        {
