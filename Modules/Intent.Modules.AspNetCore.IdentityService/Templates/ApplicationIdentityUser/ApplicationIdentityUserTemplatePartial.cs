...
namespace Intent.Modules.AspNetCore.IdentityService.Templates.ApplicationIdentityUser
{
    ...
    {
        public const string TemplateId = "Intent.AspNetCore.IdentityService.ApplicationIdentityUser";
        ...
        public ApplicationIdentityUserTemplate(IOutputTarget outputTarget, object model = null) : base(TemplateId, outputTarget, model)
        {
            ...
            AddNugetDependency(NugetPackages.MicrosoftExtensionsIdentityStores(OutputTarget.GetProject()));
