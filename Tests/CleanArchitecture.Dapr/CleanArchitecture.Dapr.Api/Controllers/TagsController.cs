...
using CleanArchitecture.Dapr.Application.Tags;
using CleanArchitecture.Dapr.Application.Tags.CreateTag;
using CleanArchitecture.Dapr.Application.Tags.DeleteTag;
using CleanArchitecture.Dapr.Application.Tags.GetTagById;
using CleanArchitecture.Dapr.Application.Tags.GetTags;
using CleanArchitecture.Dapr.Application.Tags.UpdateTag;
...
namespace CleanArchitecture.Dapr.Api.Controllers
{
    ...
    public class TagsController : ControllerBase
    {
        ...
        /// <response code="400">One or more validation errors have occurred.</response>
        /// <response code="404">Can't find an TagDto with the parameters provided.</response>
        [HttpGet("api/tags/{id}")]
