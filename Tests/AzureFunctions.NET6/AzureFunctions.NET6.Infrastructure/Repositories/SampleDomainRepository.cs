...
namespace AzureFunctions.NET6.Infrastructure.Repositories
{
    ...
    public class SampleDomainRepository : RepositoryBase<SampleDomain, SampleDomain, ApplicationDbContext>, ISampleDomainRepository
    {
        ...
        public async Task<SampleDomain> FindByIdAsync(
            Guid id,
            Func<IQueryable<SampleDomain>, IQueryable<SampleDomain>> queryOptions,
            CancellationToken cancellationToken = default)
        {
