...
namespace AdvancedMappingCrud.Repositories.Tests.Domain.Repositories
{
    ...
    public interface IFuneralCoverQuoteRepository : IEFRepository<FuneralCoverQuote, FuneralCoverQuote>
    {
        ...
        [IntentManaged(Mode.Fully)]
        Task<FuneralCoverQuote?> FindByIdAsync(Guid id, Func<IQueryable<FuneralCoverQuote>, IQueryable<FuneralCoverQuote>> queryOptions, CancellationToken cancellationToken = default);
        [IntentManaged(Mode.Fully)]
