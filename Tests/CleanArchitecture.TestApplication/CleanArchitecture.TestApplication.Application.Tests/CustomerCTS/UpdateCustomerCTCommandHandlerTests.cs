...
{
    public class UpdateCustomerCTCommandHandlerTests
    {
        public static IEnumerable<object[]> GetSuccessfulResultTestData()
        {
            ...
            fixture.Customize<UpdateCustomerCTCommand>(comp => comp.With(x => x.Id, existingEntity.Id));
            ...
            CustomerCT existingEntity)
        {
            ...
            var sut = new UpdateCustomerCTCommandHandler(repository);

            // Act
            await sut.Handle(testCommand, CancellationToken.None);

            // Assert
            CustomerCTAssertions.AssertEquivalent(testCommand, existingEntity);
        }
        ...
        public async Task Handle_WithInvalidIdCommand_ReturnsNotFound()
        {
            ...
            var repository = Substitute.For<ICustomerCTRepository>();
            repository.FindByIdAsync(testCommand.Id, CancellationToken.None).Returns(Task.FromResult<CustomerCT>(null));
