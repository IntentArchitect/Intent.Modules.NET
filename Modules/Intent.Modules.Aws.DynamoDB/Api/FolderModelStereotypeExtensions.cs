...
namespace Intent.Aws.DynamoDB.Api
{
    ...
    {
        public static Table GetTable(this FolderModel model)
        {
        ...
        public static bool HasTable(this FolderModel model)
        {
            return model.HasStereotype(Table.DefinitionId);
        }

        public static bool TryGetTable(this FolderModel model, out Table stereotype)
        {
            if (!HasTable(model))
            {
                stereotype = null;
