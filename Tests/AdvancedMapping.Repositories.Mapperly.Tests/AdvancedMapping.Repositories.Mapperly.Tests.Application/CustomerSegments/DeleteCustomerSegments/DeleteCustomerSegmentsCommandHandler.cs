...
namespace AdvancedMapping.Repositories.Mapperly.Tests.Application.CustomerSegments.DeleteCustomerSegments
{
    ...
    public class DeleteCustomerSegmentsCommandHandler : IRequestHandler<DeleteCustomerSegmentsCommand>
    {
        private readonly ICustomerSegmentsRepository _customerSegmentsRepository;

        [IntentManaged(Mode.Merge)]
        public DeleteCustomerSegmentsCommandHandler(ICustomerSegmentsRepository customerSegmentsRepository)
        {
            _customerSegmentsRepository = customerSegmentsRepository;
        }

        [IntentManaged(Mode.Fully, Body = Mode.Fully)]
        public async Task Handle(DeleteCustomerSegmentsCommand request, CancellationToken cancellationToken)
        {
