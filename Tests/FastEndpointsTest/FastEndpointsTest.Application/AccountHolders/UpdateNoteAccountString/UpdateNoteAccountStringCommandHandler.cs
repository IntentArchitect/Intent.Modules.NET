...
namespace FastEndpointsTest.Application.AccountHolders.UpdateNoteAccountString
{
    ...
    public class UpdateNoteAccountStringCommandHandler : IRequestHandler<UpdateNoteAccountStringCommand, string>
    {
        private readonly IAccountHolderRepository _accountHolderRepository;

        [IntentManaged(Mode.Merge)]
        public UpdateNoteAccountStringCommandHandler(IAccountHolderRepository accountHolderRepository)
        {
            _accountHolderRepository = accountHolderRepository;
        }

        [IntentManaged(Mode.Fully, Body = Mode.Fully)]
        public async Task<string> Handle(UpdateNoteAccountStringCommand request, CancellationToken cancellationToken)
        {
