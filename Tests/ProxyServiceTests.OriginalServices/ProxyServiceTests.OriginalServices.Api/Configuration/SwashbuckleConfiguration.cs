...
using ProxyServiceTests.OriginalServices.Api.Filters;
using ProxyServiceTests.OriginalServices.Application;
...
namespace ProxyServiceTests.OriginalServices.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("ProxyServiceTests.OriginalServices API");
