...
namespace EntityFrameworkCore.CustomPrimaryConnectionString.Infrastructure.Persistence
{
    /// <summary>
    ...
    public class DesignTimeDbContextFactory : IDesignTimeDbContextFactory<ApplicationDbContext>
    {
        ...
        /// in a local appsettings.json file. By default this will use "Custom Connection String".
        /// </param>
        public ApplicationDbContext CreateDbContext(string[] args)
        {
            ...
            {
                connStringName = "Custom Connection String";
            }
