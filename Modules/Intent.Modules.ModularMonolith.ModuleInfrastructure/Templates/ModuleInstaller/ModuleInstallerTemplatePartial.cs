...
namespace Intent.Modules.ModularMonolith.ModuleInfrastructure.Templates.ModuleInstaller
{
    ...
    {
        public const string TemplateId = "Intent.ModularMonolith.ModuleInfrastructure.ModuleInstallerTemplate";
...
#warning Would like a better way to get this assembly name Also Can't use name resolution and Careful of Conflict with Host
                    ...
                    @class.AddMethod("void", "ConfigureIntegrationEventConsumers", method =>
                    {
                        ...
                        method.AddStatement($"MassTransitConfiguration.AddConsumers(cfg);");
                    });
