...
Generates explicit C# object mapping extension methods for DTOs that have a `[map from]` domain entity mapping in the Services designer. Produces readable, zero-reflection code with no third-party library dependency.
