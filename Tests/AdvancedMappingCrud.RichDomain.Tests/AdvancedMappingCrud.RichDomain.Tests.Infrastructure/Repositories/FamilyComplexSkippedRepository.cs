...
namespace AdvancedMappingCrud.RichDomain.Tests.Infrastructure.Repositories
{
    ...
    public class FamilyComplexSkippedRepository : RepositoryBase<FamilyComplexSkipped, FamilyComplexSkipped, ApplicationDbContext>, IFamilyComplexSkippedRepository
    {
        public FamilyComplexSkippedRepository(ApplicationDbContext dbContext, IMapper mapper) : base(dbContext, mapper)
        {
        }
        ...
        public async Task<FamilyComplexSkipped?> FindByIdAsync(Guid id, CancellationToken cancellationToken = default)
        {
