...
"));
                    ...
                    else
                    {
                        file.AddHtmlElement("AccountHero", hero => hero
                            ...
                            .AddAttribute("Title", "Reset your password")
                            .AddAttribute("Subtitle", "Choose a new password for your account."));
                            ...
                            .AddHtmlElement("section", element => element
                                .AddHtmlElement("EditForm", element => element.AddAttribute("Model", "Input").AddAttribute("FormName", "reset-password").AddAttribute("OnValidSubmit", "OnValidSubmitAsync").AddAttribute("method", "post")
                                    ...
                                    .AddHtmlElement("UxField", element => element.AddAttribute("Label", "Password").AddAttribute("Icon", "lock").AddAttribute("For", "password")
                                        .AddHtmlElement("InputText", element => element.AddAttribute("id", "password").AddClass("ux-input").AddAttribute("type", "password").AddAttribute("@bind-Value", "Input.Password").AddAttribute("autocomplete", "new-password").AddAttribute("aria-required", "true").AddAttribute("placeholder", "Enter your new password"))
                                    )
