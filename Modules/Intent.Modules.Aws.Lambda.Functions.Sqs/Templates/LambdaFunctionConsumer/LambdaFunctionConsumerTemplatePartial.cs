            ...
            CSharpFile = new CSharpFile(this.GetNamespace(), this.GetFolderPath())
                ...
                .AddClass(GetConsumerName(), @class =>
                {
                    ...
                    @class.AddConstructor(ctor =>
                    {
                        ...
                        ctor.AddParameter(this.GetBusInterfaceName(), this.GetBusVariableName(), param => param.IntroduceReadonlyField((_, statement) => statement.ThrowArgumentNullException()));
                    ...
                    @class.AddMethod("Task", "ProcessAsync", method =>
                    {
                        ...
                        method.AddForEachStatement("record", "sqsEvent.Records", loop =>
                        {
                            loop.AddTryBlock(tryBlock =>
                            {
                                ...
                                tryBlock.AddStatement($"await {this.GetBusVariableName().ToPrivateMemberName()}.FlushAllAsync(cancellationToken);");
                            });
