...
using CleanArchitecture.Dapr.Application.OldMappingSystem.Clients;
using CleanArchitecture.Dapr.Application.OldMappingSystem.Clients.CreateClient;
using CleanArchitecture.Dapr.Application.OldMappingSystem.Clients.DeleteClient;
using CleanArchitecture.Dapr.Application.OldMappingSystem.Clients.GetClientById;
using CleanArchitecture.Dapr.Application.OldMappingSystem.Clients.GetClients;
using CleanArchitecture.Dapr.Application.OldMappingSystem.Clients.UpdateClient;
...
{
    [ApiController]
    public class OldMappingSystemClientsController : ControllerBase
    {
        private readonly ISender _mediator;

        public OldMappingSystemClientsController(ISender mediator)
        {
        ...
        [HttpPost("api/old-mapping-system/client")]
        ...
        [HttpDelete("api/old-mapping-system/client/{id}")]
        ...
        /// <response code="400">One or more validation errors have occurred.</response>
        /// <response code="404">One or more entities could not be found with the provided parameters.</response>
        [HttpPut("api/old-mapping-system/client/{id}")]
        ...
        [HttpGet("api/old-mapping-system/client/{id}")]
        ...
        [HttpGet("api/old-mapping-system/client")]
