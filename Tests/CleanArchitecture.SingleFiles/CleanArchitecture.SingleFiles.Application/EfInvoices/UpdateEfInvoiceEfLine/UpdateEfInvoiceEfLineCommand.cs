...
namespace CleanArchitecture.SingleFiles.Application.EfInvoices.UpdateEfInvoiceEfLine
{
    public class UpdateEfInvoiceEfLineCommand : IRequest, ICommand
    {
        ...
        public Guid EfInvoicesId { get; private set; }
        public Guid Id { get; private set; }
        public string Name { get; set; }

        public void SetEfInvoicesId(Guid efInvoicesId)
        {
            EfInvoicesId = efInvoicesId;
        }
