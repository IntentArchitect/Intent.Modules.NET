...
namespace CompositeMessageBus.Infrastructure.Eventing
{
    public class MessageRegistry
    {
        ...
        public MessageRegistry(IConfiguration configuration, MessageBrokerRegistry registry)
        {
        ...
        private void RegisterMessageTypes(MessageBrokerRegistry registry)
        {
            //Integration Events (Messages)
            PublishToTopic<MsgSolaceEvent>(topicName: "Solace/Dst");
            registry.Register<MsgSolaceEvent, SolaceMessageBus>();
        }
