                ...
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 9, >= 0) => new PackageVersion("15.1.6")
                            .WithNugetDependency("HotChocolate.Transport.Sockets", "15.1.6")
                            .WithNugetDependency("HotChocolate", "15.1.6")
                            .WithNugetDependency("HotChocolate.Subscriptions.InMemory", "15.1.6")
                            .WithNugetDependency("HotChocolate.Types.Scalars.Upload", "15.1.6")
                            .WithNugetDependency("HotChocolate.Utilities.DependencyInjection", "15.1.6")
