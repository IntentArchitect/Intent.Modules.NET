...
namespace EntityFrameworkCore.Repositories.TestApplication.Application.CustomRepoOperationInvocation.Operation_Params1_ReturnsE_Collection1
{
    ...
    public class Operation_Params1_ReturnsE_Collection1QueryHandler : IRequestHandler<Operation_Params1_ReturnsE_Collection1Query, List<AggregateRoot1Dto>>
    {
        ...
        public Operation_Params1_ReturnsE_Collection1QueryHandler(ICustomRepository customRepository, IMapper mapper)
        {
        ...
        {
            var result = _customRepository.Operation_Params1_ReturnsE_Collection1(new SpParameter(
