...
using AdvancedMappingCrud.DbContext.ProjectTo.Tests.IntegrationTests.Services;
...
namespace AdvancedMappingCrud.DbContext.ProjectTo.Tests.IntegrationTests.HttpClients.Products
{
