...
namespace CleanArchitecture.ServiceModelling.ComplexTypes.Infrastructure.Repositories
{
    ...
    {
        public TestDecimalsRepository(ApplicationDbContext dbContext, IMapper mapper) : base(dbContext, mapper)
        {
        }
        ...
        public async Task<TestDecimals?> FindByIdAsync(
            Guid id,
            Func<IQueryable<TestDecimals>, IQueryable<TestDecimals>> queryOptions,
            CancellationToken cancellationToken = default)
        {
