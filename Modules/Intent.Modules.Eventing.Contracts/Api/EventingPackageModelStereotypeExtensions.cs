...
namespace Intent.Eventing.Contracts.Api
{
    ...
    {
        public static MessageBus GetMessageBus(this EventingPackageModel model)
        {
        ...
        public static bool HasMessageBus(this EventingPackageModel model)
        {
            return model.HasStereotype(MessageBus.DefinitionId);
        }

        public static bool TryGetMessageBus(this EventingPackageModel model, out MessageBus stereotype)
        {
