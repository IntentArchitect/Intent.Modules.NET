...
using Subscribe.MassTransit.OutboxMemory.Api.Filters;
using Subscribe.MassTransit.OutboxMemory.Application;
using Subscribe.MassTransit.OutboxMemory.Domain.Common.Exceptions;
...
namespace Subscribe.MassTransit.OutboxMemory.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("Subscribe.MassTransit.OutboxMemory API");
