...
namespace Intent.Modules.MediatR.DomainEvents.Templates.DomainEventHandlerSkill
{
    ...
    public class DomainEventHandlerSkillTemplate : MarkdownBaseTemplate<object>, IMarkdownFileBuilderTemplate
    {
        ...
        public const string TemplateId = "Intent.MediatR.DomainEvents.DomainEventHandlerSkill";
        ...
        public DomainEventHandlerSkillTemplate(IOutputTarget outputTarget, object model = null) : base(TemplateId, outputTarget, model)
        {
            ...
            MarkdownFile = new MarkdownFile($"SKILL", relativeLocation: "mediatr-domain-event-handler")
                .FromMarkdown($"""
---
