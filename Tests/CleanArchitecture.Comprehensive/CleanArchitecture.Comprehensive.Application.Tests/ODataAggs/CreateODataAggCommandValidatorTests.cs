...
{
    public class CreateODataAggCommandValidatorTests
    {
        public static IEnumerable<object[]> GetSuccessfulResultTestData()
        {
            var fixture = new Fixture();
            var testCommand = fixture.Create<CreateODataAggCommand>();
            yield return new object[] { testCommand };
        }

        [Theory]
        [MemberData(nameof(GetSuccessfulResultTestData))]
        public async Task Validate_WithValidCommand_PassesValidation(CreateODataAggCommand testCommand)
        {
            // Arrange
        ...
        {
            var fixture = new Fixture();
            fixture.Customize<CreateODataAggCommand>(comp => comp.With(x => x.Name, () => default));
            var testCommand = fixture.Create<CreateODataAggCommand>();
        ...
        public async Task Validate_WithInvalidCommand_FailsValidation(
            CreateODataAggCommand testCommand,
        ...
        {
            return new ValidationBehaviour<CreateODataAggCommand, System.Guid>(new[] { new CreateODataAggCommandValidator() });
        }
    }
}