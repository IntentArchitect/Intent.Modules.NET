...
namespace Intent.Modules.MongoDb.Templates.MongoDbRepositoryBase
{
    ...
    public class MongoDbRepositoryBaseTemplateRegistration : SingleFileListModelTemplateRegistration<ClassModel>
    {
        private readonly IMetadataManager _metadataManager;

        public MongoDbRepositoryBaseTemplateRegistration(IMetadataManager metadataManager)
        {
            _metadataManager = metadataManager;
        }

        public override string TemplateId => MongoDbRepositoryBaseTemplate.TemplateId;

        [IntentManaged(Mode.Fully)]
        public override ITemplate CreateTemplateInstance(IOutputTarget outputTarget, IList<ClassModel> model)
        {
            return new MongoDbRepositoryBaseTemplate(outputTarget, model);
        }
