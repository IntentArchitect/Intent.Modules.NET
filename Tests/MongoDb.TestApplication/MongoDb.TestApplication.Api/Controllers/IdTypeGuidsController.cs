...
namespace MongoDb.TestApplication.Api.Controllers
{
    ...
    public class IdTypeGuidsController : ControllerBase
    {
        ...
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<ActionResult<IdTypeGuidDto>> FindById([FromRoute] Guid id, CancellationToken cancellationToken)
        {
        ...
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<ActionResult<List<IdTypeGuidDto>>> FindAll(CancellationToken cancellationToken)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<ActionResult<IdTypeGuidDto>> Delete([FromRoute] Guid id, CancellationToken cancellationToken)
        {
            var result = default(IdTypeGuidDto);
            using (var transaction = new TransactionScope(TransactionScopeOption.Required,
                new TransactionOptions() { IsolationLevel = IsolationLevel.ReadCommitted }, TransactionScopeAsyncFlowOption.Enabled))
