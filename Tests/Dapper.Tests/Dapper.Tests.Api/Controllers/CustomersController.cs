...
using Dapper.Tests.Api.Controllers.ResponseTypes;
using Dapper.Tests.Application.Customers;
using Dapper.Tests.Application.Customers.CreateCustomer;
using Dapper.Tests.Application.Customers.DeleteCustomer;
using Dapper.Tests.Application.Customers.GetCustomerById;
using Dapper.Tests.Application.Customers.GetCustomers;
using Dapper.Tests.Application.Customers.UpdateCustomer;
...
namespace Dapper.Tests.Api.Controllers
{
    [ApiController]
