...
using Blazor.ProductService.Api.Controllers.ResponseTypes;
using Blazor.ProductService.Application;
using Blazor.ProductService.Application.CreateProduct;
using Blazor.ProductService.Application.DeleteProduct;
using Blazor.ProductService.Application.GetProductById;
using Blazor.ProductService.Application.GetProducts;
using Blazor.ProductService.Application.UpdateProduct;
...
namespace Blazor.ProductService.Api.Controllers
{
    [ApiController]
