...
{
    public class UpdateDerivedOfTCommandHandlerTests
    {
        public static IEnumerable<object[]> GetSuccessfulResultTestData()
        {
            ...
            fixture.Customize<UpdateDerivedOfTCommand>(comp => comp.With(x => x.Id, existingEntity.Id));
            ...
            DerivedOfT existingEntity)
        {
            ...
            var sut = new UpdateDerivedOfTCommandHandler(derivedOfTRepository);

            // Act
            await sut.Handle(testCommand, CancellationToken.None);

            // Assert
            DerivedOfTAssertions.AssertEquivalent(testCommand, existingEntity);
        }
