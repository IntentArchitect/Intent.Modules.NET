...
namespace MongoDb.TestApplication.Api.Controllers
{
    ...
    public class SingleIndexEntitiesController : ControllerBase
    {
        ...
        public SingleIndexEntitiesController(ISingleIndexEntitiesService appService, IMongoDbUnitOfWork mongoDbUnitOfWork)
        {
        ...
        /// <response code="400">One or more validation errors have occurred.</response>
        /// <response code="404">Can't find an SingleIndexEntityDto with the parameters provided.</response>
        [HttpGet("{id}")]
