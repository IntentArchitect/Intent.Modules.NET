...
using WolverineEventing.ErrorPolicy.RetryWithCooldown.Domain.Common.Exceptions;

[assembly: DefaultIntentManaged(Mode.Fully)]
[assembly: IntentTemplate("Intent.AspNetCore.Swashbuckle.SwashbuckleConfiguration", Version = "1.0")]

namespace WolverineEventing.ErrorPolicy.RetryWithCooldown.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("WolverineEventing.ErrorPolicy.RetryWithCooldown API");
