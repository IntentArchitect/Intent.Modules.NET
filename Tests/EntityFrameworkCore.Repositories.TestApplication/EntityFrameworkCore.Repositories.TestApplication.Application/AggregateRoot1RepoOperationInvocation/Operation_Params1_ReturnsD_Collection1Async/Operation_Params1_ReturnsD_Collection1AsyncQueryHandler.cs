...
namespace EntityFrameworkCore.Repositories.TestApplication.Application.AggregateRoot1RepoOperationInvocation.Operation_Params1_ReturnsD_Collection1Async
{
    ...
    public class Operation_Params1_ReturnsD_Collection1AsyncQueryHandler : IRequestHandler<Operation_Params1_ReturnsD_Collection1AsyncQuery, List<SpResultDto>>
    {
        ...
        public Operation_Params1_ReturnsD_Collection1AsyncQueryHandler(IAggregateRoot1Repository aggregateRoot1Repository,
            IMapper mapper)
        {
        ...
        {
            var result = await _aggregateRoot1Repository.Operation_Params1_ReturnsD_Collection1Async(new SpParameter(
