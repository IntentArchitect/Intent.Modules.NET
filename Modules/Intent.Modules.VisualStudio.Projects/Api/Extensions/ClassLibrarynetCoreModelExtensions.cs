...
namespace Intent.Modules.VisualStudio.Projects.Api
{
    public static class ClassLibraryNETCoreModelExtensions
    {
        ...
        public static ProjectOptions GetProjectOptions(this ClassLibraryNETCoreModel model)
        {
            var stereotype = model.GetStereotype("Project Options");
            return stereotype != null ? new ProjectOptions(stereotype) : null;
        }

        public static bool HasProjectOptions(this ClassLibraryNETCoreModel model)
        {
