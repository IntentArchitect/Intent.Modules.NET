...
namespace Intent.AspNetCore.OutputCaching.Redis.Api
{
    ...
    {
        public static CacheEviction GetCacheEviction(this FolderModel model)
        {
        ...
        public static bool HasCacheEviction(this FolderModel model)
        {
            return model.HasStereotype(CacheEviction.DefinitionId);
        }

        public static bool TryGetCacheEviction(this FolderModel model, out CacheEviction stereotype)
        {
