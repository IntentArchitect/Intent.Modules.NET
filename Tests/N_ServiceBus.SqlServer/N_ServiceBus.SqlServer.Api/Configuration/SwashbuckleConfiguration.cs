...
using N_ServiceBus.SqlServer.Domain.Common.Exceptions;
...
namespace N_ServiceBus.SqlServer.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("N_ServiceBus.SqlServer API");
