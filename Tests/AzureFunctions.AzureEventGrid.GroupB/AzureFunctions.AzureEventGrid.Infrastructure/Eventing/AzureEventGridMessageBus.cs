...
[assembly: IntentTemplate("Intent.Eventing.AzureEventGrid.AzureEventGridMessageBus", Version = "1.0")]

namespace AzureFunctions.AzureEventGrid.Infrastructure.Eventing
{
    public class AzureEventGridMessageBus : IEventBus
    {
        ...
        public AzureEventGridMessageBus(IOptions<AzureEventGridPublisherOptions> options,
