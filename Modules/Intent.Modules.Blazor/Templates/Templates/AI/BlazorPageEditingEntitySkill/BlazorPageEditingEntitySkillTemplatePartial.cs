      ...
      MarkdownFile = new MarkdownFile($"SKILL", "md", "blazor-page-editing-entity")
        .FromMarkdown("""
          ...
          **Design and styling context** (search the project — these are NOT in the SKILL.md folder):
          ...
          Use for: Edit or update entity pages in Blazor
          ...
          **Always forbidden** (skeleton or implemented):
          ...
          | Lookup | `InputSelect` using real loaded options |
          | Array | Repeatable Bootstrap blocks |
