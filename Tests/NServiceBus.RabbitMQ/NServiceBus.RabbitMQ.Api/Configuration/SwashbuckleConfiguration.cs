...
using NServiceBus.RabbitMQ.Api.Filters;
using NServiceBus.RabbitMQ.Application;
using NServiceBus.RabbitMQ.Domain.Common.Exceptions;
...
namespace NServiceBus.RabbitMQ.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("NServiceBus.RabbitMQ API");
