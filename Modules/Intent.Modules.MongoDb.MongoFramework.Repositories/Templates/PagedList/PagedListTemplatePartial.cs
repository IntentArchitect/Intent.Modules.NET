...
namespace Intent.Modules.MongoDb.MongoFramework.Repositories.Templates.PagedList
{
    [IntentManaged(Mode.Fully, Body = Mode.Merge)]
    public partial class PagedListTemplate : CSharpTemplateBase<object>, ICSharpFileBuilderTemplate
    {
        public const string TemplateId = "Intent.MongoDb.MongoFramework.Repositories.PagedList";
