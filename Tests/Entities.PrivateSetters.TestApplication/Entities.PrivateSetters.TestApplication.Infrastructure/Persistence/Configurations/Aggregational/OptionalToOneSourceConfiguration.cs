...
{
    public class OptionalToOneSourceConfiguration : IEntityTypeConfiguration<OptionalToOneSource>
    {
        public void Configure(EntityTypeBuilder<OptionalToOneSource> builder)
        {
