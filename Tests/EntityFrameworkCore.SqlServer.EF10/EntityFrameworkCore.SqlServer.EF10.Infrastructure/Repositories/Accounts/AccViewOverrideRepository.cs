...
using EntityFrameworkCore.SqlServer.EF10.Domain.Repositories.Accounts;
...
namespace EntityFrameworkCore.SqlServer.EF10.Infrastructure.Repositories.Accounts
{
    ...
    public class AccViewOverrideRepository : RepositoryBase<AccViewOverride, AccViewOverride, ApplicationDbContext>, IAccViewOverrideRepository
    {
        ...
        public async Task<AccViewOverride?> FindByIdAsync(
            Guid id,
            Func<IQueryable<AccViewOverride>, IQueryable<AccViewOverride>> queryOptions,
