...
namespace EntityFrameworkCore.Repositories.TestApplication.Application.CustomRepoOperationInvocation.Operation_Params0_ReturnsD_Collection1Async
{
    ...
    public class Operation_Params0_ReturnsD_Collection1AsyncQueryHandler : IRequestHandler<Operation_Params0_ReturnsD_Collection1AsyncQuery, List<SpResultDto>>
    {
        ...
        public Operation_Params0_ReturnsD_Collection1AsyncQueryHandler(ICustomRepository customRepository, IMapper mapper)
        {
        ...
        {
            var result = await _customRepository.Operation_Params0_ReturnsD_Collection1Async(cancellationToken);
