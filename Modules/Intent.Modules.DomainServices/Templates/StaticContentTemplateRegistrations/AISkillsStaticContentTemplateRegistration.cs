...
namespace Intent.Modules.DomainServices.Templates.StaticContentTemplateRegistrations
{
    public class AISkillsStaticContentTemplateRegistration : AIStaticContentTemplateRegistration
    {
        public new const string TemplateId = "Intent.Modules.DomainServices.Templates.StaticContentTemplateRegistrations.AISkillsStaticContentTemplateRegistration";
