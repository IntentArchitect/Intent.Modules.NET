...
namespace DynamoDbTests.EntityInterfaces.Infrastructure.Persistence.Documents
{
    ...
    internal class IdTestingDocument : IDynamoDBDocument<IIdTesting, IdTesting, IdTestingDocument>
    {
        [DynamoDBHashKey]
        ...
        public IdTestingDocument PopulateFromEntity(IIdTesting entity, Func<object, int?> getVersion)
        {
        ...
        public static IdTestingDocument? FromEntity(IIdTesting? entity, Func<object, int?> getVersion)
        {
            if (entity is null)
            {
                return null;
