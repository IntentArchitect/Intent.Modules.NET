...
using AzureKeyVault.Api.Filters;
using AzureKeyVault.Application;
using AzureKeyVault.Domain.Common.Exceptions;
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.SwaggerEndpoint("/swagger/v1/swagger.json", "AzureKeyVault API V1");
                    options.OAuthAppName("AzureKeyVault API");
