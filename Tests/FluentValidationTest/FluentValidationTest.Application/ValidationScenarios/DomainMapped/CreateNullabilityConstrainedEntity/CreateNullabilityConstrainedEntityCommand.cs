...
{
    public class CreateNullabilityConstrainedEntityCommand : IRequest, ICommand
    {
        public CreateNullabilityConstrainedEntityCommand(string requiredString, string? optionalString, int requiredInt, int? optionalInt, Guid requiredGuidValue, Guid? optionalGuidValue, DateTime requiredDateValue, DateTime? optionalDateValue)
        {
