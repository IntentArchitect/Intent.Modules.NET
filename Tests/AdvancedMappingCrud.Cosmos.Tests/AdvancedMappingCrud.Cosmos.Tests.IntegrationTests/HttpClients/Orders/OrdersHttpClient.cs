...
namespace AdvancedMappingCrud.Cosmos.Tests.IntegrationTests.HttpClients.Orders
{
    public class OrdersHttpClient : IOrdersService
    {
        ...
        public async Task<string> CreateOrderOrderItemAsync(
        ...
        public async Task DeleteOrderOrderItemAsync(string orderId, string id, CancellationToken cancellationToken = default)
        {
