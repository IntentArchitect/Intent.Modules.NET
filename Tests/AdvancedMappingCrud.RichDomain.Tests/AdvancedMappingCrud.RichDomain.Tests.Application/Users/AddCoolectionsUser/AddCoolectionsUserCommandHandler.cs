...
namespace AdvancedMappingCrud.RichDomain.Tests.Application.Users.AddCoolectionsUser
{
    ...
    public class AddCoolectionsUserCommandHandler : IRequestHandler<AddCoolectionsUserCommand>
    {
        private readonly IUserRepository _userRepository;

        [IntentManaged(Mode.Merge)]
        public AddCoolectionsUserCommandHandler(IUserRepository userRepository)
        {
            _userRepository = userRepository;
        }

        [IntentManaged(Mode.Fully, Body = Mode.Fully)]
        public async Task Handle(AddCoolectionsUserCommand request, CancellationToken cancellationToken)
        {
            ...
            user.AddCoolections(request.Addresses
