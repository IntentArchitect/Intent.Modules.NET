...
{
    public class Operation_Params3_ReturnsE_Collection1Query : IRequest<List<AggregateRoot1Dto>>, IQuery
    {
        public Operation_Params3_ReturnsE_Collection1Query(byte[] attributeBinary,
            bool attributeBool,
            byte attributeByte,
