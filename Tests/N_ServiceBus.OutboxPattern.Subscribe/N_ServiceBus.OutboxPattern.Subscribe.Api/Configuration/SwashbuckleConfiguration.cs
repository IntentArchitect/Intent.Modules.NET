...
using N_ServiceBus.OutboxPattern.Subscribe.Domain.Common.Exceptions;
...
namespace N_ServiceBus.OutboxPattern.Subscribe.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("N_ServiceBus.OutboxPattern.Subscribe API");
