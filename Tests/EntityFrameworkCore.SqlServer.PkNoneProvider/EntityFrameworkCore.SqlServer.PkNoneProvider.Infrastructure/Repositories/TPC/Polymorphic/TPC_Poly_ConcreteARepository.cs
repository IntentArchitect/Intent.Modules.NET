...
using EntityFrameworkCore.SqlServer.PkNoneProvider.Domain.Repositories.TPC.Polymorphic;
...
namespace EntityFrameworkCore.SqlServer.PkNoneProvider.Infrastructure.Repositories.TPC.Polymorphic
{
    ...
    public class TPC_Poly_ConcreteARepository : RepositoryBase<TPC_Poly_ConcreteA, TPC_Poly_ConcreteA, ApplicationDbContext>, ITPC_Poly_ConcreteARepository
    {
        ...
        public async Task<TPC_Poly_ConcreteA?> FindByIdAsync(
            Guid id,
            Func<IQueryable<TPC_Poly_ConcreteA>, IQueryable<TPC_Poly_ConcreteA>> queryOptions,
