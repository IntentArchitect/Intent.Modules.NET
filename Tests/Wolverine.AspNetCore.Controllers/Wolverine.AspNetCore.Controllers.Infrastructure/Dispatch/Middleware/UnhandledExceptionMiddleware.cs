...
namespace Wolverine.AspNetCore.Controllers.Infrastructure.Dispatch.Middleware
{
    public class UnhandledExceptionMiddleware
    {
        ...
        private void LogException(Exception exception, object request, ILogger logger)
        {
            ...
            {
                logger.LogError(exception, "Wolverine.AspNetCore.Controllers Request: Unhandled Exception for Request {Name} {@Request}", requestName, request);
            }
            else
            {
                logger.LogError(exception, "Wolverine.AspNetCore.Controllers Request: Unhandled Exception for Request {Name}", requestName);
            }
        }
    }
}