...
using NServiceBus.OutboxPattern.Subscribe.Api.Filters;
using NServiceBus.OutboxPattern.Subscribe.Application;
using NServiceBus.OutboxPattern.Subscribe.Domain.Common.Exceptions;
...
namespace NServiceBus.OutboxPattern.Subscribe.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("NServiceBus.OutboxPattern.Subscribe API");
