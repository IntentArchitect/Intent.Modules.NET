...
using WolverineEventing.Coexist.Cqrs.Api.Filters;
using WolverineEventing.Coexist.Cqrs.Application;
using WolverineEventing.Coexist.Cqrs.Domain.Common.Exceptions;

[assembly: DefaultIntentManaged(Mode.Fully)]
[assembly: IntentTemplate("Intent.AspNetCore.Swashbuckle.SwashbuckleConfiguration", Version = "1.0")]

namespace WolverineEventing.Coexist.Cqrs.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("WolverineEventing.Coexist.Cqrs API");
