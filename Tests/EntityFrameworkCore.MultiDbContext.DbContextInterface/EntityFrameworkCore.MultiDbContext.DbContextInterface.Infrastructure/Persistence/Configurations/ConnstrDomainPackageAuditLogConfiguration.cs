...
{
    public class ConnstrDomainPackageAuditLogConfiguration : IEntityTypeConfiguration<ConnstrDomainPackageAuditLog>
    {
        public void Configure(EntityTypeBuilder<ConnstrDomainPackageAuditLog> builder)
        {
