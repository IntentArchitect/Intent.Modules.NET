...
namespace EntityFrameworkCore.SqlServer.PkNoneProvider.Domain.Repositories.TPT.InheritanceAssociations
{
    ...
    public interface ITPT_AbstractBaseClassRepository : IEFRepository<TPT_AbstractBaseClass, TPT_AbstractBaseClass>
    {
        ...
        [IntentManaged(Mode.Fully)]
        Task<TPT_AbstractBaseClass?> FindByIdAsync(Guid id, Func<IQueryable<TPT_AbstractBaseClass>, IQueryable<TPT_AbstractBaseClass>> queryOptions, CancellationToken cancellationToken = default);
        [IntentManaged(Mode.Fully)]
