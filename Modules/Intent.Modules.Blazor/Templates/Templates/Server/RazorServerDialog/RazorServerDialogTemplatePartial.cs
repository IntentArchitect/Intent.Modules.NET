...
namespace Intent.Modules.Blazor.Templates.Templates.Server.RazorServerDialog
{
    ...
    public partial class RazorServerDialogTemplate : ServerComponentRazorTemplateBase
    {
        /// <inheritdoc cref="IntentTemplateBase.Id"/>
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Intent.Blazor.Templates.Server.RazorServerDialogTemplate";

        /// <summary>
        /// Creates a new instance of <see cref="RazorServerDialogTemplate"/>.
        /// </summary>
        [IntentManaged(Mode.Fully, Body = Mode.Ignore)]
        public RazorServerDialogTemplate(IOutputTarget outputTarget, ComponentModel model) : base(TemplateId, outputTarget, model)
        {
        }
        ...
        protected override string CodeBehindTemplateId => RazorServerDialogCodeBehindTemplate.TemplateId;
    }
}
