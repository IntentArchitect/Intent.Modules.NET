    ...
    public class NugetPackages : INugetPackages
    {
        ...
        public void RegisterPackages()
        {
            ...
            NugetRegistry.Register(MicrosoftIdentityWebPackageName,
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 9, >= 0) => new PackageVersion("3.9.3")
                            .WithNugetDependency("Microsoft.Identity.Web.Certificate", "3.9.3")
                            .WithNugetDependency("Microsoft.Identity.Web.Certificateless", "3.9.3")
                            .WithNugetDependency("Microsoft.Identity.Web.TokenAcquisition", "3.9.3")
                            .WithNugetDependency("Microsoft.Identity.Web.TokenCache", "3.9.3")
                            .WithNugetDependency("Microsoft.IdentityModel.Protocols.OpenIdConnect", "8.12.0")
                            .WithNugetDependency("Microsoft.IdentityModel.Validators", "8.12.0")
                            .WithNugetDependency("System.Formats.Asn1", "9.0.0")
                            .WithNugetDependency("System.IdentityModel.Tokens.Jwt", "8.12.0"),
                        ( >= 8, >= 0) => new PackageVersion("3.9.3")
                            .WithNugetDependency("Microsoft.Identity.Web.Certificate", "3.9.3")
                            .WithNugetDependency("Microsoft.Identity.Web.Certificateless", "3.9.3")
                            .WithNugetDependency("Microsoft.Identity.Web.TokenAcquisition", "3.9.3")
                            .WithNugetDependency("Microsoft.Identity.Web.TokenCache", "3.9.3")
            ...
            NugetRegistry.Register(MicrosoftIdentityWebUIPackageName,
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 9, >= 0) => new PackageVersion("3.9.3")
                            .WithNugetDependency("Microsoft.Identity.Web", "3.9.3"),
                        ( >= 8, >= 0) => new PackageVersion("3.9.3")
                            .WithNugetDependency("Microsoft.Identity.Web", "3.9.3"),
                        ( >= 7, >= 0) => new PackageVersion("3.9.3")
                            .WithNugetDependency("Microsoft.Identity.Web", "3.9.3"),
