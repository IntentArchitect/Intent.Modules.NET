    ...
    internal static class LoginWithRecoveryCodePageContent
    {
                        ...
                        <EditForm Model="Input" FormName="login-with-recovery-code" OnValidSubmit="OnValidSubmitAsync" method="post">
                            ...
                            <MudGrid>
                                <MudItem xs="12">
                                    ...
                                    <MudText Typo="Typo.body2" Class="mb-4">Enter one of your saved recovery codes to continue.</MudText>
                                </MudItem>
                                <MudItem xs="12">
                                    <div class="account-input-field">
                                        <label class="account-input-label" for="recovery-code">Recovery code</label>
                                        <div class="account-input-shell">
                                            <MudIcon Icon="@Icons.Material.Filled.VpnKey" Class="account-input-icon" />
                                            <InputText id="recovery-code" class="account-input-control" @bind-Value="Input.RecoveryCode" autocomplete="off" aria-required="true" placeholder="Recovery code" />
                                        </div>
                                ...
                                <MudItem xs="12">
                                    <MudStack Row="true" Justify="Justify.FlexEnd">
                                        <MudButton ButtonType="ButtonType.Submit" Variant="Variant.Filled" Color="Color.Primary" StartIcon="@Icons.Material.Filled.Login">Log in</MudButton>
                                    </MudStack>
                                </MudItem>
                            </MudGrid>
                        </EditForm>
        ...
        private static string BuildBootstrapContent(string identityClass, string redirectManager)
        {
            return $$"""
                ...
                <AccountHero Icon="key" Title="Recovery code verification" Subtitle="Log in using one of your saved recovery codes." />
                ...
                <div class="ux-form-narrow">
                    <section>
                        ...
                        <EditForm Model="Input" FormName="login-with-recovery-code" OnValidSubmit="OnValidSubmitAsync" method="post">
                            <DataAnnotationsValidator />
                            <ValidationSummary class="text-danger" role="alert" />
                            <UxField Label="Recovery code" Icon="key" For="recovery-code">
                                <InputText id="recovery-code" @bind-Value="Input.RecoveryCode" class="ux-input" autocomplete="off" placeholder="Enter a recovery code" />
                            </UxField>
                            <ValidationMessage For="() => Input.RecoveryCode" class="text-danger" />
