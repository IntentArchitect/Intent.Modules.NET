...
namespace Intent.Modules.Eventing.MassTransit.CRUD.FactoryExtensions
{
    [IntentManaged(Mode.Fully, Body = Mode.Merge)]
    public class EventBusPublisherInstaller : FactoryExtensionBase
    {
        public override string Id => "Intent.Modules.Eventing.MassTransit.CRUD.EventBusPublisherInstaller";
