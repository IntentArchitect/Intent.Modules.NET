...
- Improvement: `Azure Event Stereotype` is not required on Messages unless you need to use in addition to other message brokers or want to overwrite the default topic name.
