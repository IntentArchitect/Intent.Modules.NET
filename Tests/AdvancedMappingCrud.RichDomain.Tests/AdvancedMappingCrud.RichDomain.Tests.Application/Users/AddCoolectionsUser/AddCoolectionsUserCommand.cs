...
{
    public class AddCoolectionsUserCommand : IRequest, ICommand
    {
        public AddCoolectionsUserCommand(Guid id, List<AddAddressDCDto> addresses, List<AddContactDetailsVODto> contacts)
        {
            Id = id;
            Addresses = addresses;
            Contacts = contacts;
