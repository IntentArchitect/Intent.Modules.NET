...
namespace EFCore.Lazy.Loading.Tests.Application.Common.Behaviours
{
        ...
        where TRequest : notnull
    {
        ...
        public Task Process(TRequest request, CancellationToken cancellationToken)
        {
            ...
            {
                _logger.LogInformation("EFCore.Lazy.Loading.Tests Request: {Name} {@UserId} {@UserName} {@Request}", requestName, userId, userName, request);
            }
            else
            {
                _logger.LogInformation("EFCore.Lazy.Loading.Tests Request: {Name} {@UserId} {@UserName}", requestName, userId, userName);
            }
