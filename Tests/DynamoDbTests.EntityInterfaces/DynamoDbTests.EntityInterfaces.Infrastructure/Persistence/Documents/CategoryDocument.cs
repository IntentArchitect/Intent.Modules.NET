...
namespace DynamoDbTests.EntityInterfaces.Infrastructure.Persistence.Documents
{
    ...
    internal class CategoryDocument : IDynamoDBDocument<ICategory, Category, CategoryDocument>
    {
        [DynamoDBHashKey]
        ...
        public CategoryDocument PopulateFromEntity(ICategory entity, Func<object, int?> getVersion)
        {
            Id = entity.Id;
            Name = entity.Name;
        ...
        public static CategoryDocument? FromEntity(ICategory? entity, Func<object, int?> getVersion)
        {
            if (entity is null)
            {
                return null;
