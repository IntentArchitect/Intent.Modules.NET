        ...
        public void RegisterPackages()
        {
            NugetRegistry.Register(GrpcAspNetCorePackageName,
                (framework) => framework switch
                    {
                        ( >= 9, 0) => new PackageVersion("2.67.0")
                            .WithNugetDependency("Google.Protobuf", "3.27.0")
                            .WithNugetDependency("Grpc.AspNetCore.Server.ClientFactory", "2.67.0")
                            .WithNugetDependency("Grpc.Tools", "2.67.0"),
                        ( >= 8, 0) => new PackageVersion("2.67.0")
                            .WithNugetDependency("Google.Protobuf", "3.27.0")
                            .WithNugetDependency("Grpc.AspNetCore.Server.ClientFactory", "2.67.0")
                            .WithNugetDependency("Grpc.Tools", "2.67.0"),
                        ( >= 7, 0) => new PackageVersion("2.67.0")
                            .WithNugetDependency("Google.Protobuf", "3.27.0")
                            .WithNugetDependency("Grpc.AspNetCore.Server.ClientFactory", "2.67.0")
                            .WithNugetDependency("Grpc.Tools", "2.67.0"),
                        ( >= 6, 0) => new PackageVersion("2.67.0")
                            .WithNugetDependency("Google.Protobuf", "3.27.0")
                            .WithNugetDependency("Grpc.AspNetCore.Server.ClientFactory", "2.67.0")
                            .WithNugetDependency("Grpc.Tools", "2.67.0"),
                ...
                (framework) => framework switch
                    {
                        ( >= 9, 0) => new PackageVersion("2.67.0")
                            .WithNugetDependency("Google.Protobuf", "3.27.0")
                            .WithNugetDependency("Grpc.AspNetCore.Server", "2.67.0")
                            .WithNugetDependency("Grpc.Reflection", "2.67.0"),
                        ( >= 8, 0) => new PackageVersion("2.67.0")
                            .WithNugetDependency("Google.Protobuf", "3.27.0")
                            .WithNugetDependency("Grpc.AspNetCore.Server", "2.67.0")
                            .WithNugetDependency("Grpc.Reflection", "2.67.0"),
            ...
            NugetRegistry.Register(GrpcStatusProtoPackageName,
                (framework) => framework switch
                    {
                        ( >= 2, 1) => new PackageVersion("2.67.0")
                            .WithNugetDependency("Google.Api.CommonProtos", "2.15.0")
                            .WithNugetDependency("Grpc.Core.Api", "2.67.0"),
                        ( >= 2, 0) => new PackageVersion("2.67.0")
                            .WithNugetDependency("Google.Api.CommonProtos", "2.15.0")
                            .WithNugetDependency("Grpc.Core.Api", "2.67.0"),
