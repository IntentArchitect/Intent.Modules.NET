...
namespace IntegrationTesting.Tests.IntegrationTests.HttpClients
{
    public class ParentsHttpClient : IParentsService
    {
        ...
        public async Task<Guid> CreateParentAsync(
            CreateParentCommand command,
            CancellationToken cancellationToken = default)
        {
            var relativeUri = $"api/parent";
        ...
        public async Task<ParentDto> GetParentByIdAsync(Guid id, CancellationToken cancellationToken = default)
        {
            var relativeUri = $"api/parent/{id}";
