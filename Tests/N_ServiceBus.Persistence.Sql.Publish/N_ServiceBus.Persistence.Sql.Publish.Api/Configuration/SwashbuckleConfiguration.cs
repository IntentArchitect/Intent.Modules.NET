...
using N_ServiceBus.Persistence.Sql.Publish.Domain.Common.Exceptions;
...
namespace N_ServiceBus.Persistence.Sql.Publish.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("N_ServiceBus.Persistence.Sql.Publish API");
