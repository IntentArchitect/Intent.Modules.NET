...
using EntityFrameworkCore.Postgres.Application.Common.Exceptions;
using EntityFrameworkCore.Postgres.Domain.Common.Exceptions;
...
namespace EntityFrameworkCore.Postgres.Api.Filters
{
