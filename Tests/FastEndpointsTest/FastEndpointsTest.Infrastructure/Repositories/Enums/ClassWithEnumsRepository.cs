...
namespace FastEndpointsTest.Infrastructure.Repositories.Enums
{
    ...
    public class ClassWithEnumsRepository : RepositoryBase<ClassWithEnums, ClassWithEnums, ApplicationDbContext>, IClassWithEnumsRepository
    {
        ...
        public async Task<ClassWithEnums?> FindByIdAsync(
            Guid id,
            Func<IQueryable<ClassWithEnums>, IQueryable<ClassWithEnums>> queryOptions,
            CancellationToken cancellationToken = default)
        {
