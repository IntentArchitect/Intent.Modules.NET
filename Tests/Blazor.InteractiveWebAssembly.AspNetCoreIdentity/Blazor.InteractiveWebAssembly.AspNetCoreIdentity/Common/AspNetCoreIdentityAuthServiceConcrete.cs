...
namespace Blazor.InteractiveWebAssembly.AspNetCoreIdentity.Common
{
    internal class AspNetCoreIdentityAuthServiceConcrete : IAuthService
    {
        ...
        public AspNetCoreIdentityAuthServiceConcrete(SignInManager<ApplicationUser> signInManager,
