...
public static class MessageBusExtensions
{
    ...
    {
        return MessageBusRegistry.HasMultipleMessageBusImplementations();
    }
    ...
    /// </returns>
    private static bool HasMatchingStereotype<T>(T element, IReadOnlyList<string> brokerStereotypeNameOrIds)
        where T : IHasStereotypes
    {
