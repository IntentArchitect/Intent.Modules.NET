...
using CleanArchitecture.QueueStorage.Api.Controllers.ResponseTypes;
using CleanArchitecture.QueueStorage.Application.Products;
using CleanArchitecture.QueueStorage.Application.Products.CreateProduct;
using CleanArchitecture.QueueStorage.Application.Products.DeleteProduct;
using CleanArchitecture.QueueStorage.Application.Products.GetProductById;
using CleanArchitecture.QueueStorage.Application.Products.GetProducts;
using CleanArchitecture.QueueStorage.Application.Products.UpdateProduct;
...
namespace CleanArchitecture.QueueStorage.Api.Controllers
{
    [ApiController]
