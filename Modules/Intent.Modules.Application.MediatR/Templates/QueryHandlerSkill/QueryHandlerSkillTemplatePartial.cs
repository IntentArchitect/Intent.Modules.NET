...
namespace Intent.Modules.Application.MediatR.Templates.QueryHandlerSkill
{
    [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
    public class QueryHandlerSkillTemplate : MarkdownBaseTemplate<object>, IMarkdownFileBuilderTemplate
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Intent.Application.MediatR.QueryHandlerSkillTemplate";

        internal const string SkillName = "mediatr-query-handler";
