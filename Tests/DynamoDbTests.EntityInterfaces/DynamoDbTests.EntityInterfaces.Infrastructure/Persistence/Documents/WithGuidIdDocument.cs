...
namespace DynamoDbTests.EntityInterfaces.Infrastructure.Persistence.Documents
{
    ...
    internal class WithGuidIdDocument : IDynamoDBDocument<IWithGuidId, WithGuidId, WithGuidIdDocument>
    {
        [DynamoDBHashKey]
        ...
        public WithGuidIdDocument PopulateFromEntity(IWithGuidId entity, Func<object, int?> getVersion)
        {
            Id = entity.Id;
            Field = entity.Field;
        ...
        public static WithGuidIdDocument? FromEntity(IWithGuidId? entity, Func<object, int?> getVersion)
        {
            if (entity is null)
            {
                return null;
