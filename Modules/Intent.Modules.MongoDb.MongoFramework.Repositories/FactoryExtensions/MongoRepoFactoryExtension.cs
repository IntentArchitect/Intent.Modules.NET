...
using Intent.Modules.MongoDb.MongoFramework.Repositories.Templates;
...
namespace Intent.Modules.MongoDb.MongoFramework.Repositories.FactoryExtensions
{
    [IntentManaged(Mode.Fully, Body = Mode.Merge)]
    public class MongoRepoFactoryExtension : FactoryExtensionBase
    {
        public override string Id => "Intent.MongoDb.MongoFramework.Repositories.MongoRepoFactoryExtension";
