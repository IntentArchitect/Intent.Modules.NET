...
using JsonPatchRfc7396.Swashbuckle.Api.Configuration;
using JsonPatchRfc7396.Swashbuckle.Api.Filters;
using JsonPatchRfc7396.Swashbuckle.Api.Logging;
using JsonPatchRfc7396.Swashbuckle.Api.Services;
using JsonPatchRfc7396.Swashbuckle.Application;
using JsonPatchRfc7396.Swashbuckle.Infrastructure;
...
namespace JsonPatchRfc7396.Swashbuckle.Api
{
            ...
            try
            {
                ...
                builder.Services.AddControllers(
                    opt =>
                    {
                        ...
                        opt.ModelMetadataDetailsProviders.Add(new PatchIgnoreMetadataProvider());
                    })
