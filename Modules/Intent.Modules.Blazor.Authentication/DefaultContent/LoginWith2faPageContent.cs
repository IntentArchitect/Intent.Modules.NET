    ...
    internal static class LoginWith2faPageContent
    {
        ...
        private static string BuildMudBlazorContent(string identityClass, string redirectManager)
        {
            return $$"""
                ...
                <MudText Typo="Typo.body1" Class="mb-4">Your login is protected with an authenticator app. Enter your authenticator code below.</MudText>
                        ...
                        <EditForm Model="Input" FormName="login-with-2fa" OnValidSubmit="OnValidSubmitAsync" method="post">
                            ...
                            <MudGrid>
                                <MudItem xs="12">
                                    ...
                                    <MudText Typo="Typo.body2" Class="mb-4">Enter the code generated by your authenticator app.</MudText>
                                </MudItem>
                                <MudItem xs="12">
                                    <div class="account-input-field">
                                        <label class="account-input-label" for="two-factor-code">Authenticator code</label>
                                        <div class="account-input-shell">
                                            <MudIcon Icon="@Icons.Material.Filled.Password" Class="account-input-icon" />
                                            <InputText id="two-factor-code" class="account-input-control" @bind-Value="Input.TwoFactorCode" autocomplete="off" aria-required="true" placeholder="Enter your authenticator code" />
                                        </div>
                                ...
                                <MudItem xs="12">
                                    <div class="account-checkbox-field">
                                        <InputCheckbox @bind-Value="Input.RememberMachine" class="account-checkbox-control" />
        ...
        private static string BuildBootstrapContent(string identityClass, string redirectManager)
        {
            return $$"""
                ...
                <AccountHero Icon="shield" Title="Two-factor authentication" Subtitle="Your login is protected with an authenticator app." />
                ...
                <div class="ux-form-narrow">
                    <section>
                        ...
                        <EditForm Model="Input" FormName="login-with-2fa" OnValidSubmit="OnValidSubmitAsync" method="post">
                            ...
                            <DataAnnotationsValidator />
                            <ValidationSummary class="text-danger" role="alert" />
                            <UxField Label="Authenticator code" Icon="shield" For="two-factor-code">
                                <InputText id="two-factor-code" @bind-Value="Input.TwoFactorCode" class="ux-input" autocomplete="off" placeholder="Enter your code" />
                            </UxField>
                            <ValidationMessage For="() => Input.TwoFactorCode" class="text-danger" />
                            <div class="form-check">
                                <InputCheckbox id="remember-machine" class="form-check-input" @bind-Value="Input.RememberMachine" />
