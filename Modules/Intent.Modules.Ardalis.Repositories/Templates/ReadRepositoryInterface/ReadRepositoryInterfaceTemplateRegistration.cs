...
namespace Intent.Modules.Ardalis.Repositories.Templates.ReadRepositoryInterface
{
    ...
    public class ReadRepositoryInterfaceTemplateRegistration : FilePerModelTemplateRegistration<ClassModel>
    {
        private readonly IMetadataManager _metadataManager;

        public ReadRepositoryInterfaceTemplateRegistration(IMetadataManager metadataManager)
        {
