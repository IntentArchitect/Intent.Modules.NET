    ...
    public class NugetPackages : INugetPackages
    {
        ...
        public void RegisterPackages()
        {
            ...
            NugetRegistry.Register(MicrosoftAzureFunctionsWorkerPackageName,
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 9, >= 0) => new PackageVersion("2.1.0")
                            .WithNugetDependency("Microsoft.Azure.Functions.Worker.Core", "2.1.0")
                            .WithNugetDependency("Microsoft.Azure.Functions.Worker.Grpc", "2.1.0"),
                        ( >= 8, >= 0) => new PackageVersion("2.1.0")
                            .WithNugetDependency("Microsoft.Azure.Functions.Worker.Core", "2.1.0")
                            .WithNugetDependency("Microsoft.Azure.Functions.Worker.Grpc", "2.1.0"),
                        ( >= 7, >= 0) => new PackageVersion("2.1.0")
                            .WithNugetDependency("Microsoft.Azure.Functions.Worker.Core", "2.1.0")
                            .WithNugetDependency("Microsoft.Azure.Functions.Worker.Grpc", "2.1.0"),
                ...
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 8, >= 0) => new PackageVersion("9.0.10")
                            .WithNugetDependency("Microsoft.EntityFrameworkCore.Abstractions", "9.0.10")
                            .WithNugetDependency("Microsoft.EntityFrameworkCore.Analyzers", "9.0.10")
            ...
            NugetRegistry.Register(MicrosoftEntityFrameworkCoreToolsPackageName,
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 8, >= 0) => new PackageVersion("9.0.10")
                            .WithNugetDependency("Microsoft.EntityFrameworkCore.Design", "9.0.10"),
                        ( >= 6, >= 0) => new PackageVersion("6.0.32", locked: true),
                ...
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 9, >= 0) => new PackageVersion("9.0.10")
                            .WithNugetDependency("Microsoft.Extensions.Primitives", "9.0.10"),
                        ( >= 8, >= 0) => new PackageVersion("9.0.10")
                            .WithNugetDependency("Microsoft.Extensions.Primitives", "9.0.10"),
