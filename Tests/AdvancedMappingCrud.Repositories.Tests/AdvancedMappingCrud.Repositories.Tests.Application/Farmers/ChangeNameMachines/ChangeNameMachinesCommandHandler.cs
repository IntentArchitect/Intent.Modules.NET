...
namespace AdvancedMappingCrud.Repositories.Tests.Application.Farmers.ChangeNameMachines
{
    ...
    public class ChangeNameMachinesCommandHandler : IRequestHandler<ChangeNameMachinesCommand>
    {
        private readonly IFarmerRepository _farmerRepository;

        [IntentManaged(Mode.Merge)]
        public ChangeNameMachinesCommandHandler(IFarmerRepository farmerRepository)
        {
            _farmerRepository = farmerRepository;
        }

        [IntentManaged(Mode.Fully, Body = Mode.Fully)]
        public async Task Handle(ChangeNameMachinesCommand request, CancellationToken cancellationToken)
        {
            ...
            machines.ChangeName(request.Name);
        }
    }
}