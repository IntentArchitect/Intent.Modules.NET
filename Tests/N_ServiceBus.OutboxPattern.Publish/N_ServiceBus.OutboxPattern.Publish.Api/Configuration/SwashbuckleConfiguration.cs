...
using N_ServiceBus.OutboxPattern.Publish.Domain.Common.Exceptions;
...
namespace N_ServiceBus.OutboxPattern.Publish.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("N_ServiceBus.OutboxPattern.Publish API");
