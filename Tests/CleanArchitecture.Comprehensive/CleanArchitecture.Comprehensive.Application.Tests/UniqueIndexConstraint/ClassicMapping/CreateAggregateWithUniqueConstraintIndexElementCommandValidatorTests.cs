...
{
    public class CreateAggregateWithUniqueConstraintIndexElementCommandValidatorTests
    {
        public static IEnumerable<object[]> GetSuccessfulResultTestData()
        {
            var fixture = new Fixture();
            var testCommand = fixture.Create<CreateAggregateWithUniqueConstraintIndexElementCommand>();
        ...
        public async Task Validate_WithValidCommand_PassesValidation(CreateAggregateWithUniqueConstraintIndexElementCommand testCommand)
        {
            // Arrange
        ...
        {
            var fixture = new Fixture();
            fixture.Customize<CreateAggregateWithUniqueConstraintIndexElementCommand>(comp => comp
            ...
            fixture.Customize<CreateAggregateWithUniqueConstraintIndexElementCommand>(comp => comp
                ...
                .With(x => x.CompUniqueFieldA, () => $"{string.Join(string.Empty, fixture.CreateMany<char>(255))}")
                .With(x => x.CompUniqueFieldB, () => $"{string.Join(string.Empty, fixture.CreateMany<char>(255))}"));
            testCommand = fixture.Create<CreateAggregateWithUniqueConstraintIndexElementCommand>();
        ...
        public async Task Validate_WithInvalidCommand_FailsValidation(
            CreateAggregateWithUniqueConstraintIndexElementCommand testCommand,
        ...
        private ValidationBehaviour<CreateAggregateWithUniqueConstraintIndexElementCommand, System.Guid> GetValidationBehaviour()
        {
            ...
            return new ValidationBehaviour<CreateAggregateWithUniqueConstraintIndexElementCommand, System.Guid>(new[] { new CreateAggregateWithUniqueConstraintIndexElementCommandValidator(aggregateWithUniqueConstraintIndexElementRepository) });
        }
    }
}