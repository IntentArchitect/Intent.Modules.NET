...
namespace Intent.Modules.MongoDb.MongoFramework.FactoryExtensions
{
    [IntentManaged(Mode.Fully, Body = Mode.Merge)]
    public class DependencyInjectionFactoryExtension : FactoryExtensionBase
    {
        public override string Id => "Intent.MongoDb.MongoFramework.DependencyInjectionFactoryExtension";
