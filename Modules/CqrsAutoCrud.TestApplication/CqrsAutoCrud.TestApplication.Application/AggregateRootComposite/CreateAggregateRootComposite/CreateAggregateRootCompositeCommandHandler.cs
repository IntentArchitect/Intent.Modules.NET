...
namespace CqrsAutoCrud.TestApplication.Application.AggregateRootComposite.CreateAggregateRootComposite
{
    ...
    public class CreateAggregateRootCompositeCommandHandler : IRequestHandler<CreateAggregateRootCompositeCommand, Guid>
    {
        private readonly IAggregateRootRepository _aggregateRootRepository;

        [IntentManaged(Mode.Ignore)]
        public CreateAggregateRootCompositeCommandHandler(IAggregateRootRepository aggregateRootRepository)
        {
            _aggregateRootRepository = aggregateRootRepository;
        }

        [IntentManaged(Mode.Fully, Body = Mode.Fully)]
        public async Task<Guid> Handle(CreateAggregateRootCompositeCommand request, CancellationToken cancellationToken)
        {
