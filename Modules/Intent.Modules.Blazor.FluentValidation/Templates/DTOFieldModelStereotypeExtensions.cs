...
namespace Intent.Modules.Blazor.FluentValidation.Templates
{
    ...
    {
        public static Validations GetValidations(this IElement model)
        {
        ...
        public static bool HasValidations(this IElement model)
        {
            return model.HasStereotype("4b54a612-2664-4493-a1f7-dc0623aa03da");
        }

        public static bool TryGetValidations(this IElement model, out Validations stereotype)
        {
