...
{
    public class CustomCollectionEntityAMongoRepository : MongoRepositoryBase<CustomCollectionEntityA, CustomCollectionEntityA>, ICustomCollectionEntityARepository
    {
