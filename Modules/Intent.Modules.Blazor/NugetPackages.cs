        ...
        public void RegisterPackages()
        {
                ...
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 10, >= 0) => new PackageVersion("10.0.9")
                            .WithNugetDependency("Microsoft.AspNetCore.Components.Web", "10.0.9")
                            ...
                            .WithNugetDependency("Microsoft.JSInterop.WebAssembly", "10.0.9"),
                        ( >= 9, >= 0) => new PackageVersion("9.0.17")
                            .WithNugetDependency("Microsoft.AspNetCore.Components.Web", "9.0.17")
                            .WithNugetDependency("Microsoft.Extensions.Configuration.Binder", "9.0.17")
                            .WithNugetDependency("Microsoft.Extensions.Configuration.Json", "9.0.17")
                            .WithNugetDependency("Microsoft.Extensions.Logging", "9.0.17")
                            .WithNugetDependency("Microsoft.JSInterop.WebAssembly", "9.0.17"),
                        ( >= 8, >= 0) => new PackageVersion("8.0.28")
                            .WithNugetDependency("Microsoft.AspNetCore.Components.Web", "8.0.28")
                            ...
                            .WithNugetDependency("Microsoft.JSInterop.WebAssembly", "8.0.28"),
            ...
            NugetRegistry.Register(MicrosoftAspNetCoreComponentsWebAssemblyAuthenticationPackageName,
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 10, >= 0) => new PackageVersion("10.0.9")
                            .WithNugetDependency("Microsoft.AspNetCore.Components.Authorization", "10.0.9")
                            .WithNugetDependency("Microsoft.AspNetCore.Components.Web", "10.0.9"),
                        ( >= 9, >= 0) => new PackageVersion("9.0.17")
                            .WithNugetDependency("Microsoft.AspNetCore.Components.Authorization", "9.0.17")
                            .WithNugetDependency("Microsoft.AspNetCore.Components.Web", "9.0.17"),
                        ( >= 8, >= 0) => new PackageVersion("8.0.28")
                            .WithNugetDependency("Microsoft.AspNetCore.Components.Authorization", "8.0.28")
                            .WithNugetDependency("Microsoft.AspNetCore.Components.Web", "8.0.28"),
                        ( >= 7, >= 0) => new PackageVersion("7.0.20")
            ...
            NugetRegistry.Register(MicrosoftAspNetCoreComponentsWebAssemblyServerPackageName,
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 10, >= 0) => new PackageVersion("10.0.9")
                            .WithNugetDependency("Microsoft.AspNetCore.Components.WebAssembly", "10.0.9"),
                        ( >= 9, >= 0) => new PackageVersion("9.0.17"),
                        ( >= 8, >= 0) => new PackageVersion("8.0.28"),
                        ( >= 7, >= 0) => new PackageVersion("7.0.20"),
                        ( >= 6, >= 0) => new PackageVersion("6.0.36"),
