...
using MassTransit.RequestResponse.Client.Api.Filters;
using MassTransit.RequestResponse.Client.Application;
using MassTransit.RequestResponse.Client.Domain.Common.Exceptions;
...
namespace MassTransit.RequestResponse.Client.Api.Configuration
{
        ...
        public static IServiceCollection ConfigureSwagger(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddSwaggerGen(
                options =>
                {
                    ...
                    //IntentIgnore
                    var applicationXmlFile = Path.Combine(AppContext.BaseDirectory, $"{typeof(Application.DependencyInjection).Assembly.GetName().Name}.xml");
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("MassTransit.RequestResponse.Client API");
