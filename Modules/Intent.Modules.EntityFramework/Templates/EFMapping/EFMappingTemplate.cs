...
//Some initial validation
  ...
  if (UsesImplicitId())
    ...
    foreach (var associationEnd in Model.AssociatedClasses)
    {
        ...
        {
            case Intent.Modules.EntityFramework.Templates.RelationshipType.OneToOne :
                MapOneToOne(associationEnd);
                break;
            case Intent.Modules.EntityFramework.Templates.RelationshipType.OneToMany :
            ...
            #line 183 "C:\Dev\Intent.Modules.NET\Modules\Intent.Modules.EntityFramework\Templates\EFMapping\EFMappingTemplate.tt"
                  break;
            case Intent.Modules.EntityFramework.Templates.RelationshipType.ManyToOne :
            ...
            #line 199 "C:\Dev\Intent.Modules.NET\Modules\Intent.Modules.EntityFramework\Templates\EFMapping\EFMappingTemplate.tt"
                  break;
            case Intent.Modules.EntityFramework.Templates.RelationshipType.ManyToMany :
