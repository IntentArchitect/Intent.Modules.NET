...
namespace EntityFrameworkCore.Repositories.TestApplication.Application.CustomRepoOperationInvocation.Operation_Params3_ReturnsE_Collection1Async
{
    [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
    public class Operation_Params3_ReturnsE_Collection1AsyncQueryHandler : IRequestHandler<Operation_Params3_ReturnsE_Collection1AsyncQuery, List<AggregateRoot1Dto>>
    {
        private readonly ICustomRepository _customRepository;
        private readonly IMapper _mapper;

        [IntentManaged(Mode.Merge)]
        public Operation_Params3_ReturnsE_Collection1AsyncQueryHandler(ICustomRepository customRepository, IMapper mapper)
        {
        ...
        public async Task<List<AggregateRoot1Dto>> Handle(
            Operation_Params3_ReturnsE_Collection1AsyncQuery request,
            CancellationToken cancellationToken)
        {
            var result = await _customRepository.Operation_Params3_ReturnsE_Collection1Async(
                new SpParameter(
