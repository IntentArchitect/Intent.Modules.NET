...
using N_ServiceBus.SQS.Application.Common.Behaviours;
using N_ServiceBus.SQS.Application.Common.Eventing;
using N_ServiceBus.SQS.Application.Common.Validation;
using N_ServiceBus.SQS.Application.Implementation.Animals;
using N_ServiceBus.SQS.Application.IntegrationEvents.EventHandlers;
...
namespace N_ServiceBus.SQS.Application
{
