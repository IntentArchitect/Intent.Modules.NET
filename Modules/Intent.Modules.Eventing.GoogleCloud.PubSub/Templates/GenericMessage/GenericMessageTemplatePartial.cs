...
namespace Intent.Modules.Eventing.GoogleCloud.PubSub.Templates.GenericMessage
{
    [IntentManaged(Mode.Fully, Body = Mode.Merge)]
    partial class GenericMessageTemplate : CSharpTemplateBase<object>
    {
        public const string TemplateId = "Intent.Eventing.GoogleCloud.PubSub.GenericMessage";
