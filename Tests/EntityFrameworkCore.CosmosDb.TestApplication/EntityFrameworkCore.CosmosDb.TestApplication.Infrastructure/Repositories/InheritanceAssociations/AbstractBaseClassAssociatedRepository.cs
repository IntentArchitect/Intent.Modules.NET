...
namespace EntityFrameworkCore.CosmosDb.TestApplication.Infrastructure.Repositories.InheritanceAssociations
{
    ...
    public class AbstractBaseClassAssociatedRepository : RepositoryBase<AbstractBaseClassAssociated, AbstractBaseClassAssociated, ApplicationDbContext>, IAbstractBaseClassAssociatedRepository
    {
        ...
        public async Task<AbstractBaseClassAssociated?> FindByIdAsync(
            Guid id,
            CancellationToken cancellationToken = default)
        {
        ...
        public async Task<AbstractBaseClassAssociated?> FindByIdAsync(
            Guid id,
            Func<IQueryable<AbstractBaseClassAssociated>, IQueryable<AbstractBaseClassAssociated>> queryOptions,
            CancellationToken cancellationToken = default)
        {
            return await FindAsync(x => x.Id == id, queryOptions, cancellationToken);
        }

        public async Task<List<AbstractBaseClassAssociated>> FindByIdsAsync(
            Guid[] ids,
            CancellationToken cancellationToken = default)
        {
