...
namespace Intent.Eventing.MassTransit.Api
{
    ...
    {
        public static MassTransitConsumer GetMassTransitConsumer(this QueryModel model)
        {
        ...
        public static bool HasMassTransitConsumer(this QueryModel model)
        {
            return model.HasStereotype("b37b2302-97f4-4bc0-b3ad-bc04894c305a");
        }

        public static bool TryGetMassTransitConsumer(this QueryModel model, out MassTransitConsumer stereotype)
        {
