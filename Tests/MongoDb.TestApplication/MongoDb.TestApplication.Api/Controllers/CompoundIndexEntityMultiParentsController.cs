...
namespace MongoDb.TestApplication.Api.Controllers
{
    ...
    public class CompoundIndexEntityMultiParentsController : ControllerBase
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            return CreatedAtAction(nameof(FindCompoundIndexEntityMultiParentById), new { id = result }, result);
        }
        ...
        /// <response code="400">One or more validation errors have occurred.</response>
        /// <response code="404">No CompoundIndexEntityMultiParentDto could be found with the provided parameters.</response>
        [HttpGet("{id}")]
