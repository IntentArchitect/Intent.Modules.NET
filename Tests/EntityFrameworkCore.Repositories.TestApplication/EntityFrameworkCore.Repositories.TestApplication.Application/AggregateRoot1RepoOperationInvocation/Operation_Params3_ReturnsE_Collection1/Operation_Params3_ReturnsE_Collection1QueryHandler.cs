...
namespace EntityFrameworkCore.Repositories.TestApplication.Application.AggregateRoot1RepoOperationInvocation.Operation_Params3_ReturnsE_Collection1
{
    ...
    public class Operation_Params3_ReturnsE_Collection1QueryHandler : IRequestHandler<Operation_Params3_ReturnsE_Collection1Query, List<AggregateRoot1Dto>>
    {
        ...
        public Operation_Params3_ReturnsE_Collection1QueryHandler(IAggregateRoot1Repository aggregateRoot1Repository,
            IMapper mapper)
        {
        ...
        {
            var result = _aggregateRoot1Repository.Operation_Params3_ReturnsE_Collection1(new SpParameter(
