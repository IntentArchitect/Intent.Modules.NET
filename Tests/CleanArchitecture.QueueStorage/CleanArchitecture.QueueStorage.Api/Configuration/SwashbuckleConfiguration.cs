...
using CleanArchitecture.QueueStorage.Domain.Common.Exceptions;
...
namespace CleanArchitecture.QueueStorage.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("CleanArchitecture.QueueStorage API");
