...
namespace Intent.Modules.AspNetCore.Swashbuckle.FactoryExtensions
{
    ...
    public class HideRouteParametersFromBodyOperationFilterExtension : FactoryExtensionBase
    {
        public override string Id => "Intent.AspNetCore.Swashbuckle.HideRouteParametersFromBodyOperationFilterExtension";
        ...
        protected override void OnBeforeTemplateExecution(IApplication application)
        {
            ...
            foreach (var template in templates)
            {
                ...
                configureSwaggerOptionsBlock.AddStatement($@"options.OperationFilter<{template.GetHideRouteParametersFromBodyOperationFilterName()}>();");
            }
        }
