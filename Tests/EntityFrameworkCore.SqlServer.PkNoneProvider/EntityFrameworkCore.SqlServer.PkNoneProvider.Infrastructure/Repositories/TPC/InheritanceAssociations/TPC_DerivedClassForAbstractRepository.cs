...
using EntityFrameworkCore.SqlServer.PkNoneProvider.Domain.Repositories.TPC.InheritanceAssociations;
...
namespace EntityFrameworkCore.SqlServer.PkNoneProvider.Infrastructure.Repositories.TPC.InheritanceAssociations
{
    ...
    public class TPC_DerivedClassForAbstractRepository : RepositoryBase<TPC_DerivedClassForAbstract, TPC_DerivedClassForAbstract, ApplicationDbContext>, ITPC_DerivedClassForAbstractRepository
    {
        ...
        public async Task<TPC_DerivedClassForAbstract?> FindByIdAsync(
            Guid id,
            Func<IQueryable<TPC_DerivedClassForAbstract>, IQueryable<TPC_DerivedClassForAbstract>> queryOptions,
            CancellationToken cancellationToken = default)
        {
