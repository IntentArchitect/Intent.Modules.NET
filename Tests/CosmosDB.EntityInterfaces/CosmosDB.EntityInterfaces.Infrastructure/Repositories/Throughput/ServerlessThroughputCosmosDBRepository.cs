...
{
    internal class ServerlessThroughputCosmosDBRepository : CosmosDBRepositoryBase<IServerlessThroughput, ServerlessThroughput, ServerlessThroughputDocument, IServerlessThroughputDocument>, IServerlessThroughputRepository
    {
        ...
        public async Task<IServerlessThroughput?> FindByIdAsync(string id, CancellationToken cancellationToken = default) => await base.FindByIdAsync(id: id, cancellationToken: cancellationToken);
    }
}