...
{
    public class MudBlazorPageViewEntitySkillSampleFilesStaticContentTemplateRegistration : StaticContentTemplateRegistration
    {
        public new const string TemplateId = "Intent.Modules.Blazor.Components.MudBlazor.Templates.StaticContentTemplateRegistrations.MudBlazorPageViewEntitySkillSampleFilesStaticContentTemplateRegistration";

        public MudBlazorPageViewEntitySkillSampleFilesStaticContentTemplateRegistration() : base(TemplateId)
        {
        }
        ...
        protected override ITemplate CreateTemplate(IOutputTarget outputTarget, string fileFullPath, string fileRelativePath, OverwriteBehaviour defaultOverwriteBehaviour)
        {
            return new SkillSampleStaticContentTemplate(
                ...
                skillTemplateId: MudBlazorPageViewEntitySkillTemplate.TemplateId);
        }
    }
}
