...
namespace Intent.AspNetCore.OutputCaching.Redis.Api
{
    ...
    {
        public static CacheEviction GetCacheEviction(this ServiceModel model)
        {
        ...
        public static bool HasCacheEviction(this ServiceModel model)
        {
            return model.HasStereotype(CacheEviction.DefinitionId);
        }

        public static bool TryGetCacheEviction(this ServiceModel model, out CacheEviction stereotype)
        {
        ...
        public static Caching GetCaching(this ServiceModel model)
        {
        ...
        public static bool HasCaching(this ServiceModel model)
        {
            return model.HasStereotype(Caching.DefinitionId);
        }

        public static bool TryGetCaching(this ServiceModel model, out Caching stereotype)
        {
            if (!HasCaching(model))
            {
                stereotype = null;
