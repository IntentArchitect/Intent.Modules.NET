...
{
    internal class NonStringPartitionKeyDynamoDBRepository : DynamoDBRepositoryBase<INonStringPartitionKey, NonStringPartitionKey, NonStringPartitionKeyDocument, int, string>, INonStringPartitionKeyRepository
    {
        public NonStringPartitionKeyDynamoDBRepository(IDynamoDBContext context, DynamoDBUnitOfWork unitOfWork) : base(context, unitOfWork)
        {
        }
    }
}