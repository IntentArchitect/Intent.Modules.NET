...
{
    public class TextIndexEntitySingleParentMapping : IMongoMappingConfiguration<TextIndexEntitySingleParent>
    {
        public string CollectionName => "TextIndexEntitySingleParents";

        public void RegisterCollectionMap()
        {
            if (!BsonClassMap.IsClassMapRegistered(typeof(TextIndexEntitySingleParent)))
            {
                BsonClassMap.RegisterClassMap<TextIndexEntitySingleParent>(
                    mapping =>
                    {
                        mapping.AutoMap();
