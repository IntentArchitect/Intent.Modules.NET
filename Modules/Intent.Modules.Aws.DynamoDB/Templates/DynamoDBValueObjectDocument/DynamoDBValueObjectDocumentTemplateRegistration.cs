...
namespace Intent.Modules.Aws.DynamoDB.Templates.DynamoDBValueObjectDocument
{
    ...
    public class DynamoDBValueObjectDocumentTemplateRegistration : FilePerModelTemplateRegistration<IElement>
    {
        private readonly IMetadataManager _metadataManager;

        public DynamoDBValueObjectDocumentTemplateRegistration(IMetadataManager metadataManager)
        {
            _metadataManager = metadataManager;
        }

        public override string TemplateId => DynamoDBValueObjectDocumentTemplate.TemplateId;

        [IntentManaged(Mode.Fully)]
        public override ITemplate CreateTemplateInstance(IOutputTarget outputTarget, IElement model)
        {
            return new DynamoDBValueObjectDocumentTemplate(outputTarget, model);
        }
