                ...
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 9, >= 0) => new PackageVersion("15.1.3")
                            ...
                            .WithNugetDependency("HotChocolate.Fetching", "15.1.3")
                            .WithNugetDependency("HotChocolate.Types.CursorPagination.Extensions", "15.1.3")
                            .WithNugetDependency("HotChocolate.Types.CursorPagination", "15.1.3")
