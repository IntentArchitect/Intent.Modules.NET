...
using EntityFrameworkCore.MaintainColumnOrder.Tests.Application.Common.Models;
...
namespace EntityFrameworkCore.MaintainColumnOrder.Tests.Infrastructure.Services
{
