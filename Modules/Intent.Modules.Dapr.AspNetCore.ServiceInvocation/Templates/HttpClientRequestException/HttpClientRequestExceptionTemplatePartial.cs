...
namespace Intent.Modules.Dapr.AspNetCore.ServiceInvocation.Templates.HttpClientRequestException
{
    [IntentManaged(Mode.Ignore)]
    public class HttpClientRequestExceptionTemplate : HttpClientRequestExceptionTemplateBase
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Intent.Dapr.AspNetCore.ServiceInvocation.HttpClientRequestException";
