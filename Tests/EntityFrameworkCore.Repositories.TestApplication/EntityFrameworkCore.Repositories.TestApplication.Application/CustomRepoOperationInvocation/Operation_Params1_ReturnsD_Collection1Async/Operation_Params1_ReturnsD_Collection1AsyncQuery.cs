...
{
    public class Operation_Params1_ReturnsD_Collection1AsyncQuery : IRequest<List<SpResultDto>>, IQuery
    {
        public Operation_Params1_ReturnsD_Collection1AsyncQuery(byte[] attributeBinary,
            bool attributeBool,
            byte attributeByte,
