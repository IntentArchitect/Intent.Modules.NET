        ...
        public void RegisterPackages()
        {
                ...
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 9, >= 0) => new PackageVersion("9.0.9")
                            .WithNugetDependency("Microsoft.AspNetCore.Components.Web", "9.0.9")
                            ...
                            .WithNugetDependency("Microsoft.JSInterop.WebAssembly", "9.0.9"),
                        ( >= 8, >= 0) => new PackageVersion("8.0.20")
                            .WithNugetDependency("Microsoft.AspNetCore.Components.Web", "8.0.20")
                            ...
                            .WithNugetDependency("Microsoft.JSInterop.WebAssembly", "8.0.20"),
            ...
            NugetRegistry.Register(MicrosoftAspNetCoreComponentsWebAssemblyAuthenticationPackageName,
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 9, >= 0) => new PackageVersion("9.0.9")
                            .WithNugetDependency("Microsoft.AspNetCore.Components.Authorization", "9.0.9")
                            .WithNugetDependency("Microsoft.AspNetCore.Components.Web", "9.0.9"),
                        ( >= 8, >= 0) => new PackageVersion("8.0.20")
                            .WithNugetDependency("Microsoft.AspNetCore.Components.Authorization", "8.0.20")
                            .WithNugetDependency("Microsoft.AspNetCore.Components.Web", "8.0.20"),
                        ( >= 7, >= 0) => new PackageVersion("7.0.20")
