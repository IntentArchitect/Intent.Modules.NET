...
namespace Intent.Modules.AspNetCore.Grpc.Api
{
    public static class OperationModelStereotypeExtensions
    {
        public static ExposeWithGRPC GetExposeWithGRPC(this OperationModel model)
        {
        ...
        public static bool HasExposeWithGRPC(this OperationModel model)
        {
            return model.HasStereotype(ExposeWithGRPC.DefinitionId);
        }

        public static bool TryGetExposeWithGRPC(this OperationModel model, out ExposeWithGRPC stereotype)
        {
