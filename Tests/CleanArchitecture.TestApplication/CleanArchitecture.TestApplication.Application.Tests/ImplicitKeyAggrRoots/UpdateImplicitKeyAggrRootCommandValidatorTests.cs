...
namespace CleanArchitecture.TestApplication.Application.Tests.ImplicitKeyAggrRoots
{
    public class UpdateImplicitKeyAggrRootCommandValidatorTests
    {
        ...
        public async Task Validate_WithInvalidCommand_FailsValidation(UpdateImplicitKeyAggrRootCommand testCommand, string expectedPropertyName, string expectedPhrase)
        {
            // Arrange
            var validator = GetValidationBehaviour();
            // Act
