...
#line hidden
  ...
  if (ExecutionContext.Settings.GetMultitenancySettings().Store().IsEfcore()) { 
            ...
            #line default
            #line hidden
            this.Write(", TenantInfo>() // See https://www.finbuckle.com/MultiTenant/Docs/v6.5.1/Stores#efcore-store\r\n");
            ...
            #line default
            #line hidden
            this.Write("                .WithInMemoryStore(SetupInMemoryStore) // See https://www.finbuckle.com/MultiTenant/Docs/v6.5.1/Stores#in-memory-store\r\n");
            ...
            #line default
            #line hidden
            this.Write("                .WithConfigurationStore() // See https://www.finbuckle.com/MultiTenant/Docs/v6.5.1/Stores#configuration-store\r\n");
  ...
  if (ExecutionContext.Settings.GetMultitenancySettings().Strategy().IsHeader()) { 
            ...
            #line default
            #line hidden
            this.Write("                .WithHeaderStrategy(\"X-Tenant-Identifier\"); // See https://www.finbuckle.com/MultiTenant/Docs/v6.5.1/Strategies#header-strategy\r\n");
            ...
            #line default
            #line hidden
            this.Write("                .WithHostStrategy(); // default pattern is __tenant__.* (e.g. https://tenantidentifier.example.com). See https://www.finbuckle.com/MultiTenant/Docs/v6.5.1/Strategies#host-strategy\r\n");
            ...
            #line default
            #line hidden
            this.Write("                .WithClaimStrategy(); // default claim value with type __tenant__. See https://www.finbuckle.com/MultiTenant/Docs/v6.5.1/Strategies#claim-strategy\r\n");
