...
namespace Intent.Modules.Eventing.MassTransit.Templates.Consumer
{
    ...
    public class ConsumerTemplateRegistration : FilePerModelTemplateRegistration<MessageHandlerModel>
    {
        private readonly IMetadataManager _metadataManager;

        public ConsumerTemplateRegistration(IMetadataManager metadataManager)
        {
            _metadataManager = metadataManager;
        }

        public override string TemplateId => ConsumerTemplate.TemplateId;

        public override ITemplate CreateTemplateInstance(IOutputTarget outputTarget, MessageHandlerModel model)
        {
            return new ConsumerTemplate(outputTarget, model);
        }
