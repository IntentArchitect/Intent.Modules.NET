...
namespace EntityFrameworkCore.Repositories.TestApplication.Application.OperationInvocation.AggregateRootOperationParams3Async
{
    ...
    public class AggregateRootOperationParams3AsyncCommandHandler : IRequestHandler<AggregateRootOperationParams3AsyncCommand>
    {
        private readonly IAggregateRoot1Repository _aggregateRoot1Repository;
        [IntentManaged(Mode.Merge)]
        public AggregateRootOperationParams3AsyncCommandHandler(IAggregateRoot1Repository aggregateRoot1Repository)
        {
            _aggregateRoot1Repository = aggregateRoot1Repository;
        }

        [IntentManaged(Mode.Fully, Body = Mode.Fully)]
        public async Task Handle(AggregateRootOperationParams3AsyncCommand request, CancellationToken cancellationToken)
        {
