...
using Subscribe.MassTransit.OutboxEF.Domain.Common.Exceptions;
...
namespace Subscribe.MassTransit.OutboxEF.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("Subscribe.MassTransit.OutboxEF API");
