...
{
    public class Operation_Params1_ReturnsD_Collection0Query : IRequest<SpResultDto>, IQuery
    {
        public Operation_Params1_ReturnsD_Collection0Query(byte[] attributeBinary,
            bool attributeBool,
            byte attributeByte,
