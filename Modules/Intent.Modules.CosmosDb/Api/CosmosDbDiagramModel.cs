...
namespace Intent.CosmosDb.Api
{
    ...
    public class CosmosDBDiagramModel : IMetadataModel, IHasStereotypes, IHasName
    {
        ...
        public const string SpecializationTypeId = "ab2d8076-f373-4144-8475-dfb0490a3bd0"; // i used the newguid tool in vs to generate this, not sure if it is bound to an already existing intent id
