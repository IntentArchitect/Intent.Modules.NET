...
using System.Linq;
using Intent.Engine;
using Intent.Modules.Blazor.Templates.Templates.AI.BlazorDialogEditingEntitySkill;
...
{
    public class BlazorDialogEditingEntitySkillSampleFilesStaticContentTemplateRegistration : StaticContentTemplateRegistration
    {
        public new const string TemplateId = "Intent.Modules.Blazor.Templates.Templates.StaticContentTemplateRegistrations.BlazorDialogEditingEntitySkillSampleFilesStaticContentTemplateRegistration";

        public BlazorDialogEditingEntitySkillSampleFilesStaticContentTemplateRegistration() : base(TemplateId)
        {
        }
        ...
        protected override ITemplate CreateTemplate(IOutputTarget outputTarget, string fileFullPath, string fileRelativePath, OverwriteBehaviour defaultOverwriteBehaviour)
        {
            return new SkillSampleStaticContentTemplate(
                ...
                skillTemplateId: BlazorDialogEditingEntitySkillTemplate.TemplateId);
        }
