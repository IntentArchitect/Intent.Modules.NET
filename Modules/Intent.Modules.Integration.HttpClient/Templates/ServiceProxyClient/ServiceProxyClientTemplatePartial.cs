...
namespace Intent.Modules.Integration.HttpClient.Templates.ServiceProxyClient
{
    [IntentManaged(Mode.Fully, Body = Mode.Merge)]
    partial class ServiceProxyClientTemplate : CSharpTemplateBase<ServiceProxyModel>
    {
        public const string TemplateId = "Intent.Integration.HttpClient.ServiceProxyClient";
