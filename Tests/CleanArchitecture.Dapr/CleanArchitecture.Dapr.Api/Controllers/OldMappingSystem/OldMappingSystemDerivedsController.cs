...
using CleanArchitecture.Dapr.Application.OldMappingSystem.Deriveds;
using CleanArchitecture.Dapr.Application.OldMappingSystem.Deriveds.CreateDerived;
using CleanArchitecture.Dapr.Application.OldMappingSystem.Deriveds.DeleteDerived;
using CleanArchitecture.Dapr.Application.OldMappingSystem.Deriveds.GetDerivedById;
using CleanArchitecture.Dapr.Application.OldMappingSystem.Deriveds.GetDeriveds;
using CleanArchitecture.Dapr.Application.OldMappingSystem.Deriveds.UpdateDerived;
...
{
    [ApiController]
    public class OldMappingSystemDerivedsController : ControllerBase
    {
        private readonly ISender _mediator;

        public OldMappingSystemDerivedsController(ISender mediator)
        {
