...
namespace Intent.Modules.Blazor.Templates.Templates.Server
{
    using Intent.Blazor.Api;

    /// <summary>
    /// Shared logic for every Server (Render On Server) Razor component variant (plain Component,
    /// Page, Dialog): page directive/title, secured "@attribute" directives, edit-preserving
    /// <see cref="TransformText"/> merging, the auth-mode output file name suffix, and the AI
    /// intention-context builder.
    /// </summary>
    public abstract partial class ServerComponentRazorTemplateBase : RazorComponentTemplateBase<ComponentModel>, IAuthPageRazorTemplate
    {
        ...
        protected ServerComponentRazorTemplateBase(string templateId, IOutputTarget outputTarget, ComponentModel model) : base(templateId, outputTarget, model)
        {
