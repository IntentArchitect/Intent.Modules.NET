...
{
    public class CompoundIndexEntitySingleParentMongoRepository : MongoRepositoryBase<CompoundIndexEntitySingleParent>, ICompoundIndexEntitySingleParentRepository
    {
