...
{
    public class K_MultipleAggregateNavMongoRepository : MongoRepositoryBase<K_MultipleAggregateNav, K_MultipleAggregateNav>, IK_MultipleAggregateNavRepository
    {
