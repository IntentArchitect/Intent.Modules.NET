...
{
    internal class NonStringPartitionKeyDynamoDBRepository : DynamoDBRepositoryBase<NonStringPartitionKey, NonStringPartitionKeyDocument, int, string>, INonStringPartitionKeyRepository
    {
