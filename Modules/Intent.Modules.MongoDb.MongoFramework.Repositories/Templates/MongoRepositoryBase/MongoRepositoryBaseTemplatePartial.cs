...
namespace Intent.Modules.MongoDb.MongoFramework.Repositories.Templates.MongoRepositoryBase
{
    [IntentManaged(Mode.Fully, Body = Mode.Merge, Signature = Mode.Merge)]
    public partial class MongoRepositoryBaseTemplate : CSharpTemplateBase<object>, ICSharpFileBuilderTemplate
    {
        public const string TemplateId = "Intent.MongoDb.MongoFramework.Repositories.MongoRepositoryBase";
