...
namespace MassTransit.RabbitMQ.Services.RequestResponse.CQRS
{
    public class QueryGuidReturn
    {
        ...
        public QueryGuidReturn(MassTransit.RequestResponse.Client.Application.IntegrationServices.Contracts.RabbitMQ.Services.RequestResponse.CQRS.QueryGuidReturn dto)
        {
            Input = dto.Input;
        }
