...
namespace EntityFrameworkCore.Repositories.TestApplication.Application.CustomRepoOperationInvocation.Operation_Params3_ReturnsD_Collection0
{
    ...
    public class Operation_Params3_ReturnsD_Collection0QueryHandler : IRequestHandler<Operation_Params3_ReturnsD_Collection0Query, SpResultDto>
    {
        ...
        public Operation_Params3_ReturnsD_Collection0QueryHandler(ICustomRepository customRepository, IMapper mapper)
        {
