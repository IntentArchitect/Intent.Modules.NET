...
{
    public class UpdateCustomerCTCommandValidatorTests
    {
        public static IEnumerable<object[]> GetSuccessfulResultTestData()
        {
            var fixture = new Fixture();
            var testCommand = fixture.Create<UpdateCustomerCTCommand>();
            yield return new object[] { testCommand };
        }

        [Theory]
        [MemberData(nameof(GetSuccessfulResultTestData))]
        public async Task Validate_WithValidCommand_PassesValidation(UpdateCustomerCTCommand testCommand)
        {
            // Arrange
        ...
        {
            var fixture = new Fixture();
            fixture.Customize<UpdateCustomerCTCommand>(comp => comp.With(x => x.Name, () => default));
            var testCommand = fixture.Create<UpdateCustomerCTCommand>();
        ...
        public async Task Validate_WithInvalidCommand_FailsValidation(
            UpdateCustomerCTCommand testCommand,
        ...
        private ValidationBehaviour<UpdateCustomerCTCommand, Unit> GetValidationBehaviour()
        {
            return new ValidationBehaviour<UpdateCustomerCTCommand, Unit>(new[] { new UpdateCustomerCTCommandValidator() });
        }
    }
}