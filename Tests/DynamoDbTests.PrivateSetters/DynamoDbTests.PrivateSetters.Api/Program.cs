...
using DynamoDbTests.PrivateSetters.Api.Configuration;
using DynamoDbTests.PrivateSetters.Api.Filters;
using DynamoDbTests.PrivateSetters.Api.Logging;
using DynamoDbTests.PrivateSetters.Application;
using DynamoDbTests.PrivateSetters.Infrastructure;
...
namespace DynamoDbTests.PrivateSetters.Api
{
