...
using EfCore.SecondLevelCaching.Api.Controllers.ResponseTypes;
using EfCore.SecondLevelCaching.Application.Invoices;
using EfCore.SecondLevelCaching.Application.Invoices.CreateInvoice;
using EfCore.SecondLevelCaching.Application.Invoices.DeleteInvoice;
using EfCore.SecondLevelCaching.Application.Invoices.GetInvoiceById;
using EfCore.SecondLevelCaching.Application.Invoices.GetInvoices;
using EfCore.SecondLevelCaching.Application.Invoices.UpdateInvoice;
...
namespace EfCore.SecondLevelCaching.Api.Controllers
{
    [ApiController]
