using System.Linq;
using Intent.Engine;
using Intent.Modules.AspNetCore.ODataQuery.Templates;
...
namespace Intent.Modules.AspNetCore.ODataQuery.FactoryExtensions
{
    ...
    {
        public override string Id => "Intent.AspNetCore.ODataQuery.SwaggerConfigExtension";
        ...
        protected override void OnBeforeTemplateExecution(IApplication application)
        {
            ...
            configureSwaggerOptionsBlock.AddStatement($@"options.OperationFilter<{template.GetODataQuerySwaggerFilterName()}>();");
        }
