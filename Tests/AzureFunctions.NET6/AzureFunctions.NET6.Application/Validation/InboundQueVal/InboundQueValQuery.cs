...
namespace AzureFunctions.NET6.Application.Validation.InboundQueVal
{
    public class InboundQueValQuery : IRequest<DummyResultDto>, IQuery
    {
        public InboundQueValQuery(string rangeStr,
            string minStr,
            string maxStr,
            int rangeInt,
            int minInt,
