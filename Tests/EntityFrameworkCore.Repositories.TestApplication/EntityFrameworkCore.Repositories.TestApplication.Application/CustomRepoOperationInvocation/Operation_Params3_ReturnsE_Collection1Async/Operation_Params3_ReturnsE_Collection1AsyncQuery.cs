...
{
    public class Operation_Params3_ReturnsE_Collection1AsyncQuery : IRequest<List<AggregateRoot1Dto>>, IQuery
    {
        public Operation_Params3_ReturnsE_Collection1AsyncQuery(byte[] attributeBinary,
            bool attributeBool,
            byte attributeByte,
