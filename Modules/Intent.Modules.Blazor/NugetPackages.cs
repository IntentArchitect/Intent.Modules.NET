                ...
                (framework) => framework switch
                    {
                        ( >= 9, 0) => new PackageVersion("9.0.3")
                            .WithNugetDependency("Microsoft.AspNetCore.Components.Web", "9.0.3")
                            ...
                            .WithNugetDependency("Microsoft.JSInterop.WebAssembly", "9.0.3"),
                        ( >= 8, 0) => new PackageVersion("8.0.14")
                            .WithNugetDependency("Microsoft.AspNetCore.Components.Web", "8.0.14")
                            ...
                            .WithNugetDependency("Microsoft.JSInterop.WebAssembly", "8.0.14"),
