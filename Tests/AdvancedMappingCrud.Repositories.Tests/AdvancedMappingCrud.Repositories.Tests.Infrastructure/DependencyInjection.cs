...
using AdvancedMappingCrud.Repositories.Tests.Infrastructure.Repositories.EdgeCompositeHandling;
...
using AdvancedMappingCrud.Repositories.Tests.Infrastructure.Repositories.NullableNested;
...
namespace AdvancedMappingCrud.Repositories.Tests.Infrastructure
{
    public static class DependencyInjection
    {
        public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddTransient<ILevel1Repository, Level1Repository>();
