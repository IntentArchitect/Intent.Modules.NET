...
using CompositePublishTest.Infrastructure.Eventing.Solace;
...
namespace CompositePublishTest.Infrastructure.Configuration
{
    ...
    {
        public static void ConfigureSolace(this IServiceCollection services, IConfiguration configuration, MessageBrokerRegistry registry)
        {
            ...
            services.AddSingleton<MessageRegistry>(sp => new MessageRegistry(configuration, registry));
