...
namespace EntityFrameworkCore.CosmosDb.TestApplication.Infrastructure.Repositories.InheritanceAssociations
{
    ...
    public class ConcreteBaseClassAssociatedRepository : RepositoryBase<ConcreteBaseClassAssociated, ConcreteBaseClassAssociated, ApplicationDbContext>, IConcreteBaseClassAssociatedRepository
    {
        public ConcreteBaseClassAssociatedRepository(ApplicationDbContext dbContext, IMapper mapper) : base(dbContext, mapper)
        {
        }
        ...
        public async Task<ConcreteBaseClassAssociated?> FindByIdAsync(
            Guid id,
            Func<IQueryable<ConcreteBaseClassAssociated>, IQueryable<ConcreteBaseClassAssociated>> queryOptions,
            CancellationToken cancellationToken = default)
        {
