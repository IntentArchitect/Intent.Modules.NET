...
namespace MassTransit.AzureServiceBus.Services.RequestResponse.CQRS
{
    public class QueryResponseDtoReturn
    {
        ...
        public QueryResponseDtoReturn(MassTransit.RequestResponse.Client.Application.IntegrationServices.Contracts.AzureServiceBus.Services.RequestResponse.CQRS.QueryResponseDtoReturn dto)
        {
            Input = dto.Input;
        }
