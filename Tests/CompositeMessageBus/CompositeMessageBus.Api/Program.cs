using CompositeMessageBus.Api.Configuration;
using CompositeMessageBus.Api.Filters;
using CompositeMessageBus.Api.Logging;
...
namespace CompositeMessageBus.Api
{
