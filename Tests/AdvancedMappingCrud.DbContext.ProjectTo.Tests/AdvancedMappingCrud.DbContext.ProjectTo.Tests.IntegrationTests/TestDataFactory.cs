using AdvancedMappingCrud.DbContext.ProjectTo.Tests.IntegrationTests.HttpClients.Customers;
...
using AdvancedMappingCrud.DbContext.ProjectTo.Tests.IntegrationTests.Tests.Services.Customers;
using AdvancedMappingCrud.DbContext.ProjectTo.Tests.IntegrationTests.Tests.Services.Orders;
using AdvancedMappingCrud.DbContext.ProjectTo.Tests.IntegrationTests.Tests.Services.Products;
using AutoFixture;
