...
namespace Intent.Modules.Blazor.Templates.Templates.Client.RazorComponentStyle
{
    ...
    public class RazorComponentStyleTemplateRegistration : FilePerModelTemplateRegistration<ComponentModel>
    {
        private readonly IMetadataManager _metadataManager;

        public RazorComponentStyleTemplateRegistration(IMetadataManager metadataManager)
        {
            _metadataManager = metadataManager;
        }

        public override string TemplateId => RazorComponentStyleTemplate.TemplateId;

        [IntentManaged(Mode.Fully)]
        public override ITemplate CreateTemplateInstance(IOutputTarget outputTarget, ComponentModel model)
        {
            return new RazorComponentStyleTemplate(outputTarget, model);
        }
