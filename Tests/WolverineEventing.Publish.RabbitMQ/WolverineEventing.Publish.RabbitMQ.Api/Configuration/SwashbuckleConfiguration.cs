...
using WolverineEventing.Publish.RabbitMQ.Api.Filters;
using WolverineEventing.Publish.RabbitMQ.Application;
using WolverineEventing.Publish.RabbitMQ.Domain.Common.Exceptions;

[assembly: DefaultIntentManaged(Mode.Fully)]
[assembly: IntentTemplate("Intent.AspNetCore.Swashbuckle.SwashbuckleConfiguration", Version = "1.0")]

namespace WolverineEventing.Publish.RabbitMQ.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("WolverineEventing.Publish.RabbitMQ API");
