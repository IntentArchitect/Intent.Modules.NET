...
public class InheritanceTPHTests : SharedDatabaseFixture<ApplicationDbContext, InheritanceTPHTests>
{
    ...
    public void Test_Inheritance_TPH_AbstractBaseClass()
    {
        ...
        DbContext.TPHInheritanceAssociationsDerivedClassForAbstracts.Add(derived);
        ...
        Assert.Equal(derived, DbContext.TPHInheritanceAssociationsDerivedClassForAbstracts.Single(p => p.Id == derived.Id));
    ...
    public void Test_Inheritance_TPH_ConcreteBaseClass()
    {
        ...
        DbContext.TPHInheritanceAssociationsConcreteBaseClassAssociateds.Add(concreteBaseAssociated);

        DbContext.SaveChanges();

        Assert.Equal((object)concreteBase, (object)DbContext.ConcreteBaseClasses.SingleOrDefault(p => p.Id == concreteBase.Id));
        Assert.Equal(concreteBase, DbContext.TPHInheritanceAssociationsConcreteBaseClassAssociateds.Single(p => p.Id == concreteBaseAssociated.Id).ConcreteBaseClass);
        ...
        DbContext.TPHInheritanceAssociationsConcreteBaseClassAssociateds.Add(concreteBaseAssociatedForDerived);
        ...
        Assert.Equal(derived, DbContext.TPHInheritanceAssociationsConcreteBaseClassAssociateds.Single(p => p.Id == concreteBaseAssociatedForDerived.Id).ConcreteBaseClass);
    }
    ...
    public void Test_Inheritance_TPH_CompositeForeignKey()
    {
        ...
        DbContext.TPHInheritanceAssociationsFkBaseClasses.Add(baseClass);
        ...
        Assert.Equal(baseClass, DbContext.TPHInheritanceAssociationsFkBaseClasses.Single(p => p.CompositeKeyA == baseClass.CompositeKeyA && p.CompositeKeyB == baseClass.CompositeKeyB));
        ...
        DbContext.TPHInheritanceAssociationsFkDerivedClasses.Add(derived);

        var associated = new FkAssociatedClass();
        associated.FkDerivedClass = derived;
        associated.AssociatedField = "Associated Value";
        DbContext.TPHInheritanceAssociationsFkAssociatedClasses.Add(associated);
        ...
        Assert.Equal(derived, DbContext.TPHInheritanceAssociationsFkDerivedClasses.Single(p => p.CompositeKeyA == derived.CompositeKeyA && p.CompositeKeyB == derived.CompositeKeyB));
        Assert.Equal(derived, DbContext.TPHInheritanceAssociationsFkAssociatedClasses.Single(p => p.Id == associated.Id).FkDerivedClass);
    ...
    public void Test_Inheritance_TPH_Polymorphic()
    {
        ...
        DbContext.TPHPolymorphicPoly_TopLevels.Add(topLevel);
        ...
        DbContext.TPHPolymorphicPoly_SecondLevels.Add(secondLevel);
        
        DbContext.SaveChanges();
        
        var retrievedTopLevel = DbContext.TPHPolymorphicPoly_TopLevels.Single(p => p.Id == topLevel.Id);
        ...
        var retrievedSecondLevel = DbContext.TPHPolymorphicPoly_SecondLevels.Single(p => p.Id == secondLevel.Id);
        ...
        (Poly_RootAbstract_Aggr, Poly_BaseClassNonAbstract, Poly_ConcreteA, Poly_ConcreteB) CreateNewPolyClasses()
        {
            ...
            DbContext.TPHPolymorphicPoly_RootAbstract_Aggrs.Add(rootAbstractAggr);
            ...
            DbContext.TPHPolymorphicPoly_ConcreteBs.Add(concreteB);
