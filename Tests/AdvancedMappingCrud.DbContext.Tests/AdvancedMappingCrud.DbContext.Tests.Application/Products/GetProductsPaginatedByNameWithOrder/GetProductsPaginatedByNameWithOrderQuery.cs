...
{
    public class GetProductsPaginatedByNameWithOrderQuery : IRequest<PagedResult<ProductDto>>, IQuery
    {
        public GetProductsPaginatedByNameWithOrderQuery(string name, int pageNo, int pageSize, string orderBy)
        {
            Name = name;
            PageNo = pageNo;
            PageSize = pageSize;
