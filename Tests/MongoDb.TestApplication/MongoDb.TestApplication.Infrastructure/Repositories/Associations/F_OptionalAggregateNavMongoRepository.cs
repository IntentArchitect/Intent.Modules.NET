...
{
    public class F_OptionalAggregateNavMongoRepository : MongoRepositoryBase<F_OptionalAggregateNav, F_OptionalAggregateNav>, IF_OptionalAggregateNavRepository
    {
