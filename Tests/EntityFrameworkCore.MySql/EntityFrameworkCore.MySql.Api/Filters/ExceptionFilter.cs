...
using EntityFrameworkCore.MySql.Application.Common.Exceptions;
using EntityFrameworkCore.MySql.Domain.Common.Exceptions;
...
namespace EntityFrameworkCore.MySql.Api.Filters
{
