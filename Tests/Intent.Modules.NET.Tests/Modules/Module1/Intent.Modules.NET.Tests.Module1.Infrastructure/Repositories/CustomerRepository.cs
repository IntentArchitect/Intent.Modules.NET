...
namespace Intent.Modules.NET.Tests.Module1.Infrastructure.Repositories
{
    [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
    public class CustomerRepository : RepositoryBase<Customer, Customer, Module1DbContext>, ICustomerRepository
    {
        public CustomerRepository(Module1DbContext dbContext, IMapper mapper) : base(dbContext, mapper)
        {
        }
