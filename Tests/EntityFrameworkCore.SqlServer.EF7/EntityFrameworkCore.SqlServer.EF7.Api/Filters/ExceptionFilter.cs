...
using EntityFrameworkCore.SqlServer.EF7.Application.Common.Exceptions;
using EntityFrameworkCore.SqlServer.EF7.Domain.Common.Exceptions;
...
namespace EntityFrameworkCore.SqlServer.EF7.Api.Filters
{
