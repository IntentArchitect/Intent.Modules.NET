...
namespace AdvancedMappingCrud.Repositories.Tests.Infrastructure.Repositories.OperationMapping
{
    [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
    public class UserRepository : RepositoryBase<User, User, ApplicationDbContext>, Domain.Repositories.OperationMapping.IUserRepository
    {
