...
using EntityFrameworkCore.SqlServer.EF10.Application.Common.Interfaces;
...
using EntityFrameworkCore.SqlServer.EF10.Domain.Entities.Accounts;
using EntityFrameworkCore.SqlServer.EF10.Domain.Entities.Accounts.NotSchema;
...
using EntityFrameworkCore.SqlServer.EF10.Domain.Entities.Geometry;
using EntityFrameworkCore.SqlServer.EF10.Domain.Entities.Indexes;
using EntityFrameworkCore.SqlServer.EF10.Domain.Entities.NestedAssociations;
using EntityFrameworkCore.SqlServer.EF10.Domain.Entities.NotSchema;
using EntityFrameworkCore.SqlServer.EF10.Domain.Entities.PkDataSources;
using EntityFrameworkCore.SqlServer.EF10.Domain.Entities.SoftDelete;
using EntityFrameworkCore.SqlServer.EF10.Domain.Entities.TimeConcepts;
using EntityFrameworkCore.SqlServer.EF10.Domain.Entities.TPC.InheritanceAssociations;
using EntityFrameworkCore.SqlServer.EF10.Domain.Entities.TPC.Polymorphic;
using EntityFrameworkCore.SqlServer.EF10.Domain.Entities.TPH.InheritanceAssociations;
using EntityFrameworkCore.SqlServer.EF10.Domain.Entities.TPH.Polymorphic;
...
using EntityFrameworkCore.SqlServer.EF10.Infrastructure.Interceptors;
using EntityFrameworkCore.SqlServer.EF10.Infrastructure.Persistence.Configurations;
using EntityFrameworkCore.SqlServer.EF10.Infrastructure.Persistence.Configurations.Accounts;
using EntityFrameworkCore.SqlServer.EF10.Infrastructure.Persistence.Configurations.Accounts.NotSchema;
using EntityFrameworkCore.SqlServer.EF10.Infrastructure.Persistence.Configurations.Associations;
using EntityFrameworkCore.SqlServer.EF10.Infrastructure.Persistence.Configurations.BasicAudit;
using EntityFrameworkCore.SqlServer.EF10.Infrastructure.Persistence.Configurations.Enums;
using EntityFrameworkCore.SqlServer.EF10.Infrastructure.Persistence.Configurations.ExplicitKeys;
using EntityFrameworkCore.SqlServer.EF10.Infrastructure.Persistence.Configurations.Geometry;
using EntityFrameworkCore.SqlServer.EF10.Infrastructure.Persistence.Configurations.Indexes;
using EntityFrameworkCore.SqlServer.EF10.Infrastructure.Persistence.Configurations.NestedAssociations;
using EntityFrameworkCore.SqlServer.EF10.Infrastructure.Persistence.Configurations.NotSchema;
using EntityFrameworkCore.SqlServer.EF10.Infrastructure.Persistence.Configurations.PkDataSources;
using EntityFrameworkCore.SqlServer.EF10.Infrastructure.Persistence.Configurations.SoftDelete;
using EntityFrameworkCore.SqlServer.EF10.Infrastructure.Persistence.Configurations.TimeConcepts;
using EntityFrameworkCore.SqlServer.EF10.Infrastructure.Persistence.Configurations.TPC.InheritanceAssociations;
using EntityFrameworkCore.SqlServer.EF10.Infrastructure.Persistence.Configurations.TPC.Polymorphic;
using EntityFrameworkCore.SqlServer.EF10.Infrastructure.Persistence.Configurations.TPH.InheritanceAssociations;
using EntityFrameworkCore.SqlServer.EF10.Infrastructure.Persistence.Configurations.TPH.Polymorphic;
using EntityFrameworkCore.SqlServer.EF10.Infrastructure.Persistence.Configurations.TPT.InheritanceAssociations;
using EntityFrameworkCore.SqlServer.EF10.Infrastructure.Persistence.Configurations.TPT.Polymorphic;
using EntityFrameworkCore.SqlServer.EF10.Infrastructure.Persistence.Configurations.ValueObjects;
...
namespace EntityFrameworkCore.SqlServer.EF10.Infrastructure.Persistence
{
    public class ApplicationDbContext : DbContext, IUnitOfWork
    {
        ...
        public DbSet<AutoGeneratedDataSourceEntity> AutoGeneratedDataSourceEntities { get; set; }
        public DbSet<CompKeyAutoGeneratedDataSourceEntity> CompKeyAutoGeneratedDataSourceEntities { get; set; }
        public DbSet<CompKeyDefaultDataSourceEntity> CompKeyDefaultDataSourceEntities { get; set; }
        public DbSet<CompKeyUserSuppliedDataSourceEntity> CompKeyUserSuppliedDataSourceEntities { get; set; }
        public DbSet<DefaultDataSourceEntity> DefaultDataSourceEntities { get; set; }
        public DbSet<UserSuppliedDataSourceEntity> UserSuppliedDataSourceEntities { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfiguration(new AutoGeneratedDataSourceEntityConfiguration());
            modelBuilder.ApplyConfiguration(new CompKeyAutoGeneratedDataSourceEntityConfiguration());
            modelBuilder.ApplyConfiguration(new CompKeyDefaultDataSourceEntityConfiguration());
            modelBuilder.ApplyConfiguration(new CompKeyUserSuppliedDataSourceEntityConfiguration());
            modelBuilder.ApplyConfiguration(new DefaultDataSourceEntityConfiguration());
            modelBuilder.ApplyConfiguration(new UserSuppliedDataSourceEntityConfiguration());
