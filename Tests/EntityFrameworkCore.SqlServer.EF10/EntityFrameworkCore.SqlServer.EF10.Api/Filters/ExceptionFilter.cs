...
using EntityFrameworkCore.SqlServer.EF10.Application.Common.Exceptions;
using EntityFrameworkCore.SqlServer.EF10.Domain.Common.Exceptions;
...
namespace EntityFrameworkCore.SqlServer.EF10.Api.Filters
{
