...
namespace EntityFrameworkCore.Repositories.TestApplication.Application.AggregateRoot1RepoOperationInvocation.Operation_Params3_ReturnsE_Collection0Async
{
    [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
    public class Operation_Params3_ReturnsE_Collection0AsyncQueryHandler : IRequestHandler<Operation_Params3_ReturnsE_Collection0AsyncQuery, AggregateRoot1Dto>
    {
        private readonly IAggregateRoot1Repository _aggregateRoot1Repository;
        private readonly IMapper _mapper;

        [IntentManaged(Mode.Merge)]
        public Operation_Params3_ReturnsE_Collection0AsyncQueryHandler(IAggregateRoot1Repository aggregateRoot1Repository,
            IMapper mapper)
        {
        ...
        public async Task<AggregateRoot1Dto> Handle(
            Operation_Params3_ReturnsE_Collection0AsyncQuery request,
            CancellationToken cancellationToken)
        {
            var result = await _aggregateRoot1Repository.Operation_Params3_ReturnsE_Collection0Async(
                new SpParameter(
