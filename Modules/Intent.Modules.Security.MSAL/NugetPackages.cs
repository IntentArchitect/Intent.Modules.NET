    ...
    public class NugetPackages : INugetPackages
    {
        ...
        public void RegisterPackages()
        {
            ...
            NugetRegistry.Register(MicrosoftIdentityWebPackageName,
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 9, >= 0) => new PackageVersion("3.9.4")
                            .WithNugetDependency("Microsoft.Identity.Web.Certificate", "3.9.4")
                            .WithNugetDependency("Microsoft.Identity.Web.Certificateless", "3.9.4")
                            .WithNugetDependency("Microsoft.Identity.Web.TokenAcquisition", "3.9.4")
                            .WithNugetDependency("Microsoft.Identity.Web.TokenCache", "3.9.4")
            ...
            NugetRegistry.Register(MicrosoftIdentityWebUIPackageName,
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 9, >= 0) => new PackageVersion("3.9.4")
                            .WithNugetDependency("Microsoft.Identity.Web", "3.9.4"),
                        ( >= 8, >= 0) => new PackageVersion("3.9.4")
                            .WithNugetDependency("Microsoft.Identity.Web", "3.9.4"),
                        ( >= 7, >= 0) => new PackageVersion("3.9.4")
                            .WithNugetDependency("Microsoft.Identity.Web", "3.9.4"),
