...
{
    public class IdTypeGuidRepository : MongoRepositoryBase<IdTypeGuid, IdTypeGuid>, IIdTypeGuidRepository
    {
        public IdTypeGuidRepository(ApplicationMongoDbContext context) : base(context)
        {
        }
