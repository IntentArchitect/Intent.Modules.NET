...
{
    public static class ClassLibraryNETFrameworkModelStereotypeExtensions
    {
        ...
        public static bool TryGetNETFrameworkSettings(this ClassLibraryNETFrameworkModel model, out NETFrameworkSettings stereotype)
        {
        ...
        public static bool TryGetCSharpProjectOptions(this ClassLibraryNETFrameworkModel model, out CSharpProjectOptions stereotype)
        {
            ...
            public class LanguageVersionOptions
            {
                ...
                public LanguageVersionOptionsEnum AsEnum()
                {
                    switch (Value)
                    {
                        ...
                        case "14.0":
                            return LanguageVersionOptionsEnum._140;
                        case "13.0":
