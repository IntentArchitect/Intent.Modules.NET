...
namespace EntityFrameworkCore.Repositories.TestApplication.Infrastructure.Repositories
{
    ...
    {
        public AggregateRoot5Repository(ApplicationDbContext dbContext, IMapper mapper) : base(dbContext, mapper)
        {
        }
        ...
        public async Task<AggregateRoot5?> FindByIdAsync(
            Guid id,
            Func<IQueryable<AggregateRoot5>, IQueryable<AggregateRoot5>> queryOptions,
            CancellationToken cancellationToken = default)
        {
