...
namespace Intent.Modules.Eventing.MassTransit.Templates.EventHandlerInterface
{
    ...
    public class EventHandlerInterfaceTemplateRegistration : FilePerModelTemplateRegistration<MessageHandlerModel>
    {
        private readonly IMetadataManager _metadataManager;

        public EventHandlerInterfaceTemplateRegistration(IMetadataManager metadataManager)
        {
            _metadataManager = metadataManager;
        }

        public override string TemplateId => EventHandlerInterfaceTemplate.TemplateId;

        public override ITemplate CreateTemplateInstance(IOutputTarget outputTarget, MessageHandlerModel model)
        {
            return new EventHandlerInterfaceTemplate(outputTarget, model);
        }
