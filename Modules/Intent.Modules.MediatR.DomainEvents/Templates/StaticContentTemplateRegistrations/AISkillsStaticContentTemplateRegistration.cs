...
namespace Intent.Modules.MediatR.DomainEvents.Templates.StaticContentTemplateRegistrations
{
    public class AISkillsStaticContentTemplateRegistration : AIStaticContentTemplateRegistration
    {
        public new const string TemplateId = "Intent.Modules.MediatR.DomainEvents.Templates.StaticContentTemplateRegistrations.AISkillsStaticContentTemplateRegistration";
