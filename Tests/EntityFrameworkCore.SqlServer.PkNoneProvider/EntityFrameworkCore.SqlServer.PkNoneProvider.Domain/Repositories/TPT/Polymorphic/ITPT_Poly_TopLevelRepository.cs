...
namespace EntityFrameworkCore.SqlServer.PkNoneProvider.Domain.Repositories.TPT.Polymorphic
{
    ...
    public interface ITPT_Poly_TopLevelRepository : IEFRepository<TPT_Poly_TopLevel, TPT_Poly_TopLevel>
    {
        ...
        [IntentManaged(Mode.Fully)]
        Task<TPT_Poly_TopLevel?> FindByIdAsync(Guid id, Func<IQueryable<TPT_Poly_TopLevel>, IQueryable<TPT_Poly_TopLevel>> queryOptions, CancellationToken cancellationToken = default);
        [IntentManaged(Mode.Fully)]
