...
{
    internal abstract class DynamoDBRepositoryBase<TDomain, TDomainState, TDocument, TPartitionKey, TSortKey> : IDynamoDBRepository<TDomain, TPartitionKey>, IDynamoDBRepository<TDomain, TPartitionKey, TSortKey>
        where TDomain : class
        where TDomainState : class, TDomain
        where TDocument : IDynamoDBDocument<TDomain, TDomainState, TDocument>, new()
    {
