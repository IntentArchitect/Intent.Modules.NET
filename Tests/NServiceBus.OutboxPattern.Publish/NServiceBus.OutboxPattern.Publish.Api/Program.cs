...
using NServiceBus.OutboxPattern.Publish.Api.Configuration;
using NServiceBus.OutboxPattern.Publish.Api.Filters;
using NServiceBus.OutboxPattern.Publish.Api.Logging;
using NServiceBus.OutboxPattern.Publish.Application;
using NServiceBus.OutboxPattern.Publish.Infrastructure;
using Serilog;
...
namespace NServiceBus.OutboxPattern.Publish.Api
{
