...
using WolverineEventing.ErrorPolicy.Retry.Api.Filters;
using WolverineEventing.ErrorPolicy.Retry.Application;
using WolverineEventing.ErrorPolicy.Retry.Domain.Common.Exceptions;

[assembly: DefaultIntentManaged(Mode.Fully)]
[assembly: IntentTemplate("Intent.AspNetCore.Swashbuckle.SwashbuckleConfiguration", Version = "1.0")]

namespace WolverineEventing.ErrorPolicy.Retry.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("WolverineEventing.ErrorPolicy.Retry API");
