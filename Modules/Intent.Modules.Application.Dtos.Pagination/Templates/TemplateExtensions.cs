...
namespace Intent.Modules.Application.Dtos.Pagination.Templates
{
    public static class TemplateExtensions
    {
        ...
        public static string GetCursorPagedResultName(this IIntentTemplate template)
        {
        ...
        public static string GetPagedResultMappingExtensionsName(this IIntentTemplate template)
        {
