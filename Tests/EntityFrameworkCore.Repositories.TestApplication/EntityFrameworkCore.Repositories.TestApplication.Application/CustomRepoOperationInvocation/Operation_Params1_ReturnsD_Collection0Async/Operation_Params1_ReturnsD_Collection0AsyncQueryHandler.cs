...
namespace EntityFrameworkCore.Repositories.TestApplication.Application.CustomRepoOperationInvocation.Operation_Params1_ReturnsD_Collection0Async
{
    ...
    public class Operation_Params1_ReturnsD_Collection0AsyncQueryHandler : IRequestHandler<Operation_Params1_ReturnsD_Collection0AsyncQuery, SpResultDto>
    {
        ...
        public Operation_Params1_ReturnsD_Collection0AsyncQueryHandler(ICustomRepository customRepository, IMapper mapper)
        {
        ...
        {
            var result = await _customRepository.Operation_Params1_ReturnsD_Collection0Async(new SpParameter(
