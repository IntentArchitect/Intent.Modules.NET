        ...
        public void RegisterPackages()
        {
            NugetRegistry.Register(FastEndpointsPackageName,
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 9, >= 0) => new PackageVersion("6.2.0")
                            .WithNugetDependency("FastEndpoints.Attributes", "6.2.0")
                            .WithNugetDependency("FastEndpoints.Messaging.Core", "6.2.0")
                            .WithNugetDependency("FluentValidation", "12.0.0"),
                        ( >= 8, >= 0) => new PackageVersion("6.2.0")
                            .WithNugetDependency("FastEndpoints.Attributes", "6.2.0")
                            .WithNugetDependency("FastEndpoints.Messaging.Core", "6.2.0")
                            .WithNugetDependency("FluentValidation", "12.0.0"),
                ...
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 9, >= 0) => new PackageVersion("6.2.0")
                            ...
                            .WithNugetDependency("FastEndpoints", "6.2.0")
