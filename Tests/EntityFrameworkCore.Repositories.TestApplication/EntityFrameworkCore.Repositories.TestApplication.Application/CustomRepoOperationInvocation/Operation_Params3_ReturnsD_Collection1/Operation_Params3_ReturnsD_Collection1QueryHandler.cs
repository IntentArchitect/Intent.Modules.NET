...
namespace EntityFrameworkCore.Repositories.TestApplication.Application.CustomRepoOperationInvocation.Operation_Params3_ReturnsD_Collection1
{
    ...
    public class Operation_Params3_ReturnsD_Collection1QueryHandler : IRequestHandler<Operation_Params3_ReturnsD_Collection1Query, List<SpResultDto>>
    {
        ...
        public Operation_Params3_ReturnsD_Collection1QueryHandler(ICustomRepository customRepository, IMapper mapper)
        {
        ...
        {
            var result = _customRepository.Operation_Params3_ReturnsD_Collection1(new SpParameter(
