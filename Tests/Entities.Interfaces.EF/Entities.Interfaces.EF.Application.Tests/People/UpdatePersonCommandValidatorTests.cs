...
namespace Entities.Interfaces.EF.Application.Tests.People
{
    public class UpdatePersonCommandValidatorTests
    {
        ...
        public async Task Validate_WithValidCommand_PassesValidation(UpdatePersonCommand testCommand)
        {
            // Arrange
        ...
        {
            var fixture = new Fixture();
            fixture.Customize<UpdatePersonCommand>(comp => comp.With(x => x.Name, () => default));
            var testCommand = fixture.Create<UpdatePersonCommand>();
        ...
        private ValidationBehaviour<UpdatePersonCommand, Unit> GetValidationBehaviour()
        {
            return new ValidationBehaviour<UpdatePersonCommand, Unit>(new[] { new UpdatePersonCommandValidator() });
        }
    }
}