...
namespace CosmosDB.EntityInterfaces.Domain.Repositories.Throughput
{
    ...
    public interface IManualRepository : ICosmosDBRepository<IManual, IManualDocument>
    {
        [IntentManaged(Mode.Fully)]
        Task<IManual?> FindByIdAsync(string id, CancellationToken cancellationToken = default);
    }
}