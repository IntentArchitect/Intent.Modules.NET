...
namespace AzureFunctions.AzureServiceBus.Api
{
    public class ClientCreatedEventConsumer
    {
        ...
        public ClientCreatedEventConsumer(IAzureServiceBusMessageDispatcher dispatcher,
            ILogger<ClientCreatedEventConsumer> logger,
            IEventBus eventBus,
        ...
        public async Task Run(
            [ServiceBusTrigger("%AzureServiceBus:ClientCreated%", "%AzureServiceBus:ClientCreatedSubscription%", Connection = "AzureServiceBus:ConnectionString")] ServiceBusReceivedMessage message,
            CancellationToken cancellationToken)
        {
            ...
            {
                _logger.LogError(ex, "Error processing ClientCreatedEventConsumer");
                throw;
            }
        }
    }
