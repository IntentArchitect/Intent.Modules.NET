...
public static class BlobStorageExtensions
{
    ...
    {
        var result = await storage.DownloadAsync(cloudStorageLocation, cancellationToken);
    ...
    {
        var result = await storage.DownloadAsync(containerName, blobName, cancellationToken);
        var text = await new StreamReader(result).ReadToEndAsync();
        return text;
    }
}