...
namespace WolverineEventing.Transport.RabbitMQ.Subscribe.Infrastructure.Eventing
{
            ...
            var transport = opts.UseRabbitMq(rabbit =>
{
    ...
    rabbit.Password = password;
            ...
            transport.BindExchange("order-created-event").ToQueue("wolverine-eventing.transport.rabbit-mq.subscribe-order-created-event");

            opts.ListenToRabbitQueue("wolverine-eventing.transport.rabbit-mq.subscribe-order-created-event");
