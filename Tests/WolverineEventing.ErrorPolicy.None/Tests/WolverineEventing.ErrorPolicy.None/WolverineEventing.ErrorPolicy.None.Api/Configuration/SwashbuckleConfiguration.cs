...
using WolverineEventing.ErrorPolicy.None.Api.Filters;
using WolverineEventing.ErrorPolicy.None.Application;
using WolverineEventing.ErrorPolicy.None.Domain.Common.Exceptions;

[assembly: DefaultIntentManaged(Mode.Fully)]
[assembly: IntentTemplate("Intent.AspNetCore.Swashbuckle.SwashbuckleConfiguration", Version = "1.0")]

namespace WolverineEventing.ErrorPolicy.None.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("WolverineEventing.ErrorPolicy.None API");
