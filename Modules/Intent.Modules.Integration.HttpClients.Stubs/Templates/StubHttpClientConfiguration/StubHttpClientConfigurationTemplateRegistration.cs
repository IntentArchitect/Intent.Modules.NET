...
namespace Intent.Modules.Integration.HttpClients.Stubs.Templates.StubHttpClientConfiguration
{
    ...
    public class StubHttpClientConfigurationTemplateRegistration : SingleFileListModelTemplateRegistration<IServiceProxyModel>
    {
        private readonly IMetadataManager _metadataManager;

        public StubHttpClientConfigurationTemplateRegistration(IMetadataManager metadataManager)
        {
            _metadataManager = metadataManager;
        }

        public override string TemplateId => StubHttpClientConfigurationTemplate.TemplateId;

        [IntentManaged(Mode.Fully)]
        public override ITemplate CreateTemplateInstance(IOutputTarget outputTarget, IList<IServiceProxyModel> model)
        {
            return new StubHttpClientConfigurationTemplate(outputTarget, model);
        }
