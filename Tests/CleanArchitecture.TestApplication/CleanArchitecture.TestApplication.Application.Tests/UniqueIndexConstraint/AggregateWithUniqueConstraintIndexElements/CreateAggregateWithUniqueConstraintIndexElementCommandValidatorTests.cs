...
namespace CleanArchitecture.TestApplication.Application.Tests.UniqueIndexConstraint.AggregateWithUniqueConstraintIndexElements
{
    public class CreateAggregateWithUniqueConstraintIndexElementCommandValidatorTests
    {
        ...
        {
            return new ValidationBehaviour<CreateAggregateWithUniqueConstraintIndexElementCommand, System.Guid>(new[] { new CreateAggregateWithUniqueConstraintIndexElementCommandValidator() });
        }
    }
}