...
using NServiceBus.AzureServiceBus.Api.Filters;
using NServiceBus.AzureServiceBus.Application;
using NServiceBus.AzureServiceBus.Domain.Common.Exceptions;
...
namespace NServiceBus.AzureServiceBus.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("NServiceBus.AzureServiceBus API");
