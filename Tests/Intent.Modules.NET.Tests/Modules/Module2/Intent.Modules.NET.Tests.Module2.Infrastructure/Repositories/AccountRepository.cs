...
namespace Intent.Modules.NET.Tests.Module2.Infrastructure.Repositories
{
    ...
    public class AccountRepository : RepositoryBase<Account, Account, Module2DbContext>, IAccountRepository
    {
        public AccountRepository(Module2DbContext dbContext, IMapper mapper) : base(dbContext, mapper)
        {
        }
