...
namespace CleanArchitecture.TestApplication.Application.Tests.AggregateTestNoIdReturns
{
    public class CreateAggregateTestNoIdReturnCommandValidatorTests
    {
        ...
        public async Task Validate_WithInvalidCommand_FailsValidation(CreateAggregateTestNoIdReturnCommand testCommand, string expectedPropertyName, string expectedPhrase)
        {
            // Arrange
            var validator = GetValidationBehaviour();
            // Act
