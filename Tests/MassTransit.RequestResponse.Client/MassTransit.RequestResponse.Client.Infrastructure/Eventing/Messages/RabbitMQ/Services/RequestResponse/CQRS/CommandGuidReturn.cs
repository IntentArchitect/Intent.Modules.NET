...
namespace MassTransit.RabbitMQ.Services.RequestResponse.CQRS
{
    public class CommandGuidReturn
    {
        ...
        public CommandGuidReturn(MassTransit.RequestResponse.Client.Application.IntegrationServices.Contracts.RabbitMQ.Services.RequestResponse.CQRS.CommandGuidReturn dto)
        {
            Input = dto.Input;
        }
