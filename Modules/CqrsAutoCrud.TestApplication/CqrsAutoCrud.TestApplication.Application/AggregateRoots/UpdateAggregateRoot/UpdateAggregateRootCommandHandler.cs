...
#warning Property not a composite association: Aggregate
        ...
        private void UpdateCompositeManyB(CompositeManyB entity, UpdateCompositeManyBDTO dto)
        {
        ...
        private void UpdateCompositeManyBB(CompositeManyBB entity, UpdateCompositeManyBBDTO dto)
        {
            entity.CompositeAttr = dto.CompositeAttr;
        }

        private void UpdateCompositeSingleBB(CompositeSingleBB entity, UpdateCompositeSingleBBDTO dto)
        {
            entity.CompositeAttr = dto.CompositeAttr;
        }

        private void UpdateCompositeSingleA(CompositeSingleA entity, UpdateCompositeSingleADTO dto)
        {
            entity.CompositeAttr = dto.CompositeAttr;
            entity.Composite = dto.Composite != null
                ? (entity.Composite ?? new CompositeSingleAA()).UpdateObject(dto.Composite,
                    UpdateCompositeSingleAA)
                : null;

            entity.Composites.UpdateCollection(dto.Composites, (x, y) => x.Id == y.Id, UpdateCompositeManyAA);
        }

        private void UpdateCompositeManyAA(CompositeManyAA entity, UpdateCompositeManyAADTO dto)
        {
            entity.CompositeAttr = dto.CompositeAttr;
        }

        private void UpdateCompositeSingleAA(CompositeSingleAA entity, UpdateCompositeSingleAADTO dto)
        {
            entity.CompositeAttr = dto.CompositeAttr;
        }
    }
