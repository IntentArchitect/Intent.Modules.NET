...
- [Intent.AzureFunctions.Dispatch.Wolverine](https://github.com/IntentArchitect/Intent.Modules.NET/blob/master/Modules/Intent.Modules.AzureFunctions.Dispatch.Wolverine/README.md) — dispatches commands and queries from Azure Functions via Wolverine.
...
- [Intent.Aws.Lambda.Functions.Dispatch.Wolverine](https://github.com/IntentArchitect/Intent.Modules.NET/blob/master/Modules/Intent.Modules.Aws.Lambda.Functions.Dispatch.Wolverine/README.md) — dispatches commands and queries from AWS Lambda functions via Wolverine.
