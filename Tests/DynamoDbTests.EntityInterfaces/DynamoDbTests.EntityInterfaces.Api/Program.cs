...
using DynamoDbTests.EntityInterfaces.Api.Configuration;
using DynamoDbTests.EntityInterfaces.Api.Filters;
using DynamoDbTests.EntityInterfaces.Api.Logging;
using DynamoDbTests.EntityInterfaces.Application;
using DynamoDbTests.EntityInterfaces.Infrastructure;
...
namespace DynamoDbTests.EntityInterfaces.Api
{
