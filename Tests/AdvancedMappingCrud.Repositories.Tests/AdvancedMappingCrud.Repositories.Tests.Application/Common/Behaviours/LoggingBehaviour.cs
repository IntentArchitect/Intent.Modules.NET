...
namespace AdvancedMappingCrud.Repositories.Tests.Application.Common.Behaviours
{
        ...
        where TRequest : notnull
    {
        ...
        public Task Process(TRequest request, CancellationToken cancellationToken)
        {
            ...
            {
                _logger.LogInformation("AdvancedMappingCrud.Repositories.Tests Request: {Name} {@UserId} {@UserName} {@Request}", requestName, userId, userName, request);
            }
            else
            {
                _logger.LogInformation("AdvancedMappingCrud.Repositories.Tests Request: {Name} {@UserId} {@UserName}", requestName, userId, userName);
            }
