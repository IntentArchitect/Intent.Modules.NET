...
namespace Application.Identity.AccountController.UserIdentity.Api.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        private readonly IUserStore<BespokeUser> _userStore;
        private readonly UserManager<BespokeUser> _userManager;
        private readonly ILogger<AccountController> _logger;
        private readonly IAccountEmailSender _accountEmailSender;
        private readonly ITokenService _tokenService;

        public AccountController(IUserStore<BespokeUser> userStore,
            UserManager<BespokeUser> userManager,
        ...
        public async Task<IActionResult> Register(RegisterDto input)
        {
            ...
            var emailStore = (IUserEmailStore<BespokeUser>)_userStore;
        ...
        private async Task SendConfirmationEmail(BespokeUser user)
        {
