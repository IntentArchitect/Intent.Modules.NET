...
namespace EfCoreSoftDelete.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.SwaggerEndpoint("/swagger/v1/swagger.json", "EfCoreSoftDelete API V1");
                    options.OAuthAppName("EfCoreSoftDelete API");
