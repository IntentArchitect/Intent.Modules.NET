...
using EntityFrameworkCore.MultiDbContext.NoDefaultDbContext.Application.Common.Models;
...
namespace EntityFrameworkCore.MultiDbContext.NoDefaultDbContext.Infrastructure.Services
{
