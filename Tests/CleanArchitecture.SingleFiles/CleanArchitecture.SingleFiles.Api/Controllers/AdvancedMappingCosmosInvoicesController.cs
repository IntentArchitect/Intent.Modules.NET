...
using CleanArchitecture.SingleFiles.Application.AdvancedMappingCosmosInvoices;
...
{
    [ApiController]
    public class AdvancedMappingCosmosInvoicesController : ControllerBase
    {
        private readonly ISender _mediator;

        public AdvancedMappingCosmosInvoicesController(ISender mediator)
        {
        ...
        [HttpPost("api/advanced/cosmos-invoice")]
        ...
        [HttpDelete("api/advanced/cosmos-invoice/{id}")]
        ...
        /// <response code="400">One or more validation errors have occurred.</response>
        /// <response code="404">One or more entities could not be found with the provided parameters.</response>
        [HttpPut("api/advanced/cosmos-invoice/{id}")]
        ...
        [HttpGet("api/advanced/cosmos-invoice/{id}")]
        ...
        [HttpGet("api/advanced/cosmos-invoice")]
