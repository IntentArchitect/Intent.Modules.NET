...
namespace EntityFrameworkCore.Repositories.TestApplication.Application.AggregateRoot1RepoOperationInvocation.Operation_Params1_ReturnsV_Collection0Async
{
    ...
    public class Operation_Params1_ReturnsV_Collection0AsyncCommandHandler : IRequestHandler<Operation_Params1_ReturnsV_Collection0AsyncCommand>
    {
        ...
        public Operation_Params1_ReturnsV_Collection0AsyncCommandHandler(IAggregateRoot1Repository aggregateRoot1Repository)
        {
        ...
        {
            await _aggregateRoot1Repository.Operation_Params1_ReturnsV_Collection0Async(new SpParameter(
