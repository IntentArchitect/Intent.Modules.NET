...
{
    internal class ClassContainerDynamoDBRepository : DynamoDBRepositoryBase<IClassContainer, ClassContainer, ClassContainerDocument, string, string>, IClassContainerRepository
    {
        public ClassContainerDynamoDBRepository(IDynamoDBContext context, DynamoDBUnitOfWork unitOfWork) : base(context, unitOfWork)
        {
        }
    }
}