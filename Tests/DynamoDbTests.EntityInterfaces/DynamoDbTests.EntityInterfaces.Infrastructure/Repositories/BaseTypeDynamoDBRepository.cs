...
{
    internal class BaseTypeDynamoDBRepository : DynamoDBRepositoryBase<IBaseType, BaseType, BaseTypeDocument, string, object>, IBaseTypeRepository
    {
        public BaseTypeDynamoDBRepository(IDynamoDBContext context, DynamoDBUnitOfWork unitOfWork) : base(context, unitOfWork)
        {
        }
    }
}