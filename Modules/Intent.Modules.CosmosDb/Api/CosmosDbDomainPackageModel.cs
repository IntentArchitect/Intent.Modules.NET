...
namespace Intent.CosmosDb.Api
{
    ...
    public class CosmosDbDomainPackageModel : IHasStereotypes, IMetadataModel
    {
        ...
        public const string SpecializationTypeId = "65a81352-87cc-49c1-bc1b-de4da18b825c"; // i used the newguid tool in vs to generate this, not sure if it is bound to an already existing intent id
