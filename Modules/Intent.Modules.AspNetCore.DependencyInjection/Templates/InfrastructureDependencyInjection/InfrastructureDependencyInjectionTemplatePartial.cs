...
namespace Intent.Modules.AspNetCore.DependencyInjection.Templates.InfrastructureDependencyInjection
{
    ...
    partial class InfrastructureDependencyInjectionTemplate : CSharpTemplateBase<object, InfrastructureDependencyInjectionDecorator>
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Intent.AspNetCore.DependencyInjection.InfrastructureDependencyInjection";
        private readonly IList<ContainerRegistrationRequest> _registrationRequests = new List<ContainerRegistrationRequest>();

        public InfrastructureDependencyInjectionTemplate(IOutputTarget outputTarget, object model) : base(TemplateId, outputTarget, model)
        {
