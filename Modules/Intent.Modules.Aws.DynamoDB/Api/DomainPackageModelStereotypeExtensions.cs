...
namespace Intent.Aws.DynamoDB.Api
{
    ...
    {
        public static Table GetTable(this DomainPackageModel model)
        {
        ...
        public static bool HasTable(this DomainPackageModel model)
        {
            return model.HasStereotype(Table.DefinitionId);
        }

        public static bool TryGetTable(this DomainPackageModel model, out Table stereotype)
        {
            if (!HasTable(model))
            {
                stereotype = null;
