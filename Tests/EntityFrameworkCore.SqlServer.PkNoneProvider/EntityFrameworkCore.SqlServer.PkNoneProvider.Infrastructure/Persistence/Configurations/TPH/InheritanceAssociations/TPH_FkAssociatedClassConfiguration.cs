...
namespace EntityFrameworkCore.SqlServer.PkNoneProvider.Infrastructure.Persistence.Configurations.TPH.InheritanceAssociations
{
    public class TPH_FkAssociatedClassConfiguration : IEntityTypeConfiguration<TPH_FkAssociatedClass>
    {
        public void Configure(EntityTypeBuilder<TPH_FkAssociatedClass> builder)
        {
