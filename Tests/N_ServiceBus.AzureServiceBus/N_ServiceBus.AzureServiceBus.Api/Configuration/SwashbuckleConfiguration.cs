...
using N_ServiceBus.AzureServiceBus.Domain.Common.Exceptions;
...
namespace N_ServiceBus.AzureServiceBus.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("N_ServiceBus.AzureServiceBus API");
