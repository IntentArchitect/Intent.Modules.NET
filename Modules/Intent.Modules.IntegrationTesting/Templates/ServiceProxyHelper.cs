...
{
    internal static class ServiceProxyHelper
    {

        internal static IEnumerable<IServiceProxyModel> GetServicesAsProxyModels(this IMetadataManager metadataManager, IApplication application)
        {
