...
using N_ServiceBus.SqlServer.Application.Common.Behaviours;
using N_ServiceBus.SqlServer.Application.Common.Eventing;
using N_ServiceBus.SqlServer.Application.Common.Validation;
using N_ServiceBus.SqlServer.Application.Implementation.Animals;
using N_ServiceBus.SqlServer.Application.IntegrationEvents.EventHandlers;
...
namespace N_ServiceBus.SqlServer.Application
{
