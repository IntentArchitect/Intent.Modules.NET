...
namespace Intent.Modules.MongoDb.Templates.MongoDbUnitOfWork
{
    [IntentManaged(Mode.Fully, Body = Mode.Merge)]
    public partial class MongoDbUnitOfWorkTemplate : CSharpTemplateBase<object>, ICSharpFileBuilderTemplate
    {
        public const string TemplateId = "Intent.MongoDb.MongoDbUnitOfWork";

        [IntentManaged(Mode.Fully, Body = Mode.Ignore)]
        public MongoDbUnitOfWorkTemplate(IOutputTarget outputTarget, object model = null) : base(TemplateId, outputTarget, model)
        {
            CSharpFile = new CSharpFile(this.GetNamespace(), this.GetFolderPath())
                ...
                .AddClass($"MongoDbUnitOfWork", @class =>
                {
                    ...
                    @class
                        .Internal()
                        .ImplementsInterface(this.GetMongoDbUnitOfWorkInterfaceName())
