...
using MassTransit.RequestResponse.Client.Api.Configuration;
using MassTransit.RequestResponse.Client.Api.Filters;
using MassTransit.RequestResponse.Client.Api.Logging;
using MassTransit.RequestResponse.Client.Application;
using MassTransit.RequestResponse.Client.Infrastructure;
using Serilog;
...
namespace MassTransit.RequestResponse.Client.Api
{
