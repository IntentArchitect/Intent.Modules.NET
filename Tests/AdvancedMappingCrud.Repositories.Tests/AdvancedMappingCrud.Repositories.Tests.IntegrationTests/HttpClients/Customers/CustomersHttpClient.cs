...
namespace AdvancedMappingCrud.Repositories.Tests.IntegrationTests.HttpClients.Customers
{
    public class CustomersHttpClient : ICustomersService
    {
        ...
        public async Task ApproveQuoteAsync(
            Guid quoteId,
        ...
        public async Task CreateCorporateFuneralCoverQuoteAsync(
            CreateCorporateFuneralCoverQuoteCommand command,
            CancellationToken cancellationToken = default)
        {
            var relativeUri = $"api/customers/funeralquote";
            var httpRequest = new HttpRequestMessage(HttpMethod.Post, relativeUri);
            httpRequest.Headers.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
        ...
        public async Task CreateFuneralCoverQuoteAsync(
            CreateFuneralCoverQuoteCommand command,
            CancellationToken cancellationToken = default)
        {
            var relativeUri = $"api/customers/funeral";
            var httpRequest = new HttpRequestMessage(HttpMethod.Post, relativeUri);
            httpRequest.Headers.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
        ...
        public async Task CreateQuoteAsync(CreateQuoteCommand command, CancellationToken cancellationToken = default)
        {
        ...
        public async Task DeactivateCustomerAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            var relativeUri = $"api/customers/deactivate-customer";
        ...
        public async Task<List<CustomerDto>> GetCustomersByNameAndSurnameAsync(
            string name,
            string surname,
            CancellationToken cancellationToken = default)
        {
            var relativeUri = $"api/customer/{name}/{surname}";
            var httpRequest = new HttpRequestMessage(HttpMethod.Get, relativeUri);
            httpRequest.Headers.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
        ...
        public async Task<PagedResult<CustomerDto>> GetCustomersPaginatedAsync(
            bool isActive,
            string name,
            string surname,
            int pageNo,
            ...
            CancellationToken cancellationToken = default)
        {
            var relativeUri = $"api/customer/{name}/{surname}/{isActive}/paged";
        ...
        public async Task<PagedResult<CustomerDto>> GetCustomersPaginatedWithOrderAsync(
            bool isActive,
            string name,
            string surname,
            int pageNo,
            ...
            CancellationToken cancellationToken = default)
        {
            var relativeUri = $"api/customer/{name}/{surname}/{isActive}/paged/ordered";
        ...
        public async Task<List<CustomerDto>> GetCustomersWithParamsAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            var relativeUri = $"api/customer/{name}/{surname}/{isActive}";
            var httpRequest = new HttpRequestMessage(HttpMethod.Get, relativeUri);
            httpRequest.Headers.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
