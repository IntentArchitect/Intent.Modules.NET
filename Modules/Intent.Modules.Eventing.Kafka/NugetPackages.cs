        ...
        public void RegisterPackages()
        {
            NugetRegistry.Register(ConfluentKafkaPackageName,
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 10, >= 0) => new PackageVersion("2.15.0")
                            .WithNugetDependency("librdkafka.redist", "2.15.0"),
                        ( >= 8, >= 0) => new PackageVersion("2.15.0")
                            .WithNugetDependency("librdkafka.redist", "2.15.0"),
                        ( >= 2, >= 0) => new PackageVersion("2.15.0")
                            .WithNugetDependency("librdkafka.redist", "2.15.0")
            ...
            NugetRegistry.Register(ConfluentSchemaRegistrySerdesJsonPackageName,
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 10, >= 0) => new PackageVersion("2.15.0")
                            .WithNugetDependency("Confluent.Kafka", "2.15.0")
                            .WithNugetDependency("Confluent.SchemaRegistry", "2.15.0")
