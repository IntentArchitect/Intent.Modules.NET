        ...
        public void RegisterPackages()
        {
            NugetRegistry.Register(EFCoreSecondLevelCacheInterceptorPackageName,
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 10, >= 0) => new PackageVersion("5.3.13")
                            .WithNugetDependency("AsyncKeyedLock", "8.0.2")
                            ...
                            .WithNugetDependency("System.IO.Hashing", "10.0.8"),
                        ( >= 9, >= 0) => new PackageVersion("5.3.13")
                            .WithNugetDependency("AsyncKeyedLock", "8.0.2")
            ...
            NugetRegistry.Register(MessagePackPackageName,
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 9, >= 0) => new PackageVersion("3.1.8")
                            .WithNugetDependency("MessagePackAnalyzer", "3.1.8")
                            .WithNugetDependency("MessagePack.Annotations", "3.1.8")
                            .WithNugetDependency("Microsoft.NET.StringTools", "17.11.4"),
                        ( >= 8, >= 0) => new PackageVersion("3.1.8")
                            .WithNugetDependency("MessagePackAnalyzer", "3.1.8")
                            .WithNugetDependency("MessagePack.Annotations", "3.1.8")
                            .WithNugetDependency("Microsoft.NET.StringTools", "17.11.4"),
                        ( >= 2, >= 1) => new PackageVersion("3.1.8")
                            .WithNugetDependency("MessagePackAnalyzer", "3.1.8")
                            .WithNugetDependency("MessagePack.Annotations", "3.1.8")
                            .WithNugetDependency("Microsoft.NET.StringTools", "17.11.4")
                            .WithNugetDependency("System.Collections.Immutable", "8.0.0"),
                        ( >= 2, >= 0) => new PackageVersion("3.1.8")
                            .WithNugetDependency("MessagePackAnalyzer", "3.1.8")
                            .WithNugetDependency("MessagePack.Annotations", "3.1.8")
