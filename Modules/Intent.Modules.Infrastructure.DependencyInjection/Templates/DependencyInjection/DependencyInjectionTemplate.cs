...
#line hidden
  ...
  foreach(var registration in _containerRegistrationRequests.OrderBy(x => x.Priority)) { 
    ...
    foreach (var registration in _serviceConfigurationRequests.OrderBy(x => x.Priority))
    {
            ...
            #line 30 "C:\Dev\Intent.Modules.NET\Modules\Intent.Modules.Infrastructure.DependencyInjection\Templates\DependencyInjection\DependencyInjectionTemplate.tt"
            ...
            #line 31 "C:\Dev\Intent.Modules.NET\Modules\Intent.Modules.Infrastructure.DependencyInjection\Templates\DependencyInjection\DependencyInjectionTemplate.tt"
