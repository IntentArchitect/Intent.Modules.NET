...
namespace Intent.Modules.Eventing.MassTransit.Templates.ClientContracts.DtoContract
{
    ...
    public class DtoContractTemplateRegistration : FilePerModelTemplateRegistration<DTOModel>
    {
        ...
        {
            return _metadataManager.ServiceProxies(application).GetMappedServiceProxyDTOModels(new[] { Constants.MassTransitConsumerStereotype })
                .ToList();
        }
    }
}