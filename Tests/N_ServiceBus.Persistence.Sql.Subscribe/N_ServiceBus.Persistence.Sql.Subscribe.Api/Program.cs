...
using N_ServiceBus.Persistence.Sql.Subscribe.Api.Configuration;
using N_ServiceBus.Persistence.Sql.Subscribe.Api.Filters;
using N_ServiceBus.Persistence.Sql.Subscribe.Api.Logging;
using N_ServiceBus.Persistence.Sql.Subscribe.Application;
using N_ServiceBus.Persistence.Sql.Subscribe.Infrastructure;
using Serilog;
...
namespace N_ServiceBus.Persistence.Sql.Subscribe.Api
{
