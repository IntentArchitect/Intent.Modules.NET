...
using DynamoDbTests.EnumAsStrings.Infrastructure.Configuration;
using DynamoDbTests.EnumAsStrings.Infrastructure.Persistence;
using DynamoDbTests.EnumAsStrings.Infrastructure.Repositories;
using DynamoDbTests.EnumAsStrings.Infrastructure.Repositories.Folder;
using DynamoDbTests.EnumAsStrings.Infrastructure.Repositories.Throughput;
using DynamoDbTests.EnumAsStrings.Infrastructure.Services;
...
namespace DynamoDbTests.EnumAsStrings.Infrastructure
{
