...
namespace Intent.Modules.NET.Tests.Module1.Infrastructure.Repositories
{
    ...
    public class OrderRepository : RepositoryBase<Order, Order, Module1DbContext>, IOrderRepository
    {
        public OrderRepository(Module1DbContext dbContext, IMapper mapper) : base(dbContext, mapper)
        {
        }
