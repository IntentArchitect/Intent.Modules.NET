...
namespace Application.Identity.AccountController.Api.Services
{
    public class TokenService : ITokenService
    {
        ...
        public TokenService(IConfiguration configuration, IDataProtectionProvider provider)
        {
            ...
            _protector = provider.CreateProtector("Application.Identity.AccountController.Api.Services.TokenService");
        }
