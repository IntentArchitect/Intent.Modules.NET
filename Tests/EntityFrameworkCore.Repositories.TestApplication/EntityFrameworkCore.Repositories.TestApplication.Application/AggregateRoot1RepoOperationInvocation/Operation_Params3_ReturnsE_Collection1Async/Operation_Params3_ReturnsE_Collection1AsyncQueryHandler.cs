...
namespace EntityFrameworkCore.Repositories.TestApplication.Application.AggregateRoot1RepoOperationInvocation.Operation_Params3_ReturnsE_Collection1Async
{
    ...
    public class Operation_Params3_ReturnsE_Collection1AsyncQueryHandler : IRequestHandler<Operation_Params3_ReturnsE_Collection1AsyncQuery, List<AggregateRoot1Dto>>
    {
        ...
        public Operation_Params3_ReturnsE_Collection1AsyncQueryHandler(IAggregateRoot1Repository aggregateRoot1Repository,
            IMapper mapper)
        {
        ...
        {
            var result = await _aggregateRoot1Repository.Operation_Params3_ReturnsE_Collection1Async(
                new SpParameter(
