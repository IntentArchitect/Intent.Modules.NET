...
namespace CosmosDB.Infrastructure.Persistence.Documents
{
    internal class DepartmentDocument : IDepartmentDocument, ICosmosDBDocument<Department, DepartmentDocument>
    {
        ...
        public DepartmentDocument PopulateFromEntity(Department entity, Func<string, string?> getEtag)
        {
        ...
        public static DepartmentDocument? FromEntity(Department? entity, Func<string, string?> getEtag)
        {
            if (entity is null)
            {
                return null;
