...
namespace Intent.Modules.VisualStudio.Projects.Api
{
    public static class ASPNETWebApplicationNETFrameworkModelExtensions
    {
        ...
        public static ProjectOptions GetProjectOptions(this ASPNETWebApplicationNETFrameworkModel model)
        {
            var stereotype = model.GetStereotype("Project Options");
            return stereotype != null ? new ProjectOptions(stereotype) : null;
        }

        public static bool HasProjectOptions(this ASPNETWebApplicationNETFrameworkModel model)
        {
