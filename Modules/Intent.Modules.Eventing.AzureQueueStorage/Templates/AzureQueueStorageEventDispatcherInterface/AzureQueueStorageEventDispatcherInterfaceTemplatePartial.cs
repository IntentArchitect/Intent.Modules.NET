    ...
    public partial class AzureQueueStorageEventDispatcherInterfaceTemplate : CSharpTemplateBase<object>, ICSharpFileBuilderTemplate
    {
        ...
        public AzureQueueStorageEventDispatcherInterfaceTemplate(IOutputTarget outputTarget, object model = null) : base(TemplateId, outputTarget, model)
        {
            CSharpFile = new CSharpFile(this.GetNamespace(), this.GetFolderPath())
                ...
                {
                    @interface.AddGenericParameter("T", gen => gen.Contravariant())
                        .AddGenericTypeConstraint("T", con => con.AddType("class"));

                    @interface.AddMethod(UseType("System.Threading.Tasks.Task"), "Dispatch", mth =>
                    {
                        mth.AddParameter("T", "message")
                        .AddParameter(UseType("System.Threading.CancellationToken"), "cancellationToken", cfg => cfg.WithDefaultValue("default"));
                    });
                });
        }
