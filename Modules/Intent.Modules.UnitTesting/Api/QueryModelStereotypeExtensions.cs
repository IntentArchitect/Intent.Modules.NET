...
namespace Intent.UnitTesting.Api
{
    ...
    {
        public static UnitTest GetUnitTest(this QueryModel model)
        {
        ...
        public static bool HasUnitTest(this QueryModel model)
        {
            return model.HasStereotype(UnitTest.DefinitionId);
        }

        public static bool TryGetUnitTest(this QueryModel model, out UnitTest stereotype)
        {
