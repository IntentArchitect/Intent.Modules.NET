...
{
    public class E_RequiredCompositeNavMongoRepository : MongoRepositoryBase<E_RequiredCompositeNav, E_RequiredCompositeNav>, IE_RequiredCompositeNavRepository
    {
