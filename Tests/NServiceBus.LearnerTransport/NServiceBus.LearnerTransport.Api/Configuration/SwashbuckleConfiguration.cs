...
using NServiceBus.LearnerTransport.Api.Filters;
using NServiceBus.LearnerTransport.Application;
using NServiceBus.LearnerTransport.Domain.Common.Exceptions;
...
namespace NServiceBus.LearnerTransport.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("NServiceBus.LearnerTransport API");
