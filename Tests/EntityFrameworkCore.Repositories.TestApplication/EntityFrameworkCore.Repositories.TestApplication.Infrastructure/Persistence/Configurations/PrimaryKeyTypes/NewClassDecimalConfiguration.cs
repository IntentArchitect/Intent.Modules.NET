...
{
    public class NewClassDecimalConfiguration : IEntityTypeConfiguration<NewClassDecimal>
    {
        public void Configure(EntityTypeBuilder<NewClassDecimal> builder)
        {
            ...
            builder.Property(x => x.DecimalName)
                .IsRequired();
