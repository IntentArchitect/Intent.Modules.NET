...
{
    public class MyRequestCommandEndpoint : EndpointWithoutRequest
    {
        private readonly ISender _mediator;

        public MyRequestCommandEndpoint(ISender mediator)
        {
        ...
        {
            Post("api/request-suffix-commands-with-type/my-request");
            Description(b =>
            {
        ...
        {
            await _mediator.Send(new MyRequestCommand(), ct);
