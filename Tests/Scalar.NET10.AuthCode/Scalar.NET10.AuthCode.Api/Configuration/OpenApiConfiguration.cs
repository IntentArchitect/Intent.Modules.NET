...
namespace Scalar.NET10.AuthCode.Api.Configuration
{
            ...
            services.AddOpenApi(
                options =>
                {
                    ...
                    options.AddDocumentTransformer((document, context, cancellationToken) =>
                    {
                        ...
                        var tokenUrl = oidcSection.GetValue<string>("TokenUrl");
                        ...
                        {
                            throw new ArgumentException("You have not configured your TokenUrl", nameof(tokenUrl));
                        }
