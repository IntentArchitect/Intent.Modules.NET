...
namespace Intent.Eventing.AzureServiceBus.Api
{
    public static class IntegrationCommandModelStereotypeExtensions
    {
        ...
        public static bool HasAzureServiceBus(this IntegrationCommandModel model)
        {
            return model.HasStereotype(AzureServiceBus.DefinitionId);
        }

        public static bool TryGetAzureServiceBus(this IntegrationCommandModel model, out AzureServiceBus stereotype)
        {
