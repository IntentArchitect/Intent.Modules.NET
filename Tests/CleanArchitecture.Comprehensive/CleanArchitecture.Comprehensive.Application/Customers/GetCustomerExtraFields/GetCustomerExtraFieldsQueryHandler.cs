...
namespace CleanArchitecture.Comprehensive.Application.Customers.GetCustomerExtraFields
{
    ...
    public class GetCustomerExtraFieldsQueryHandler : IRequestHandler<GetCustomerExtraFieldsQuery, List<CustomerDto>>
    {
        private readonly ICustomerRepository _customerRepository;
        private readonly IMapper _mapper;

        [IntentManaged(Mode.Merge)]
        public GetCustomerExtraFieldsQueryHandler(ICustomerRepository customerRepository, IMapper mapper)
        {
        ...
        public async Task<List<CustomerDto>> Handle(
            GetCustomerExtraFieldsQuery request,
