...
using EntityFrameworkCore.SqlServer.EF8.Infrastructure.Persistence.Configurations;
using EntityFrameworkCore.SqlServer.EF8.Infrastructure.Persistence.Configurations.Accounts;
...
using EntityFrameworkCore.SqlServer.EF8.Infrastructure.Persistence.Configurations.PkDataSources;
using EntityFrameworkCore.SqlServer.EF8.Infrastructure.Persistence.Configurations.SoftDelete;
using EntityFrameworkCore.SqlServer.EF8.Infrastructure.Persistence.Configurations.TimeConcepts;
using EntityFrameworkCore.SqlServer.EF8.Infrastructure.Persistence.Configurations.TPC.InheritanceAssociations;
using EntityFrameworkCore.SqlServer.EF8.Infrastructure.Persistence.Configurations.TPC.Polymorphic;
using EntityFrameworkCore.SqlServer.EF8.Infrastructure.Persistence.Configurations.TPH.InheritanceAssociations;
using EntityFrameworkCore.SqlServer.EF8.Infrastructure.Persistence.Configurations.TPH.Polymorphic;
using EntityFrameworkCore.SqlServer.EF8.Infrastructure.Persistence.Configurations.TPT.InheritanceAssociations;
using EntityFrameworkCore.SqlServer.EF8.Infrastructure.Persistence.Configurations.TPT.Polymorphic;
using EntityFrameworkCore.SqlServer.EF8.Infrastructure.Persistence.Configurations.ValueObjects;
...
namespace EntityFrameworkCore.SqlServer.EF8.Infrastructure.Persistence
{
