...
using Entities.PrivateSetters.MongoDb.Infrastructure.Persistence.Mappings;
...
namespace Entities.PrivateSetters.MongoDb.Infrastructure.Configuration
{
    internal static class MongoConfigurationExtensions
    {
        ...
        {
            services.AddMongoCollection(new InvoiceMapping());
            services.AddMongoCollection(new TagMapping());
            return services;
        }
    }
}