...
using N_ServiceBus.Persistence.NHibernate.Publish.Api.Configuration;
using N_ServiceBus.Persistence.NHibernate.Publish.Api.Filters;
using N_ServiceBus.Persistence.NHibernate.Publish.Api.Logging;
using N_ServiceBus.Persistence.NHibernate.Publish.Application;
using N_ServiceBus.Persistence.NHibernate.Publish.Infrastructure;
using Serilog;
...
namespace N_ServiceBus.Persistence.NHibernate.Publish.Api
{
