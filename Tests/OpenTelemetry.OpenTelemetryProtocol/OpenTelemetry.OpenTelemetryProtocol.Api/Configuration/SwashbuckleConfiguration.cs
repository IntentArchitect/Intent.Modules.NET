...
using OpenTelemetry.OpenTelemetryProtocol.Api.Filters;
using OpenTelemetry.OpenTelemetryProtocol.Application;
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("OpenTelemetry.OpenTelemetryProtocol API");
