...
namespace EntityFrameworkCore.Repositories.TestApplication.Application.AggregateRoot1RepoOperationInvocation.Operation_Params1_ReturnsE_Collection0
{
    ...
    public class Operation_Params1_ReturnsE_Collection0QueryHandler : IRequestHandler<Operation_Params1_ReturnsE_Collection0Query, AggregateRoot1Dto>
    {
        ...
        public Operation_Params1_ReturnsE_Collection0QueryHandler(IAggregateRoot1Repository aggregateRoot1Repository,
            IMapper mapper)
        {
        ...
        {
            var result = _aggregateRoot1Repository.Operation_Params1_ReturnsE_Collection0(new SpParameter(
