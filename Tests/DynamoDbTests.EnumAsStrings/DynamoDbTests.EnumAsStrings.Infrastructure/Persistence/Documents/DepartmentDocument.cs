...
namespace DynamoDbTests.EnumAsStrings.Infrastructure.Persistence.Documents
{
    ...
    internal class DepartmentDocument : IDynamoDBDocument<Department, DepartmentDocument>
    {
        [DynamoDBHashKey]
        ...
        public DepartmentDocument PopulateFromEntity(Department entity, Func<object, int?> getVersion)
        {
            Id = entity.Id;
        ...
        public static DepartmentDocument? FromEntity(Department? entity, Func<object, int?> getVersion)
        {
            if (entity is null)
            {
                return null;
