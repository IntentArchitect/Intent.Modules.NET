...
using CosmosDB.PrivateSetters.Application.Regions;
using CosmosDB.PrivateSetters.Application.Regions.CreateRegion;
using CosmosDB.PrivateSetters.Application.Regions.DeleteRegion;
using CosmosDB.PrivateSetters.Application.Regions.GetRegionById;
using CosmosDB.PrivateSetters.Application.Regions.GetRegions;
using CosmosDB.PrivateSetters.Application.Regions.GetRegionsByName;
using CosmosDB.PrivateSetters.Application.Regions.UpdateRegion;
