...
{
    public class UpdateAggregateWithUniqueConstraintIndexStereotypeCommand
    {
        public UpdateAggregateWithUniqueConstraintIndexStereotypeCommand()
        {
        ...
        public static UpdateAggregateWithUniqueConstraintIndexStereotypeCommand Create(
            Guid id,
            string singleUniqueField,
            string compUniqueFieldA,
            string compUniqueFieldB)
        {
            return new UpdateAggregateWithUniqueConstraintIndexStereotypeCommand
            {
                Id = id,
