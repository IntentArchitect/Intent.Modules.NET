...
namespace EntityFrameworkCore.CosmosDb.TestApplication.Infrastructure.Repositories.Associations
{
    ...
    {
        public E_RequiredCompositeNavRepository(ApplicationDbContext dbContext, IMapper mapper) : base(dbContext, mapper)
        {
        }
        ...
        public async Task<E_RequiredCompositeNav?> FindByIdAsync(
            Guid id,
            Func<IQueryable<E_RequiredCompositeNav>, IQueryable<E_RequiredCompositeNav>> queryOptions,
            CancellationToken cancellationToken = default)
        {
