...
namespace AdvancedMappingCrud.Cosmos.Tests.IntegrationTests.Tests
{
    ...
    public class DeleteCustomerTests : BaseIntegrationTest
    {
        ...
        [Fact(Skip = "The Cosmos DB Linux Emulator Docker image does not run on Microsoft's CI environment (GitHub, Azure DevOps).")] // https://github.com/Azure/azure-cosmos-db-emulator-docker/issues/45. // https://github.com/Azure/azure-cosmos-db-emulator-docker/issues/45.
