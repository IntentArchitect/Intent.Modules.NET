        ...
        public void RegisterPackages()
        {
            NugetRegistry.Register(ConfluentKafkaPackageName,
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 8, >= 0) => new PackageVersion("2.13.0")
                            .WithNugetDependency("librdkafka.redist", "2.13.0"),
                        ( >= 6, >= 0) => new PackageVersion("2.13.0")
                            .WithNugetDependency("librdkafka.redist", "2.13.0"),
                        ( >= 2, >= 0) => new PackageVersion("2.13.0")
                            .WithNugetDependency("librdkafka.redist", "2.13.0")
            ...
            NugetRegistry.Register(ConfluentSchemaRegistrySerdesJsonPackageName,
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 8, >= 0) => new PackageVersion("2.13.0")
                            .WithNugetDependency("Confluent.Kafka", "2.13.0")
                            .WithNugetDependency("Confluent.SchemaRegistry", "2.13.0")
