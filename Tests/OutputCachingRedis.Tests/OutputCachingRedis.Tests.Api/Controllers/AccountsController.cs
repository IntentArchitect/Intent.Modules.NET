...
using OutputCachingRedis.Tests.Application.Accounts;
using OutputCachingRedis.Tests.Application.Accounts.CreateAccount;
using OutputCachingRedis.Tests.Application.Accounts.DeleteAccount;
using OutputCachingRedis.Tests.Application.Accounts.GetAccountById;
using OutputCachingRedis.Tests.Application.Accounts.GetAccounts;
using OutputCachingRedis.Tests.Application.Accounts.UpdateAccount;
...
namespace OutputCachingRedis.Tests.Api.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status500InternalServerError)]
        [OutputCache(PolicyName = "All Default")]
