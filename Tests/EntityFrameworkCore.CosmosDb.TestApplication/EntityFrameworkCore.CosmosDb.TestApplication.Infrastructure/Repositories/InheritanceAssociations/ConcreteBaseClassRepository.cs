...
namespace EntityFrameworkCore.CosmosDb.TestApplication.Infrastructure.Repositories.InheritanceAssociations
{
    ...
    {
        public ConcreteBaseClassRepository(ApplicationDbContext dbContext) : base(dbContext)
        {
        }
        ...
        public async Task<List<ConcreteBaseClass>> FindByIdsAsync(Guid[] ids, CancellationToken cancellationToken = default)
        {
