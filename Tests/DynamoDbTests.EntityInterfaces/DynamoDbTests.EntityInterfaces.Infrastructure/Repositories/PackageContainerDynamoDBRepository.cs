...
{
    internal class PackageContainerDynamoDBRepository : DynamoDBRepositoryBase<IPackageContainer, PackageContainer, PackageContainerDocument, string, string>, IPackageContainerRepository
    {
