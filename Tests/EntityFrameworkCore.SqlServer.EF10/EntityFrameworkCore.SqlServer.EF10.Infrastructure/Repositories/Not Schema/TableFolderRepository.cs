...
using EntityFrameworkCore.SqlServer.EF10.Domain.Repositories.NotSchema;
...
namespace EntityFrameworkCore.SqlServer.EF10.Infrastructure.Repositories.NotSchema
{
    ...
    public class TableFolderRepository : RepositoryBase<TableFolder, TableFolder, ApplicationDbContext>, ITableFolderRepository
    {
        ...
        public async Task<TableFolder?> FindByIdAsync(
            Guid id,
            Func<IQueryable<TableFolder>, IQueryable<TableFolder>> queryOptions,
