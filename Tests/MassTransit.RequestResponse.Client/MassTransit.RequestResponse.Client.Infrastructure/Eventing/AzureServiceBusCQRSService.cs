...
{
    public class AzureServiceBusCQRSService : IAzureServiceBusCQRSService
    {
        private readonly IServiceProvider _serviceProvider;

        public AzureServiceBusCQRSService(IServiceProvider serviceProvider)
        {
            _serviceProvider = serviceProvider;
        }

        public async Task<MassTransit.RequestResponse.Client.Application.IntegrationServices.Contracts.AzureServiceBus.Services.RequestResponse.CQRS.CommandResponseDto> CommandDtoReturnAsync(
            MassTransit.RequestResponse.Client.Application.IntegrationServices.Contracts.AzureServiceBus.Services.RequestResponse.CQRS.CommandDtoReturn command,
        ...
        public async Task<Guid> CommandGuidReturnAsync(
            MassTransit.RequestResponse.Client.Application.IntegrationServices.Contracts.AzureServiceBus.Services.RequestResponse.CQRS.CommandGuidReturn command,
            CancellationToken cancellationToken = default)
        {
            if (command is null)
            {
        ...
        public async Task CommandNoParamAsync(
            MassTransit.RequestResponse.Client.Application.IntegrationServices.Contracts.AzureServiceBus.Services.RequestResponse.CQRS.CommandNoParam command,
            CancellationToken cancellationToken = default)
        {
            if (command is null)
            {
        ...
        public async Task CommandVoidReturnAsync(
            MassTransit.RequestResponse.Client.Application.IntegrationServices.Contracts.AzureServiceBus.Services.RequestResponse.CQRS.CommandVoidReturn command,
            CancellationToken cancellationToken = default)
        {
            if (command is null)
            {
        ...
        public async Task<Guid> QueryGuidReturnAsync(
            MassTransit.RequestResponse.Client.Application.IntegrationServices.Contracts.AzureServiceBus.Services.RequestResponse.CQRS.QueryGuidReturn query,
            CancellationToken cancellationToken = default)
        {
            if (query is null)
            {
        ...
        public async Task<List<MassTransit.RequestResponse.Client.Application.IntegrationServices.Contracts.AzureServiceBus.Services.RequestResponse.CQRS.QueryResponseDto>> QueryNoInputDtoReturnCollectionAsync(
            MassTransit.RequestResponse.Client.Application.IntegrationServices.Contracts.AzureServiceBus.Services.RequestResponse.CQRS.QueryNoInputDtoReturnCollection query,
            CancellationToken cancellationToken = default)
        {
            if (query is null)
            {
        ...
        public async Task<MassTransit.RequestResponse.Client.Application.IntegrationServices.Contracts.AzureServiceBus.Services.RequestResponse.CQRS.QueryResponseDto> QueryResponseDtoReturnAsync(
            MassTransit.RequestResponse.Client.Application.IntegrationServices.Contracts.AzureServiceBus.Services.RequestResponse.CQRS.QueryResponseDtoReturn query,
            CancellationToken cancellationToken = default)
        {
            if (query is null)
            {
