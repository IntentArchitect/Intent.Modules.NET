...
namespace DynamoDbTests.EntityInterfaces.Infrastructure.Persistence.Documents
{
    ...
    internal class UniversityDocument : IDynamoDBDocument<IUniversity, University, UniversityDocument>
    {
        [DynamoDBHashKey]
        ...
        public UniversityDocument PopulateFromEntity(IUniversity entity, Func<object, int?> getVersion)
        {
            Id = entity.Id;
            Name = entity.Name;
        ...
        public static UniversityDocument? FromEntity(IUniversity? entity, Func<object, int?> getVersion)
        {
            if (entity is null)
            {
                return null;
