...
internal static class Utils
{
    ...
    public static CSharpStatement GetReturnStatement(this ControllerTemplate template, IControllerOperationModel operationModel)
    {
        ...
        switch (operationModel.Verb)
        {
            ...
            case HttpVerb.Patch:
            case HttpVerb.Put:
                returnExpression = $"{template.ResponseMapper.GetSuccessResponseCodeOperation(operationModel.InternalElement, hasReturnType ? $"Ok({resultExpression})" : "NoContent()", resultExpression)}";
                break;
            case HttpVerb.Delete:
                returnExpression = $"{template.ResponseMapper.GetSuccessResponseCodeOperation(operationModel.InternalElement, hasReturnType ? $"Ok({resultExpression})" : "Ok()", resultExpression)}";
                break;
            case HttpVerb.Post:
                ...
                returnExpression ??= $"{template.ResponseMapper.GetSuccessResponseCodeOperation(operationModel.InternalElement, hasReturnType ? $"Created(string.Empty, {resultExpression})" : "Created(string.Empty, null)", resultExpression)}";
                break;
            default:
