...
{
    public class Db3DomainPackageAuditLogConfiguration : IEntityTypeConfiguration<Db3DomainPackageAuditLog>
    {
        public void Configure(EntityTypeBuilder<Db3DomainPackageAuditLog> builder)
        {
