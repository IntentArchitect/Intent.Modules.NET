...
namespace EntityFrameworkCore.Repositories.TestApplication.Application.AggregateRoot1RepoOperationInvocation.Operation_Params3_ReturnsV_Collection0
{
    [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
    public class Operation_Params3_ReturnsV_Collection0CommandHandler : IRequestHandler<Operation_Params3_ReturnsV_Collection0Command>
    {
        private readonly IAggregateRoot1Repository _aggregateRoot1Repository;

        [IntentManaged(Mode.Merge)]
        public Operation_Params3_ReturnsV_Collection0CommandHandler(IAggregateRoot1Repository aggregateRoot1Repository)
        {
        ...
        public async Task Handle(
            Operation_Params3_ReturnsV_Collection0Command request,
