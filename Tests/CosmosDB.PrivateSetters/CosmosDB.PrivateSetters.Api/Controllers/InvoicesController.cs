...
using CosmosDB.PrivateSetters.Application.Invoices;
using CosmosDB.PrivateSetters.Application.Invoices.CreateInvoice;
using CosmosDB.PrivateSetters.Application.Invoices.CreateInvoiceLineItem;
using CosmosDB.PrivateSetters.Application.Invoices.DeleteInvoice;
using CosmosDB.PrivateSetters.Application.Invoices.DeleteInvoiceLineItem;
using CosmosDB.PrivateSetters.Application.Invoices.GetInvoiceById;
using CosmosDB.PrivateSetters.Application.Invoices.GetInvoiceLineItemById;
using CosmosDB.PrivateSetters.Application.Invoices.GetInvoiceLineItems;
using CosmosDB.PrivateSetters.Application.Invoices.GetInvoices;
using CosmosDB.PrivateSetters.Application.Invoices.UpdateInvoice;
using CosmosDB.PrivateSetters.Application.Invoices.UpdateInvoiceByOp;
using CosmosDB.PrivateSetters.Application.Invoices.UpdateInvoiceLineItem;
