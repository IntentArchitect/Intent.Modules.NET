...
namespace Intent.Modules.AspNetCore.Controllers.Dispatch.Wolverine.FactoryExtensions
{
    [IntentManaged(Mode.Fully, Body = Mode.Merge)]
    public class WolverineControllerDispatchExtension : FactoryExtensionBase
    {
        public override string Id => "Intent.AspNetCore.Controllers.Dispatch.Wolverine.WolverineControllerDispatchExtension";
            ...
            foreach (var controllerTemplate in controllerTemplates)
            {
                ...
                controllerTemplate.CSharpFile.OnBuild(file =>
                {
                    ...
                    foreach (var actionMethod in controllerClass.Methods)
                    {
                        ...
                        actionMethod.AddStatement(GetDispatchViaWolverineStatement(controllerTemplate, operationModel), s => s.SeparatedFromPrevious());
        ...
        private CSharpStatement GetDispatchViaWolverineStatement(ControllerTemplate template, IControllerOperationModel operationModel)
        {
