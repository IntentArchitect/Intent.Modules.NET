                ...
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 9, >= 0) => new PackageVersion("15.1.5")
                            .WithNugetDependency("HotChocolate.Authorization", "15.1.5")
                            .WithNugetDependency("HotChocolate.Execution.Projections", "15.1.5")
                            .WithNugetDependency("HotChocolate.Execution", "15.1.5")
                            .WithNugetDependency("HotChocolate.Fetching", "15.1.5")
                            .WithNugetDependency("HotChocolate.Types.CursorPagination.Extensions", "15.1.5")
                            .WithNugetDependency("HotChocolate.Types.CursorPagination", "15.1.5")
                            .WithNugetDependency("HotChocolate.Types.Mutations", "15.1.5")
                            .WithNugetDependency("HotChocolate.Types.Queries", "15.1.5")
                            .WithNugetDependency("HotChocolate.Types", "15.1.5")
                            .WithNugetDependency("HotChocolate.Validation", "15.1.5")
                            .WithNugetDependency("HotChocolate.CostAnalysis", "15.1.5"),
