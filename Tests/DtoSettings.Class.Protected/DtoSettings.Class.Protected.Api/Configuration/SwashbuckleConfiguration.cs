...
using DtoSettings.Class.Protected.Api.Filters;
using DtoSettings.Class.Protected.Application;
...
namespace DtoSettings.Class.Protected.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("DtoSettings.Class.Protected API");
