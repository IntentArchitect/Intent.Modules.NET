...
using CosmosDB.Authentication.Domain.Common.Exceptions;
...
namespace CosmosDB.Authentication.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("CosmosDB.Authentication API");
