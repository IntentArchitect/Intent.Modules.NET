...
namespace EntityFrameworkCore.Repositories.TestApplication.Application.CustomRepoOperationInvocation.Operation_Params1_ReturnsD_Collection1Async
{
    [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
    public class Operation_Params1_ReturnsD_Collection1AsyncQueryHandler : IRequestHandler<Operation_Params1_ReturnsD_Collection1AsyncQuery, List<SpResultDto>>
    {
        private readonly ICustomRepository _customRepository;
        private readonly IMapper _mapper;

        [IntentManaged(Mode.Merge)]
        public Operation_Params1_ReturnsD_Collection1AsyncQueryHandler(ICustomRepository customRepository, IMapper mapper)
        {
        ...
        public async Task<List<SpResultDto>> Handle(
            Operation_Params1_ReturnsD_Collection1AsyncQuery request,
            CancellationToken cancellationToken)
        {
            var result = await _customRepository.Operation_Params1_ReturnsD_Collection1Async(new SpParameter(
