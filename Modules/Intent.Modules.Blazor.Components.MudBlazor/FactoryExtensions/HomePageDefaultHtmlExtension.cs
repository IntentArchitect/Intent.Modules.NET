...
namespace Intent.Modules.Blazor.Components.MudBlazor.FactoryExtensions
{
    ...
    public class HomePageDefaultHtmlExtension : FactoryExtensionBase
    {
        ...
        protected override void OnAfterTemplateRegistrations(IApplication application)
        {
            ...
            // Once-off by construction: ComponentRazorTemplateBase.TransformText() only consults
            // DefaultContentOverride when the .razor file does not yet exist on disk.
            homeTemplate.DefaultContentOverride = GetHomePageDefaultContent();
        ...
        /// <summary>
        /// <c>@page</c> and <c>&lt;PageTitle&gt;</c> are deliberately omitted — <see cref="Intent.Modules.Blazor.Templates.Templates.Client.ComponentRazorTemplateBase"/>
        /// injects those from the model's <c>Page</c> stereotype (and strips them from seeded content) on every run.
        /// </summary>
