...
using Kafka.Producer.Api.Controllers.ResponseTypes;
using Kafka.Producer.Application.Invoices;
using Kafka.Producer.Application.Invoices.CreateInvoice;
using Kafka.Producer.Application.Invoices.DeleteInvoice;
using Kafka.Producer.Application.Invoices.GetInvoiceById;
using Kafka.Producer.Application.Invoices.GetInvoices;
using Kafka.Producer.Application.Invoices.UpdateInvoice;
using MediatR;
