...
using EntityFrameworkCore.SqlServer.PkNoneProvider.Application.Common.Exceptions;
using EntityFrameworkCore.SqlServer.PkNoneProvider.Domain.Common.Exceptions;
...
namespace EntityFrameworkCore.SqlServer.PkNoneProvider.Api.Filters
{
