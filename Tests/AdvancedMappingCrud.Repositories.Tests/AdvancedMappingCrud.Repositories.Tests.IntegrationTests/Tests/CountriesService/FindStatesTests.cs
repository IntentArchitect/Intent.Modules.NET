...
namespace AdvancedMappingCrud.Repositories.Tests.IntegrationTests.Tests.CountriesService
{
    ...
    public class FindStatesTests : BaseIntegrationTest
    {
        public FindStatesTests(IntegrationTestWebAppFactory factory) : base(factory)
        {
        }

        [Fact]
        public async Task FindStates_ShouldFindStates()
        {
            // Arrange
