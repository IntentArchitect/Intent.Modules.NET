...
using N_ServiceBus.Persistence.Sql.Subscribe.Application.Common.Behaviours;
using N_ServiceBus.Persistence.Sql.Subscribe.Application.Common.Eventing;
using N_ServiceBus.Persistence.Sql.Subscribe.Application.Common.Validation;
using N_ServiceBus.Persistence.Sql.Subscribe.Application.IntegrationEvents.EventHandlers;
using N_ServiceBus.Persistence.Sql.Subscribe.Eventing.Messages;

[assembly: DefaultIntentManaged(Mode.Fully)]
[assembly: IntentTemplate("Intent.Application.DependencyInjection.DependencyInjection", Version = "1.0")]

namespace N_ServiceBus.Persistence.Sql.Subscribe.Application
{
