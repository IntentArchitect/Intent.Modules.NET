...
{
    public record MsgNServiceBusEvent : IEvent
    {
        public const string PubsubName = "pubsub";
        public const string TopicName = "CompositeMessageBus.Eventing.Messages.MsgNServiceBusEvent";

        public MsgNServiceBusEvent()
        {
            Message = null!;
        }
