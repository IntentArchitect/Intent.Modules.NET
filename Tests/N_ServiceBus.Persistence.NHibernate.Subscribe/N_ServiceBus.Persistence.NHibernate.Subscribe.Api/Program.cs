...
using N_ServiceBus.Persistence.NHibernate.Subscribe.Api.Configuration;
using N_ServiceBus.Persistence.NHibernate.Subscribe.Api.Filters;
using N_ServiceBus.Persistence.NHibernate.Subscribe.Api.Logging;
using N_ServiceBus.Persistence.NHibernate.Subscribe.Application;
using N_ServiceBus.Persistence.NHibernate.Subscribe.Infrastructure;
using Serilog;
...
namespace N_ServiceBus.Persistence.NHibernate.Subscribe.Api
{
