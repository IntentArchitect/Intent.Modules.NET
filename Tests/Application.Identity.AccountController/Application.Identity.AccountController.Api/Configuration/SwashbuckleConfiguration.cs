...
using Application.Identity.AccountController.Domain.Common.Exceptions;
            ...
            services.AddSwaggerGen(
                options =>
                {
                    options.SwaggerDoc(
                        ...
                        {
                            Version = "v1",
                            Title = "Application.Identity.AccountController API"
                        });
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.SwaggerEndpoint("/swagger/v1/swagger.json", "Application.Identity.AccountController API V1");
                    options.OAuthAppName("Application.Identity.AccountController API");
