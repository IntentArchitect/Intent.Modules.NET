...
namespace AdvancedMappingCrud.RichDomain.ServiceModel.Tests.Infrastructure.Repositories
{
    ...
    public class CustomConstructorRepository : RepositoryBase<CustomConstructor, CustomConstructor, ApplicationDbContext>, ICustomConstructorRepository
    {
        public CustomConstructorRepository(ApplicationDbContext dbContext, IMapper mapper) : base(dbContext, mapper)
        {
        }
        ...
        public async Task<CustomConstructor?> FindByIdAsync(Guid id, CancellationToken cancellationToken = default)
        {
