...
using System.Linq;
using Intent.Engine;
using Intent.Modules.Blazor.Templates.Templates.AI.BlazorPageEditingEntitySkill;
...
{
    public class BlazorPageEditingEntitySkillSampleFilesStaticContentTemplateRegistration : StaticContentTemplateRegistration
    {
        public new const string TemplateId = "Intent.Modules.Blazor.Templates.Templates.StaticContentTemplateRegistrations.BlazorPageEditingEntitySkillSampleFilesStaticContentTemplateRegistration";

        public BlazorPageEditingEntitySkillSampleFilesStaticContentTemplateRegistration() : base(TemplateId)
        {
        }
        ...
        protected override ITemplate CreateTemplate(IOutputTarget outputTarget, string fileFullPath, string fileRelativePath, OverwriteBehaviour defaultOverwriteBehaviour)
        {
            return new SkillSampleStaticContentTemplate(
                ...
                skillTemplateId: BlazorPageEditingEntitySkillTemplate.TemplateId);
        }
