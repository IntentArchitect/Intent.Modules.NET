...
{
    public class BlazorDialogAddingEntitySkillSampleFilesStaticContentTemplateRegistration : StaticContentTemplateRegistration
    {
        public new const string TemplateId = "Intent.Modules.Blazor.Templates.Templates.StaticContentTemplateRegistrations.BlazorDialogAddingEntitySkillSampleFilesStaticContentTemplateRegistration";

        public BlazorDialogAddingEntitySkillSampleFilesStaticContentTemplateRegistration() : base(TemplateId)
        {
        }
        ...
        protected override ITemplate CreateTemplate(IOutputTarget outputTarget, string fileFullPath, string fileRelativePath, OverwriteBehaviour defaultOverwriteBehaviour)
        {
            return new SkillSampleStaticContentTemplate(
                ...
                skillTemplateId: BlazorDialogAddingEntitySkillTemplate.TemplateId);
        }
    }
}
