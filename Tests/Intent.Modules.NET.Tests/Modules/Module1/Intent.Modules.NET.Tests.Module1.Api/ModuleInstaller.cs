...
namespace Intent.Modules.NET.Tests.Module1.Api
{
    public class ModuleInstaller : IModuleInstaller
    {
        ...
        {
            AddCommentFile(options, Path.Combine(AppContext.BaseDirectory, $"{typeof(Intent.Modules.NET.Tests.Module1.Api.ModuleInstaller).Assembly.GetName().Name}.xml"));
            AddCommentFile(options, Path.Combine(AppContext.BaseDirectory, $"{typeof(Intent.Modules.NET.Tests.Module1.Application.DependencyInjection).Assembly.GetName().Name}.Contracts.xml"));
        }
