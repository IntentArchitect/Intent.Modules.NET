    ...
    public class Migration_04_01_06_Pre_00 : IModuleMigration
    {
        ...
        public void Up()
        {
            ...
            if (existingIdentityUser != null)
            {
                ...
                existingIdentityUser.Stereotypes.Remove(existingIdentityUser.Stereotypes.First(x => x.Name == "Identity User"));
                existingIdentityUser.ChildElements.Remove(existingIdentityUser.ChildElements.First(x => x.Name == "Id"));
                existingIdentityUser.ChildElements.Add(new ElementPersistable
                {
                    Id = Guid.NewGuid().ToString(),
                    SpecializationType = "Attribute",
                    SpecializationTypeId = "0090fb93-483e-41af-a11d-5ad2dc796adf",
                    ParentFolderId = existingIdentityUser.Id,
                ...
                package.Associations.Add(new AssociationPersistable
                {
                    ...
                    SourceEnd = new AssociationEndPersistable
                    {
                        ...
                        Display = $": {existingIdentityUser.Name}",
                        Order = 0,
                        TypeReference = new TypeReferencePersistable
                        {
                            Id = Guid.NewGuid().ToString(),
