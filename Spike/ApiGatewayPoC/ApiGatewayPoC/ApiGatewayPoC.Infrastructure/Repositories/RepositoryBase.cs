...
using ApiGatewayPoC.Application.Common.Pagination;
using ApiGatewayPoC.Domain.Common.Interfaces;
using ApiGatewayPoC.Domain.Repositories;
using AutoMapper;
...
namespace ApiGatewayPoC.Infrastructure.Repositories
{
