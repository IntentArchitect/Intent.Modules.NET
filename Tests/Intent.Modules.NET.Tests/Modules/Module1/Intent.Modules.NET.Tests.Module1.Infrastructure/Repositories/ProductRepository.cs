...
namespace Intent.Modules.NET.Tests.Module1.Infrastructure.Repositories
{
    ...
    public class ProductRepository : RepositoryBase<Product, Product, Module1DbContext>, IProductRepository
    {
        public ProductRepository(Module1DbContext dbContext, IMapper mapper) : base(dbContext, mapper)
        {
        }
