...
* Fixed: Code generated by Intent Architect for the Cosmos DB provider when using the Tables Per Hierarchy inheritance strategy now supports polymorphism (and inheritance in general).
