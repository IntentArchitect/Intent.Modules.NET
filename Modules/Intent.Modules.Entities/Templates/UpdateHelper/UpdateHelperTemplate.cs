...
namespace Intent.Modules.Entities.Templates.UpdateHelper
{
    ...
    #line 1 "D:\Dev\Intent.Modules.NET\Modules\Intent.Modules.Entities\Templates\UpdateHelper\UpdateHelperTemplate.tt"
...
#line hidden
        ...
        public override string TransformText()
        {
            ...
            #line 15 "D:\Dev\Intent.Modules.NET\Modules\Intent.Modules.Entities\Templates\UpdateHelper\UpdateHelperTemplate.tt"
            ...
            #line 20 "D:\Dev\Intent.Modules.NET\Modules\Intent.Modules.Entities\Templates\UpdateHelper\UpdateHelperTemplate.tt"
            ...
            this.Write("\r\n    {\r\n        /// <summary>\r\n        /// Performs mutations to synchronize the" +
                    ...
                    "e changed collection is <see langword=\"null\" />, an empty list of type <typepara" +
                    "mref name=\"TOriginal\"/> will be returned.\r\n        /// If the base collection is" +
                    " <see langword=\"null\" />, a new list of type <typeparamref name=\"TOriginal\"/> wi" +
                    "ll be created and used.\r\n        /// </remarks>\r\n        public static ICollecti" +
                    "on<TOriginal> CreateOrUpdateCollection<TChanged, TOriginal>(\r\n            IColle" +
                    "ction<TOriginal> baseCollection,\r\n            IEnumerable<TChanged>? changedColl" +
                    "ection,\r\n            Func<TOriginal, TChanged, bool> equalityCheck,\r\n           " +
                    " Func<TOriginal?, TChanged, TOriginal> assignmentAction)\r\n        {\r\n           " +
                    " if (changedCollection == null)\r\n            {\r\n                return new List<" +
                    "TOriginal>();\r\n            }\r\n\r\n            baseCollection ??= new List<TOrigina" +
                    "l>()!;\r\n\r\n            var result = baseCollection.CompareCollections(changedColl" +
                    "ection, equalityCheck);\r\n            foreach (var elementToAdd in result.ToAdd)\r" +
                    "\n            {\r\n                var newEntity = assignmentAction(default, elemen" +
                    "tToAdd);\r\n                baseCollection.Add(newEntity);\r\n            }\r\n\r\n     " +
                    "       foreach (var elementToRemove in result.ToRemove)\r\n            {\r\n        " +
                    "        baseCollection.Remove(elementToRemove);\r\n            }\r\n\r\n            fo" +
                    "reach (var elementToEdit in result.PossibleEdits)\r\n            {\r\n              " +
