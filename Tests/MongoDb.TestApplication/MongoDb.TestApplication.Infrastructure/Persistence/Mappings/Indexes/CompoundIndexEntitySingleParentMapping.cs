...
{
    public class CompoundIndexEntitySingleParentMapping : IMongoMappingConfiguration<CompoundIndexEntitySingleParent>
    {
        public string CollectionName => "CompoundIndexEntitySingleParents";

        public void RegisterCollectionMap()
        {
            if (!BsonClassMap.IsClassMapRegistered(typeof(CompoundIndexEntitySingleParent)))
            {
                BsonClassMap.RegisterClassMap<CompoundIndexEntitySingleParent>(
                    mapping =>
                    {
                        mapping.AutoMap();
