...
using Entities.Constants.TestApplication.Api.Filters;
...
namespace Entities.Constants.TestApplication.Api.Configuration
{
            ...
            services.AddSwaggerGen(
                options =>
                {
                    options.SwaggerDoc(
                        ...
                        {
                            Version = "v1",
                            Title = "Entities.Constants.TestApplication API"
                        });
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.SwaggerEndpoint("/swagger/v1/swagger.json", "Entities.Constants.TestApplication API V1");
                    options.OAuthAppName("Entities.Constants.TestApplication API");
