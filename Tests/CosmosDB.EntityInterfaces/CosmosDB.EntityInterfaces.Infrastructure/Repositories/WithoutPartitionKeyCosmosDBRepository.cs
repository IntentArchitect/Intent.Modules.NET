...
{
    internal class WithoutPartitionKeyCosmosDBRepository : CosmosDBRepositoryBase<IWithoutPartitionKey, WithoutPartitionKey, WithoutPartitionKeyDocument, IWithoutPartitionKeyDocument>, IWithoutPartitionKeyRepository
    {
        ...
        public async Task<IWithoutPartitionKey?> FindByIdAsync(string id, CancellationToken cancellationToken = default) => await base.FindByIdAsync(id: id, cancellationToken: cancellationToken);

        public override string GetId(IWithoutPartitionKey entity) => entity.Id;
    }
}