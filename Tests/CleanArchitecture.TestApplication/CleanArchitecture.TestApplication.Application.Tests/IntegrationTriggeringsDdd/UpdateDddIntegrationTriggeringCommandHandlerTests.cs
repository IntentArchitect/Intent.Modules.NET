...
{
    public class UpdateDddIntegrationTriggeringCommandHandlerTests
    {
        public static IEnumerable<object[]> GetSuccessfulResultTestData()
        {
            ...
            fixture.Customize<UpdateDddIntegrationTriggeringCommand>(comp => comp.With(x => x.Id, existingEntity.Id));
            var testCommand = fixture.Create<UpdateDddIntegrationTriggeringCommand>();
        ...
        public async Task Handle_WithValidCommand_UpdatesExistingEntity(
            UpdateDddIntegrationTriggeringCommand testCommand,
            IntegrationTriggering existingEntity)
        {
            ...
            var sut = new UpdateDddIntegrationTriggeringCommandHandler(integrationTriggeringRepository, eventBus);
