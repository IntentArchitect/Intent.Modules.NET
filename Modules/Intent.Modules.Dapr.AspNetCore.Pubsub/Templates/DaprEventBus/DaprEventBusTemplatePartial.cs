...
namespace Intent.Modules.Dapr.AspNetCore.Pubsub.Templates.DaprEventBus
{
    [IntentManaged(Mode.Fully, Body = Mode.Merge)]
    public partial class DaprEventBusTemplate : CSharpTemplateBase<object>, ICSharpFileBuilderTemplate
    {
        public const string TemplateId = "Intent.Dapr.AspNetCore.Pubsub.DaprEventBus";

        [IntentManaged(Mode.Fully, Body = Mode.Ignore)]
        public DaprEventBusTemplate(IOutputTarget outputTarget, object model = null) : base(TemplateId, outputTarget, model)
        {
