...
namespace Intent.Modules.ModularMonolith.ModuleInfrastructure.FactoryExtensions
{
    ...
    {
        public override string Id => "Intent.ModularMonolith.ModuleInfrastructure.TemplateSuppressorExtension";
        ...
        private static void DisbaleSubscribedOnes(System.Collections.Generic.IEnumerable<ICSharpFileBuilderTemplate> templates)
        {
            ...
            {
                if (!template.Namespace.StartsWith(template.OutputTarget.GetNamespace()))
                {
