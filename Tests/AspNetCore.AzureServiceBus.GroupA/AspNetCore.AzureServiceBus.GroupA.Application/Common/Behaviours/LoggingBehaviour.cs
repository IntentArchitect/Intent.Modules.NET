...
namespace AspNetCore.AzureServiceBus.GroupA.Application.Common.Behaviours
{
        ...
        where TRequest : notnull
    {
        ...
        public Task Process(TRequest request, CancellationToken cancellationToken)
        {
            ...
            {
                _logger.LogInformation("AspNetCore.AzureServiceBus.GroupA Request: {Name} {@UserId} {@UserName} {@Request}", requestName, userId, userName, request);
            }
            else
            {
                _logger.LogInformation("AspNetCore.AzureServiceBus.GroupA Request: {Name} {@UserId} {@UserName}", requestName, userId, userName);
            }
