                ...
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 9, >= 0) => new PackageVersion("9.0.6")
                            .WithNugetDependency("Microsoft.AspNetCore.Components.Web", "9.0.6")
                            ...
                            .WithNugetDependency("Microsoft.JSInterop.WebAssembly", "9.0.6"),
                        ( >= 8, >= 0) => new PackageVersion("8.0.17")
                            .WithNugetDependency("Microsoft.AspNetCore.Components.Web", "8.0.17")
                            ...
                            .WithNugetDependency("Microsoft.JSInterop.WebAssembly", "8.0.17"),
                ...
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 9, >= 0) => new PackageVersion("9.0.5")
                            .WithNugetDependency("Microsoft.AspNetCore.Components.Authorization", "9.0.5")
                            .WithNugetDependency("Microsoft.AspNetCore.Components.Web", "9.0.5"),
                        ( >= 8, >= 0) => new PackageVersion("8.0.16")
                            .WithNugetDependency("Microsoft.AspNetCore.Components.Authorization", "8.0.16")
