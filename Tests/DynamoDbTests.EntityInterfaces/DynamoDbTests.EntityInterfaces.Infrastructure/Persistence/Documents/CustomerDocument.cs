...
namespace DynamoDbTests.EntityInterfaces.Infrastructure.Persistence.Documents
{
    ...
    internal class CustomerDocument : IDynamoDBDocument<ICustomer, Customer, CustomerDocument>
    {
        [DynamoDBHashKey]
        ...
        public CustomerDocument PopulateFromEntity(ICustomer entity, Func<object, int?> getVersion)
        {
            Id = entity.Id;
            Name = entity.Name;
        ...
        public static CustomerDocument? FromEntity(ICustomer? entity, Func<object, int?> getVersion)
        {
            if (entity is null)
            {
                return null;
