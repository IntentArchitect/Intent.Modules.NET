...
namespace Intent.Modules.VisualStudio.Projects.Templates.ServiceFabric.ServiceManifest
{
    ...
    public class ServiceManifestTemplateRegistration : ITemplateRegistration
    {
        private readonly IMetadataManager _metadataManager;

        public ServiceManifestTemplateRegistration(IMetadataManager metadataManager)
        {
            _metadataManager = metadataManager;
        }

        public string TemplateId => ServiceManifestTemplate.TemplateId;
        ...
        public void DoRegistration(ITemplateInstanceRegistry registry, IApplication applicationManager)
        {
            ...
            foreach (var model in models)
            {
                ...
                registry.Register(TemplateId, project, p => new ServiceManifestTemplate(p, model));
            }
        }
    }
}