...
using AzureFunctions.AzureEventGrid.Application.Common.Models;
using AzureFunctions.AzureEventGrid.Domain.Common;
...
namespace AzureFunctions.AzureEventGrid.Infrastructure.Services
{
