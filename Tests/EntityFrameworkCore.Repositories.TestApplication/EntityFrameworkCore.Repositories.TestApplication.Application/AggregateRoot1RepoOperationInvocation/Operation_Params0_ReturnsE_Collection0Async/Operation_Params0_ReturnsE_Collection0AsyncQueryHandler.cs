...
namespace EntityFrameworkCore.Repositories.TestApplication.Application.AggregateRoot1RepoOperationInvocation.Operation_Params0_ReturnsE_Collection0Async
{
    ...
    public class Operation_Params0_ReturnsE_Collection0AsyncQueryHandler : IRequestHandler<Operation_Params0_ReturnsE_Collection0AsyncQuery, AggregateRoot1Dto>
    {
        ...
        public Operation_Params0_ReturnsE_Collection0AsyncQueryHandler(IAggregateRoot1Repository aggregateRoot1Repository,
            IMapper mapper)
        {
        ...
        {
            var result = await _aggregateRoot1Repository.Operation_Params0_ReturnsE_Collection0Async(cancellationToken);
