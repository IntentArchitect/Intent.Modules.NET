...
namespace Intent.Modules.AspNetCore.Identity.JWT.FactoryExtensions
{
    [IntentManaged(Mode.Fully, Body = Mode.Merge)]
    public class ConfigureJwtAuthentication : FactoryExtensionBase
    {
        public override string Id => "Intent.AspNetCore.Identity.JWT.ConfigureJwtAuthentication";
