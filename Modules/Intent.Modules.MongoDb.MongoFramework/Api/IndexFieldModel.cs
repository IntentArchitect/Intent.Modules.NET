...
namespace Intent.MongoDb.MongoFramework.Api
{
    ...
    public class IndexFieldModel : IMetadataModel, IHasStereotypes, IHasName, IElementWrapper
    {
        public const string SpecializationType = "Index Field";
        public const string SpecializationTypeId = "5d296c19-e71b-46e7-9737-027d47e8f6e8";
        protected readonly IElement _element;

        [IntentManaged(Mode.Fully)]
        public IndexFieldModel(IElement element, string requiredType = SpecializationTypeId)
        {
