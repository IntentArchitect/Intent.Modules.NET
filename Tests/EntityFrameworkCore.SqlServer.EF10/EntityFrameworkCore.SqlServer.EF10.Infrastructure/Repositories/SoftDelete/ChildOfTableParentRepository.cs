...
using EntityFrameworkCore.SqlServer.EF10.Domain.Repositories.SoftDelete;
...
namespace EntityFrameworkCore.SqlServer.EF10.Infrastructure.Repositories.SoftDelete
{
    ...
    public class ChildOfTableParentRepository : RepositoryBase<ChildOfTableParent, ChildOfTableParent, ApplicationDbContext>, IChildOfTableParentRepository
    {
        ...
        public async Task<ChildOfTableParent?> FindByIdAsync(
            Guid id,
            Func<IQueryable<ChildOfTableParent>, IQueryable<ChildOfTableParent>> queryOptions,
