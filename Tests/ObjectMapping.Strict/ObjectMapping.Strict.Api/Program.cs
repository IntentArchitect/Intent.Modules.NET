...
using ObjectMapping.Strict.Api;
using ObjectMapping.Strict.Api.Configuration;
using ObjectMapping.Strict.Api.Filters;
using ObjectMapping.Strict.Api.Logging;
using ObjectMapping.Strict.Application;
using ObjectMapping.Strict.Infrastructure;
using Serilog;
