        ...
        public void RegisterPackages()
        {
            NugetRegistry.Register(ConfluentKafkaPackageName,
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 8, >= 0) => new PackageVersion("2.11.1")
                            .WithNugetDependency("librdkafka.redist", "2.11.1"),
                        ( >= 6, >= 0) => new PackageVersion("2.11.1")
                            .WithNugetDependency("librdkafka.redist", "2.11.1"),
                        ( >= 2, >= 0) => new PackageVersion("2.11.1")
                            .WithNugetDependency("librdkafka.redist", "2.11.1")
            ...
            NugetRegistry.Register(ConfluentSchemaRegistrySerdesJsonPackageName,
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 8, >= 0) => new PackageVersion("2.11.1")
                            .WithNugetDependency("Confluent.Kafka", "2.11.1")
                            .WithNugetDependency("Confluent.SchemaRegistry", "2.11.1")
                ...
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 9, >= 0) => new PackageVersion("9.0.8")
                            ...
                            .WithNugetDependency("Microsoft.Extensions.Configuration.Binder", "9.0.8")
                            .WithNugetDependency("Microsoft.Extensions.Configuration.CommandLine", "9.0.8")
                            .WithNugetDependency("Microsoft.Extensions.Configuration.EnvironmentVariables", "9.0.8")
                            .WithNugetDependency("Microsoft.Extensions.Configuration.FileExtensions", "9.0.8")
                            .WithNugetDependency("Microsoft.Extensions.Configuration.Json", "9.0.8")
                            .WithNugetDependency("Microsoft.Extensions.Configuration.UserSecrets", "9.0.8")
                            ...
                            .WithNugetDependency("Microsoft.Extensions.FileProviders.Abstractions", "9.0.8")
                            .WithNugetDependency("Microsoft.Extensions.FileProviders.Physical", "9.0.8")
                            .WithNugetDependency("Microsoft.Extensions.Hosting.Abstractions", "9.0.8")
                            ...
                            .WithNugetDependency("Microsoft.Extensions.Logging.Configuration", "9.0.8")
                            .WithNugetDependency("Microsoft.Extensions.Logging.Console", "9.0.8")
                            .WithNugetDependency("Microsoft.Extensions.Logging.Debug", "9.0.8")
                            .WithNugetDependency("Microsoft.Extensions.Logging.EventLog", "9.0.8")
                            .WithNugetDependency("Microsoft.Extensions.Logging.EventSource", "9.0.8")
