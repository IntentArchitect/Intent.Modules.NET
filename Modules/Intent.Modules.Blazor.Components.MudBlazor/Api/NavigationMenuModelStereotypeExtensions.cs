...
{
    public static class NavigationMenuModelStereotypeExtensions
    {

        public static Icon GetIcon(this NavigationMenuModel model)
        {
        ...
        public static bool HasIcon(this NavigationMenuModel model)
        {
            return model.HasStereotype(Icon.DefinitionId);
        }

        public static bool TryGetIcon(this NavigationMenuModel model, out Icon stereotype)
        {
            if (!HasIcon(model))
            {
                stereotype = null;
