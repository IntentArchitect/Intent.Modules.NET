...
using Publish.AspNetCore.GooglePubSub.TestApplication.Api.Filters;
...
namespace Publish.AspNetCore.GooglePubSub.TestApplication.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.SwaggerEndpoint("/swagger/v1/swagger.json", "Publish.AspNetCore.GooglePubSub.TestApplication API V1");
                    options.OAuthAppName("Publish.AspNetCore.GooglePubSub.TestApplication API");
