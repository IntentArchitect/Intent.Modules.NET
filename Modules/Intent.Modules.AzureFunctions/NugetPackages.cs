        ...
        public void RegisterPackages()
        {
                ...
                (framework) => framework switch
                    {
                        ( >= 8, 0) => new PackageVersion("9.0.3")
                            .WithNugetDependency("Microsoft.EntityFrameworkCore.Abstractions", "9.0.3")
                            .WithNugetDependency("Microsoft.EntityFrameworkCore.Analyzers", "9.0.3")
                            .WithNugetDependency("Microsoft.Extensions.Caching.Memory", "9.0.3")
                ...
                (framework) => framework switch
                    {
                        ( >= 8, 0) => new PackageVersion("9.0.3")
                            ...
                            .WithNugetDependency("Microsoft.EntityFrameworkCore", "9.0.3")
                            .WithNugetDependency("Microsoft.Extensions.Caching.Memory", "9.0.3")
                            .WithNugetDependency("Microsoft.Extensions.Logging", "9.0.3")
                            .WithNugetDependency("Newtonsoft.Json", "13.0.3")
                ...
                (framework) => framework switch
                    {
                        ( >= 8, 0) => new PackageVersion("9.0.3")
                            ...
                            .WithNugetDependency("Microsoft.EntityFrameworkCore.Relational", "9.0.3")
                            .WithNugetDependency("Microsoft.Extensions.Caching.Memory", "9.0.3")
                ...
                (framework) => framework switch
                    {
                        ( >= 8, 0) => new PackageVersion("9.0.3")
                            ...
                            .WithNugetDependency("Microsoft.Extensions.Configuration.Abstractions", "9.0.3")
                            .WithNugetDependency("Microsoft.Extensions.Logging", "9.0.3")
                            .WithNugetDependency("System.Formats.Asn1", "9.0.3")
                            .WithNugetDependency("System.Text.Json", "9.0.3"),
                        ( >= 6, 0) => new PackageVersion("6.0.32", locked: true),
                        ( >= 2, 1) => new PackageVersion("5.0.17")
            ...
            NugetRegistry.Register(MicrosoftEntityFrameworkCoreToolsPackageName,
                (framework) => framework switch
                    {
                        ( >= 8, 0) => new PackageVersion("9.0.3")
                            .WithNugetDependency("Microsoft.EntityFrameworkCore.Design", "9.0.3"),
                        ( >= 6, 0) => new PackageVersion("6.0.32", locked: true),
                ...
                (framework) => framework switch
                    {
                        ...
                        ( >= 2, 1) => new PackageVersion("9.0.3")
                            ...
                            .WithNugetDependency("Microsoft.Extensions.Logging.Abstractions", "9.0.3")
                            .WithNugetDependency("Microsoft.Extensions.Options", "9.0.3")
                            .WithNugetDependency("System.Diagnostics.DiagnosticSource", "9.0.3"),
                        ( >= 2, 0) => new PackageVersion("9.0.3")
                            .WithNugetDependency("Microsoft.Bcl.AsyncInterfaces", "9.0.3")
                            .WithNugetDependency("Microsoft.Extensions.DependencyInjection", "9.0.3")
                            .WithNugetDependency("Microsoft.Extensions.Logging.Abstractions", "9.0.3")
