...
namespace WolverineEventing.ErrorPolicy.ScheduleRetry.Infrastructure.Configuration
{
    public static class WolverineConfiguration
    {
        ...
        {
            var delays = ParseDelays(configuration["Wolverine:ErrorHandling:ScheduleRetry:Delays"] ?? "00:01:00, 00:05:00, 00:15:00");
