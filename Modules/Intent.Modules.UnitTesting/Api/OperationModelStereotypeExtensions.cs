...
namespace Intent.UnitTesting.Api
{
    ...
    {
        public static UnitTest GetUnitTest(this OperationModel model)
        {
        ...
        public static bool HasUnitTest(this OperationModel model)
        {
            return model.HasStereotype(UnitTest.DefinitionId);
        }

        public static bool TryGetUnitTest(this OperationModel model, out UnitTest stereotype)
        {
