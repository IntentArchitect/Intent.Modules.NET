...
namespace Intent.Modules.Blazor.Components.MudBlazor.Templates.MudBlazorDialogAddingEntitySkill
{
    [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
    public class MudBlazorDialogAddingEntitySkillTemplate : MarkdownBaseTemplate<object>, IMarkdownFileBuilderTemplate
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Intent.Blazor.Components.MudBlazor.MudBlazorDialogAddingEntitySkillTemplate";

        [IntentManaged(Mode.Fully, Body = Mode.Ignore)]
        public MudBlazorDialogAddingEntitySkillTemplate(IOutputTarget outputTarget, object model = null) : base(TemplateId, outputTarget, model)
        {
