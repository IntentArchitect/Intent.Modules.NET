...
namespace EntityFrameworkCore.SqlServer.EF7.Domain.Repositories.TPH.InheritanceAssociations
{
    ...
    public interface ITPH_AbstractBaseClassRepository : IEFRepository<TPH_AbstractBaseClass, TPH_AbstractBaseClass>
    {
        ...
        [IntentManaged(Mode.Fully)]
        Task<TPH_AbstractBaseClass?> FindByIdAsync(Guid id, Func<IQueryable<TPH_AbstractBaseClass>, IQueryable<TPH_AbstractBaseClass>> queryOptions, CancellationToken cancellationToken = default);
        [IntentManaged(Mode.Fully)]
