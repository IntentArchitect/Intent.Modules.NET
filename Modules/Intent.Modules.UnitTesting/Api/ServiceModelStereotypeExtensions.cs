...
namespace Intent.UnitTesting.Api
{
    ...
    {
        public static UnitTest GetUnitTest(this ServiceModel model)
        {
        ...
        public static bool HasUnitTest(this ServiceModel model)
        {
            return model.HasStereotype(UnitTest.DefinitionId);
        }

        public static bool TryGetUnitTest(this ServiceModel model, out UnitTest stereotype)
        {
