...
{
    /// <summary>
    /// Default (first-generation only) content for the shared UxIcon component, seeded onto the
    ...
    /// unchanged, from the old static content/Components/Account/Shared/UxIcon.razor.
    /// Bootstrap-only — the MudBlazor app uses MudIcon directly instead, so this component is never
    /// referenced (and was never generated) when MudBlazor is installed; no Mud variant needed.
    /// All state is declared in the inline @code block, so <see cref="BuildCodeBehind"/> is a no-op.
    /// </summary>
    internal static class UxIconContent
    {
            ...
            return """
                ...
                @code {
                    ...
                    private string Path => Name switch
                    {
                        ...
                        "mail-check"  => "<path d='M22 13V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h9'/><path d='m3 7 9 6 9-6'/><path d='m16 19 2 2 4-4'/>",
                        "log-in"      => "<path d='M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4'/><polyline points='10 17 15 12 10 7'/><line x1='15' y1='12' x2='3' y2='12'/>",
                        "user"        => "<path d='M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2'/><circle cx='12' cy='7' r='4'/>",
                        "user-plus"   => "<path d='M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2'/><circle cx='8.5' cy='7' r='4'/><line x1='20' y1='8' x2='20' y2='14'/><line x1='23' y1='11' x2='17' y2='11'/>",
                        "shield"      => "<path d='M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z'/>",
                        "key"         => "<circle cx='7.5' cy='15.5' r='4.5'/><path d='m10.7 12.3 9.3-9.3'/><path d='m17 6 2 2'/><path d='m13 10 2 2'/>",
                        "check-circle"=> "<path d='M22 11.08V12a10 10 0 1 1-5.93-9.14'/><polyline points='22 4 12 14.01 9 11.01'/>",
                        "alert"       => "<circle cx='12' cy='12' r='10'/><line x1='12' y1='8' x2='12' y2='12'/><line x1='12' y1='16' x2='12.01' y2='16'/>",
                        "shield-off"  => "<path d='M19.7 14a6.9 6.9 0 0 0 .3-2V5l-8-3-3.2 1.2'/><path d='M4.7 4.7 4 5v7c0 6 8 10 8 10a20.3 20.3 0 0 0 5.6-4.8'/><line x1='2' y1='2' x2='22' y2='22'/>",
