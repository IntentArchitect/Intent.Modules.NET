...
{
    internal class ClientDynamoDBRepository : DynamoDBRepositoryBase<IClient, Client, ClientDocument, string, object>, IClientRepository
    {
        public ClientDynamoDBRepository(IDynamoDBContext context, DynamoDBUnitOfWork unitOfWork) : base(context, unitOfWork)
        {
        }
    }
}