...
namespace Intent.Modules.Blazor.HttpClients.Dtos.FluentValidation.FactoryExtensions
{
    ...
    public class BlazorHttpClientFluentValidation : FactoryExtensionBase
    {
        public override string Id => "Intent.Blazor.HttpClients.Dtos.FluentValidation.BlazorHttpClientFluentValidation";
