        ...
        public void RegisterPackages()
        {
            NugetRegistry.Register(ConfluentKafkaPackageName,
                (framework) => framework switch
                    {
                        ( >= 8, 0) => new PackageVersion("2.6.1")
                            .WithNugetDependency("librdkafka.redist", "2.6.1"),
                        ( >= 6, 0) => new PackageVersion("2.6.1")
                            .WithNugetDependency("librdkafka.redist", "2.6.1"),
                        ( >= 2, 0) => new PackageVersion("2.6.1")
                            .WithNugetDependency("librdkafka.redist", "2.6.1")
            ...
            NugetRegistry.Register(ConfluentSchemaRegistrySerdesJsonPackageName,
                (framework) => framework switch
                    {
                        ( >= 8, 0) => new PackageVersion("2.6.1")
                            .WithNugetDependency("Confluent.Kafka", "2.6.1")
                            .WithNugetDependency("Confluent.SchemaRegistry", "2.6.1")
