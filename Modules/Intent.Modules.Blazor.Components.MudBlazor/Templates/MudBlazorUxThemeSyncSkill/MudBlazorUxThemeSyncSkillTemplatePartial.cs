...
namespace Intent.Modules.Blazor.Components.MudBlazor.Templates.MudBlazorUxThemeSyncSkill
{
    ...
    public class MudBlazorUxThemeSyncSkillTemplate : MarkdownBaseTemplate<object>, IMarkdownFileBuilderTemplate
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Intent.Blazor.Components.MudBlazor.MudBlazorUxThemeSyncSkillTemplate";

        [IntentManaged(Mode.Fully, Body = Mode.Ignore)]
        public MudBlazorUxThemeSyncSkillTemplate(IOutputTarget outputTarget, object model = null) : base(TemplateId, outputTarget, model)
        {
            WithContentHashing = true;
            MarkdownFile = new MarkdownFile($"SKILL", "md", "mudblazor-ux-theme-sync")
                .FromMarkdown("""
---
