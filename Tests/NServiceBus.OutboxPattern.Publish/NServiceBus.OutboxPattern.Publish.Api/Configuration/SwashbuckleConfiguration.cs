...
using NServiceBus.OutboxPattern.Publish.Domain.Common.Exceptions;
...
namespace NServiceBus.OutboxPattern.Publish.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("NServiceBus.OutboxPattern.Publish API");
