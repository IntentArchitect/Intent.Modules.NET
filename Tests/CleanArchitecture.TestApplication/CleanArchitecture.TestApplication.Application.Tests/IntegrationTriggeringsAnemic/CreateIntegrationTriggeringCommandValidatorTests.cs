...
{
    public class CreateIntegrationTriggeringCommandValidatorTests
    {
        public static IEnumerable<object[]> GetSuccessfulResultTestData()
        {
            var fixture = new Fixture();
            var testCommand = fixture.Create<CreateIntegrationTriggeringCommand>();
            yield return new object[] { testCommand };
        }

        [Theory]
        [MemberData(nameof(GetSuccessfulResultTestData))]
        public async Task Validate_WithValidCommand_PassesValidation(CreateIntegrationTriggeringCommand testCommand)
        {
            // Arrange
        ...
        {
            var fixture = new Fixture();
            fixture.Customize<CreateIntegrationTriggeringCommand>(comp => comp.With(x => x.Value, () => default));
            var testCommand = fixture.Create<CreateIntegrationTriggeringCommand>();
        ...
        public async Task Validate_WithInvalidCommand_FailsValidation(
            CreateIntegrationTriggeringCommand testCommand,
        ...
        private ValidationBehaviour<CreateIntegrationTriggeringCommand, System.Guid> GetValidationBehaviour()
        {
            return new ValidationBehaviour<CreateIntegrationTriggeringCommand, System.Guid>(new[] { new CreateIntegrationTriggeringCommandValidator() });
        }
    }
}