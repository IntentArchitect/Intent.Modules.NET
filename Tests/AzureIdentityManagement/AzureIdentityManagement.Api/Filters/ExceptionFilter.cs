...
using AzureIdentityManagement.Application.Common.Exceptions;
using AzureIdentityManagement.Domain.Common.Exceptions;
...
namespace AzureIdentityManagement.Api.Filters
{
