...
using ProxyServiceTests.Proxy.AuthHeaderProvider.Api.Filters;
using ProxyServiceTests.Proxy.AuthHeaderProvider.Application;
using ProxyServiceTests.Proxy.AuthHeaderProvider.Domain.Common.Exceptions;
...
namespace ProxyServiceTests.Proxy.AuthHeaderProvider.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("ProxyServiceTests.Proxy.AuthHeaderProvider API");
