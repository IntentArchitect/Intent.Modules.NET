        ...
        public void RegisterPackages()
        {
                ...
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 9, >= 0) => new PackageVersion("9.0.9")
                            .WithNugetDependency("Microsoft.Extensions.Primitives", "9.0.9"),
            ...
            NugetRegistry.Register(MicrosoftExtensionsHostingWindowsServicesPackageName,
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 9, >= 0) => new PackageVersion("9.0.9")
                            .WithNugetDependency("Microsoft.Extensions.Hosting", "9.0.9")
                            .WithNugetDependency("Microsoft.Extensions.Logging.EventLog", "9.0.9")
                            .WithNugetDependency("System.ServiceProcess.ServiceController", "9.0.9"),
                        ( >= 8, >= 0) => new PackageVersion("9.0.9")
                            .WithNugetDependency("Microsoft.Extensions.Hosting", "9.0.9")
                            .WithNugetDependency("Microsoft.Extensions.Logging.EventLog", "9.0.9")
                            .WithNugetDependency("System.ServiceProcess.ServiceController", "9.0.9"),
