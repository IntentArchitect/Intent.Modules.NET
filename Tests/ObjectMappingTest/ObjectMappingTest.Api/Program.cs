...
using ObjectMappingTest.Api.Configuration;
using ObjectMappingTest.Api.Filters;
using ObjectMappingTest.Api.Logging;
using ObjectMappingTest.Application;
using ObjectMappingTest.Infrastructure;
using Serilog;
...
namespace ObjectMappingTest.Api
{
