...
{
    public class SendSpecificTopicTwo
    {
        ...
        public SendSpecificTopicTwo(ISpecificChannelService appService,
            IEventBus eventBus,
        ...
        [Function("SpecificChannelService_SendSpecificTopicTwo")]
        [OpenApiOperation("SendSpecificTopicTwo", tags: new[] { "SpecificChannel" }, Description = "Send specific topic two")]
        [OpenApiRequestBody(contentType: "application/json", bodyType: typeof(PayloadDto))]
        [OpenApiResponseWithBody(statusCode: HttpStatusCode.BadRequest, contentType: "application/json", bodyType: typeof(object))]
        public async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Function, "post", Route = "specific-channel/send-specific-topic-two")] HttpRequest req,
