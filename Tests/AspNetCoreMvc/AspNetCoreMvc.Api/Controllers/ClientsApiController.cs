...
using AspNetCoreMvc.Api.Controllers.ResponseTypes;
using AspNetCoreMvc.Application.ClientsApi;
using AspNetCoreMvc.Application.ClientsApi.CreateClient;
using AspNetCoreMvc.Application.ClientsApi.DeleteClient;
using AspNetCoreMvc.Application.ClientsApi.GetClientById;
using AspNetCoreMvc.Application.ClientsApi.GetClients;
using AspNetCoreMvc.Application.ClientsApi.UpdateClient;
...
namespace AspNetCoreMvc.Api.Controllers
{
    ...
    public class ClientsApiController : ControllerBase
    {
        ...
        public ClientsApiController(ISender mediator)
        {
