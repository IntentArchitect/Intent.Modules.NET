...
namespace DynamoDbTests.EntityInterfaces.Infrastructure.Persistence.Documents
{
    ...
    internal class RegionDocument : IDynamoDBDocument<IRegion, Region, RegionDocument>
    {
        [DynamoDBHashKey]
        ...
        public RegionDocument PopulateFromEntity(IRegion entity, Func<object, int?> getVersion)
        {
            Id = entity.Id;
            Name = entity.Name;
        ...
        public static RegionDocument? FromEntity(IRegion? entity, Func<object, int?> getVersion)
        {
            if (entity is null)
            {
                return null;
