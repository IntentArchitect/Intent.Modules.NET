...
namespace DynamoDbTests.EntityInterfaces.Infrastructure.Persistence.Documents
{
    ...
    internal class OrderDocument : IDynamoDBDocument<IOrder, Order, OrderDocument>
    {
        [DynamoDBRangeKey]
        ...
        public OrderDocument PopulateFromEntity(IOrder entity, Func<object, int?> getVersion)
        {
            Id = entity.Id;
        ...
        public static OrderDocument? FromEntity(IOrder? entity, Func<object, int?> getVersion)
        {
            if (entity is null)
            {
                return null;
