...
using EntityFrameworkCore.Oracle.TestApplication.Api.Controllers.ResponseTypes;
using EntityFrameworkCore.Oracle.TestApplication.Application.Invoices;
using EntityFrameworkCore.Oracle.TestApplication.Application.Invoices.CreateInvoice;
using EntityFrameworkCore.Oracle.TestApplication.Application.Invoices.DeleteInvoice;
using EntityFrameworkCore.Oracle.TestApplication.Application.Invoices.GetInvoiceById;
using EntityFrameworkCore.Oracle.TestApplication.Application.Invoices.GetInvoices;
using EntityFrameworkCore.Oracle.TestApplication.Application.Invoices.UpdateInvoice;
...
namespace EntityFrameworkCore.Oracle.TestApplication.Api.Controllers
{
    [ApiController]
