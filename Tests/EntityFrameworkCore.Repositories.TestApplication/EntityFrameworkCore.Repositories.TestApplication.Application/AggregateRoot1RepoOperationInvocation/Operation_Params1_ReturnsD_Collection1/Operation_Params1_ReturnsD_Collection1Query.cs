...
{
    public class Operation_Params1_ReturnsD_Collection1Query : IRequest<List<SpResultDto>>, IQuery
    {
        public Operation_Params1_ReturnsD_Collection1Query(byte[] attributeBinary,
            bool attributeBool,
            byte attributeByte,
