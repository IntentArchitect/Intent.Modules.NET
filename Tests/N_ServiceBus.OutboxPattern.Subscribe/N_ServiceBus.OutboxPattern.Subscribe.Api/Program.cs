...
using N_ServiceBus.OutboxPattern.Subscribe.Api.Configuration;
using N_ServiceBus.OutboxPattern.Subscribe.Api.Filters;
using N_ServiceBus.OutboxPattern.Subscribe.Api.Logging;
using N_ServiceBus.OutboxPattern.Subscribe.Application;
using N_ServiceBus.OutboxPattern.Subscribe.Infrastructure;
using Serilog;
...
namespace N_ServiceBus.OutboxPattern.Subscribe.Api
{
