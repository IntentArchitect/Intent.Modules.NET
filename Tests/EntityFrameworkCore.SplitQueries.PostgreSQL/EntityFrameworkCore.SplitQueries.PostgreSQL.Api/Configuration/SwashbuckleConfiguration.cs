...
using EntityFrameworkCore.SplitQueries.PostgreSQL.Api.Filters;
using EntityFrameworkCore.SplitQueries.PostgreSQL.Application;
using EntityFrameworkCore.SplitQueries.PostgreSQL.Domain.Common.Exceptions;
...
namespace EntityFrameworkCore.SplitQueries.PostgreSQL.Api.Configuration
{
            ...
            services.AddSwaggerGen(
                options =>
                {
                    options.SwaggerDoc(
                        ...
                        {
                            Version = "v1",
                            Title = "EntityFrameworkCore.SplitQueries.PostgreSQL API"
                        });
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.SwaggerEndpoint("/swagger/v1/swagger.json", "EntityFrameworkCore.SplitQueries.PostgreSQL API V1");
                    options.OAuthAppName("EntityFrameworkCore.SplitQueries.PostgreSQL API");
