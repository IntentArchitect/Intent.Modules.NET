...
namespace EntityFrameworkCore.SqlServer.PkNoneProvider.Domain.Repositories.Associations
{
    ...
    public interface IA_RequiredCompositeRepository : IEFRepository<A_RequiredComposite, A_RequiredComposite>
    {
        ...
        [IntentManaged(Mode.Fully)]
        Task<A_RequiredComposite?> FindByIdAsync(Guid id, Func<IQueryable<A_RequiredComposite>, IQueryable<A_RequiredComposite>> queryOptions, CancellationToken cancellationToken = default);
        [IntentManaged(Mode.Fully)]
