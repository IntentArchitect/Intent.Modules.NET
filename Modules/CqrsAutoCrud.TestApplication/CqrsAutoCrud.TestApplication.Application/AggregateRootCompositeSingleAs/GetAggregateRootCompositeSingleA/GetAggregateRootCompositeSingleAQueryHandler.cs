...
namespace CqrsAutoCrud.TestApplication.Application.AggregateRootCompositeSingleAs.GetAggregateRootCompositeSingleAById
{
    ...
    public class GetAggregateRootCompositeSingleAQueryHandler : IRequestHandler<GetAggregateRootCompositeSingleA, CompositeSingleADTO>
    {
        private readonly IAggregateRootRepository _aggregateRootRepository;
        private readonly IMapper _mapper;

        [IntentManaged(Mode.Ignore)]
        public GetAggregateRootCompositeSingleAQueryHandler(IAggregateRootRepository aggregateRootRepository, IMapper mapper)
        {
        ...
        public async Task<CompositeSingleADTO> Handle(GetAggregateRootCompositeSingleA request, CancellationToken cancellationToken)
        {
