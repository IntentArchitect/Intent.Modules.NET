...
using EntityFrameworkCore.SqlServer.EF8.Application.Common.Exceptions;
using EntityFrameworkCore.SqlServer.EF8.Domain.Common.Exceptions;
...
namespace EntityFrameworkCore.SqlServer.EF8.Api.Filters
{
