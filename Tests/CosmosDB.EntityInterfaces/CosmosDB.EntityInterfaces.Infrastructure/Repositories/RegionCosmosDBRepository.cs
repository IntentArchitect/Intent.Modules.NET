...
{
    internal class RegionCosmosDBRepository : CosmosDBRepositoryBase<IRegion, Region, RegionDocument, IRegionDocument>, IRegionRepository
    {
        public RegionCosmosDBRepository(CosmosDBUnitOfWork unitOfWork,
            ...
            ICosmosContainerProvider<RegionDocument> containerProvider,
        ...
        public async Task<IRegion?> FindByIdAsync(string id, CancellationToken cancellationToken = default) => await base.FindByIdAsync(id: id, cancellationToken: cancellationToken);
    }
}