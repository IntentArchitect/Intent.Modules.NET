...
namespace CleanArchitecture.SingleFiles.Application.DaprInvoices.UpdateDaprInvoiceDaprLine
{
    public class UpdateDaprInvoiceDaprLineCommand : IRequest, ICommand
    {
        ...
        public string DaprInvoiceId { get; private set; }
        public string Id { get; private set; }
        public string Name { get; set; }

        public void SetDaprInvoiceId(string daprInvoiceId)
        {
            DaprInvoiceId = daprInvoiceId;
        }
