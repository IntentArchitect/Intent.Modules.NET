...
using WolverineEventing.Subscribe.RabbitMQ.Api.Filters;
using WolverineEventing.Subscribe.RabbitMQ.Application;
using WolverineEventing.Subscribe.RabbitMQ.Domain.Common.Exceptions;

[assembly: DefaultIntentManaged(Mode.Fully)]
[assembly: IntentTemplate("Intent.AspNetCore.Swashbuckle.SwashbuckleConfiguration", Version = "1.0")]

namespace WolverineEventing.Subscribe.RabbitMQ.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("WolverineEventing.Subscribe.RabbitMQ API");
