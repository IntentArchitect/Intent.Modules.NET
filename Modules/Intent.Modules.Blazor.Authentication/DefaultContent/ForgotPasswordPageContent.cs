    ...
    internal static class ForgotPasswordPageContent
    {
        ...
        private static string BuildMudBlazorContent(string authService)
        {
            return $$"""
                ...
                <MudPaper Class="pa-4 mb-4 ux-gradient-primary" Elevation="0">
                    ...
                    <MudText Typo="Typo.body1" Class="text-white opacity-90">Enter your email address and we will help you reset your password.</MudText>
                </MudPaper>
                                ...
                                <EditForm Model="Input" FormName="forgot-password" OnValidSubmit="OnValidSubmitAsync" method="post">
                                    ...
                                    <MudGrid>
                                        <MudItem xs="12">
                                            ...
                                            <MudText Typo="Typo.body2" Class="mb-2">Enter the email address associated with your account.</MudText>
                                            <ValidationSummary class="text-danger" role="alert" />
                                        </MudItem>
                                        <MudItem xs="12">
                                            <div class="forgot-password-input-field">
                                                <label class="forgot-password-input-label" for="email">Email</label>
                                                <div class="forgot-password-input-shell">
                                                    <MudIcon Icon="@Icons.Material.Filled.Email" Class="forgot-password-input-icon" />
                                                    <InputText id="email" class="forgot-password-input-control" @bind-Value="Input.Email" autocomplete="username" aria-required="true" placeholder="name@example.com" type="email" />
                                                </div>
                                        ...
                                        <MudItem xs="12">
                                            <MudStack Row="true" Spacing="2" Justify="Justify.FlexEnd" AlignItems="AlignItems.Center">
                                                <MudButton ButtonType="ButtonType.Submit" Color="Color.Primary" Variant="Variant.Filled" FullWidth="true" StartIcon="@Icons.Material.Filled.MarkEmailRead">Reset password</MudButton>
                                            </MudStack>
                                        </MudItem>
                                        <MudItem xs="12">
                                            <MudStack Spacing="1">
        ...
        private static string BuildBootstrapContent(string authService)
        {
            return $$"""
                ...
                <AccountHero Icon="lock" Title="Forgot your password?" Subtitle="Enter your email and we'll send you a reset link." />
