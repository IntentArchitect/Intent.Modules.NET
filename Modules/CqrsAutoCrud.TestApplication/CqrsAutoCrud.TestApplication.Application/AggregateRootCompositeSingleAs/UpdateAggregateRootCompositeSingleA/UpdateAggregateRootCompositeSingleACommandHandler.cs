...
namespace CqrsAutoCrud.TestApplication.Application.AggregateRootCompositeSingleAs.UpdateAggregateRootCompositeSingleA
{
    ...
    public class UpdateAggregateRootCompositeSingleACommandHandler : IRequestHandler<UpdateAggregateRootCompositeSingleACommand>
    {
        private readonly IAggregateRootRepository _aggregateRootRepository;

        [IntentManaged(Mode.Ignore)]
        public UpdateAggregateRootCompositeSingleACommandHandler(IAggregateRootRepository aggregateRootRepository)
        {
            _aggregateRootRepository = aggregateRootRepository;
        }

        [IntentManaged(Mode.Fully, Body = Mode.Fully)]
        public async Task<Unit> Handle(UpdateAggregateRootCompositeSingleACommand request, CancellationToken cancellationToken)
        {
        ...
        private static void UpdateCompositeCompositeSingleA(CompositeSingleA entity, UpdateAggregateRootCompositeSingleACommand dto)
        {
