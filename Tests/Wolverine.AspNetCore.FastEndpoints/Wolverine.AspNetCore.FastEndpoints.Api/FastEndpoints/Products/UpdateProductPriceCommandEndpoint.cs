...
{
    public class UpdateProductPriceCommandEndpoint : Endpoint<UpdateProductPriceCommand>
    {
        private readonly IMessageBus _sender;

        public UpdateProductPriceCommandEndpoint(IMessageBus sender)
        {
        ...
        public override void Configure()
        {
            ...
            {
                b.WithTags("Products");
                b.Accepts<UpdateProductPriceCommand>(MediaTypeNames.Application.Json);
