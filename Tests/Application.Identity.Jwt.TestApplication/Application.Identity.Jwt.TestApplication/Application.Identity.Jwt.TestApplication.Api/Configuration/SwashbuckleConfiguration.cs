...
using Application.Identity.Jwt.TestApplication.Domain.Common.Exceptions;
...
namespace Application.Identity.Jwt.TestApplication.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.SwaggerEndpoint("/swagger/v1/swagger.json", "Application.Identity.Jwt.TestApplication API V1");
                    options.OAuthAppName("Application.Identity.Jwt.TestApplication API");
