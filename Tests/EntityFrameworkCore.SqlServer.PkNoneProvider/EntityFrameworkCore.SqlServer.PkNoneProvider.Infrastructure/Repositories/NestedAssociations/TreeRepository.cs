...
using EntityFrameworkCore.SqlServer.PkNoneProvider.Domain.Repositories.NestedAssociations;
...
namespace EntityFrameworkCore.SqlServer.PkNoneProvider.Infrastructure.Repositories.NestedAssociations
{
    ...
    public class TreeRepository : RepositoryBase<Tree, Tree, ApplicationDbContext>, ITreeRepository
    {
        ...
        public async Task<Tree?> FindByIdAsync(
            Guid id,
            Func<IQueryable<Tree>, IQueryable<Tree>> queryOptions,
