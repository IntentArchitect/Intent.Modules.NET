...
namespace Entities.PrivateSetters.EF.CosmosDb.Api.Configuration
{
            ...
            services.AddSwaggerGen(
                options =>
                {
                    options.SwaggerDoc(
                        ...
                        {
                            Version = "v1",
                            Title = "Entities.PrivateSetters.EF.CosmosDb API"
                        });
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.SwaggerEndpoint("/swagger/v1/swagger.json", "Entities.PrivateSetters.EF.CosmosDb API V1");
                    options.OAuthAppName("Entities.PrivateSetters.EF.CosmosDb API");
