...
{
    public class D_MultipleDependentRepository : MongoRepositoryBase<D_MultipleDependent, D_MultipleDependent>, ID_MultipleDependentRepository
    {
        public D_MultipleDependentRepository(ApplicationMongoDbContext context) : base(context)
        {
        }
