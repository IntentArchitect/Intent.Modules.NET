...
using N_ServiceBus.LearnerTransport.Application.ExternalMessagePublish.PublishExternalMessage;

[assembly: DefaultIntentManaged(Mode.Fully)]
[assembly: DefaultIntentManaged(Mode.Fully, Targets = Targets.Usings)]
[assembly: IntentTemplate("Intent.AspNetCore.Controllers.Controller", Version = "1.0")]

namespace N_ServiceBus.LearnerTransport.Api.Controllers
{
    [ApiController]
    public class ExternalMessagePublishController : ControllerBase
    {
        ...
        public async Task<ActionResult> PublishExternalMessage(
            [FromBody] PublishExternalMessageCommand command,
