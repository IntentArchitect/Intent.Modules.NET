using System.Linq;
using Intent.Engine;
using Intent.EntityFrameworkCore.BasicAudit.Api;
...
using Intent.Modules.EntityFrameworkCore.BasicAudit.Templates;
...
namespace Intent.Modules.EntityFrameworkCore.BasicAudit.FactoryExtensions
{
    [IntentManaged(Mode.Fully, Body = Mode.Merge)]
    public class EfCoreExtension : FactoryExtensionBase
    {
        public override string Id => "Intent.EntityFrameworkCore.BasicAudit.EfCoreExtension";
