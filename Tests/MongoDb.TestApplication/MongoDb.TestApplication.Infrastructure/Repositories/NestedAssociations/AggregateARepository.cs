...
{
    public class AggregateARepository : MongoRepositoryBase<AggregateA, AggregateA>, IAggregateARepository
    {
        public AggregateARepository(ApplicationMongoDbContext context) : base(context)
        {
        }
