...
public static class CreateCustomValidationsExtensions
{
        ...
        string toValidateTemplateId)
    {
        ...
        var toValidateTypeName = template.GetTypeName(toValidateTemplateId, (IMetadataModel)((ITemplateWithModel)template).Model);
...
public static class ValidateDomainConstraintsExtensions
{
    ...
    private static bool TryGetMappedAttribute(DTOFieldModel field, out IElement attribute)
    {
    ...
    private static bool TryGetAdvancedMappedAttribute(DTOModel model, DTOFieldModel field, out IElement attribute)
    {
