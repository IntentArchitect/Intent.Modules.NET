...
using Intent.MongoDb.MongoFramework.Api;
using Intent.RoslynWeaver.Attributes;
using Intent.Templates;
using ClassExtensionModel = Intent.MongoDb.MongoFramework.Api.ClassExtensionModel;

[assembly: DefaultIntentManaged(Mode.Fully)]
[assembly: IntentTemplate("Intent.ModuleBuilder.CSharp.Templates.CSharpTemplatePartial", Version = "1.0")]

namespace Intent.Modules.MongoDb.MongoFramework.Templates.ApplicationMongoDbContext
{
    ...
    {
        public const string TemplateId = "Intent.MongoDb.MongoFramework.ApplicationMongoDbContext";
