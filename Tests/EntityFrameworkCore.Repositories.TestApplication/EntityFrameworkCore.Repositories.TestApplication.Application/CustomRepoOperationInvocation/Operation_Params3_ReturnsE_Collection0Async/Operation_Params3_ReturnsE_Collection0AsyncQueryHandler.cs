...
namespace EntityFrameworkCore.Repositories.TestApplication.Application.CustomRepoOperationInvocation.Operation_Params3_ReturnsE_Collection0Async
{
    ...
    public class Operation_Params3_ReturnsE_Collection0AsyncQueryHandler : IRequestHandler<Operation_Params3_ReturnsE_Collection0AsyncQuery, AggregateRoot1Dto>
    {
        ...
        public Operation_Params3_ReturnsE_Collection0AsyncQueryHandler(ICustomRepository customRepository, IMapper mapper)
        {
        ...
        {
            var result = await _customRepository.Operation_Params3_ReturnsE_Collection0Async(
                new SpParameter(
