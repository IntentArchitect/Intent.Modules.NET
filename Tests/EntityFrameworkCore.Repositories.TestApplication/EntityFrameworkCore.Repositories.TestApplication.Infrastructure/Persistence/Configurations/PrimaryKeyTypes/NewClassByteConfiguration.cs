...
{
    public class NewClassByteConfiguration : IEntityTypeConfiguration<NewClassByte>
    {
        public void Configure(EntityTypeBuilder<NewClassByte> builder)
        {
