...
using CosmosDB.PrivateSetters.Application.DerivedOfTS;
using CosmosDB.PrivateSetters.Application.DerivedOfTS.CreateDerivedOfT;
using CosmosDB.PrivateSetters.Application.DerivedOfTS.DeleteDerivedOfT;
using CosmosDB.PrivateSetters.Application.DerivedOfTS.GetDerivedOfTById;
using CosmosDB.PrivateSetters.Application.DerivedOfTS.GetDerivedOfTS;
using CosmosDB.PrivateSetters.Application.DerivedOfTS.UpdateDerivedOfT;
