                ...
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 9, >= 0) => new PackageVersion("3.15.1")
                            ...
                            .WithNugetDependency("Quartz.Extensions.Hosting", "3.15.1"),
                        ( >= 8, >= 0) => new PackageVersion("3.15.1")
                ...
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 9, >= 0) => new PackageVersion("3.15.1")
                            ...
                            .WithNugetDependency("Quartz.Extensions.DependencyInjection", "3.15.1"),
                        ( >= 8, >= 0) => new PackageVersion("3.15.1")
