...
namespace CleanArchitecture.Comprehensive.Infrastructure.Repositories.Pagination
{
    ...
    public class PersonEntryRepository : RepositoryBase<PersonEntry, PersonEntry, ApplicationDbContext>, IPersonEntryRepository
    {
        ...
        public async Task<PersonEntry?> FindByIdAsync(
            Guid id,
            Func<IQueryable<PersonEntry>, IQueryable<PersonEntry>> queryOptions,
            CancellationToken cancellationToken = default)
        {
