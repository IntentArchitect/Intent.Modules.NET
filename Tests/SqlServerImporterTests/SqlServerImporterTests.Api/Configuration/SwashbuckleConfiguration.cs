...
using SqlServerImporterTests.Api.Filters;
using SqlServerImporterTests.Application;
...
namespace SqlServerImporterTests.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("SqlServerImporterTests API");
