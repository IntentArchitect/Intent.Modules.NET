...
{
    public class CreateOrgIntegrationCommandConsumer
    {
        ...
        [Function("CreateOrgIntegrationCommandConsumer")]
        public async Task Run(
            [ServiceBusTrigger("%AzureServiceBus:CreateOrg%", Connection = "AzureServiceBus:ConnectionString")] ServiceBusReceivedMessage message,
            CancellationToken cancellationToken)
        {
            ...
            {
                _logger.LogError(ex, "Error processing CreateOrgIntegrationCommandConsumer");
                throw;
            }
        }
    }
