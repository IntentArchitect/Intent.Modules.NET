...
using Wolverine;
using WolverineEventing.Transport.RabbitMQ.Publish.Api.Configuration;
using WolverineEventing.Transport.RabbitMQ.Publish.Api.Filters;
using WolverineEventing.Transport.RabbitMQ.Publish.Api.Logging;
using WolverineEventing.Transport.RabbitMQ.Publish.Application;
using WolverineEventing.Transport.RabbitMQ.Publish.Infrastructure;
using WolverineEventing.Transport.RabbitMQ.Publish.Infrastructure.Configuration;
using WolverineEventing.Transport.RabbitMQ.Publish.Infrastructure.Eventing;

[assembly: DefaultIntentManaged(Mode.Fully)]
[assembly: IntentTemplate("Intent.AspNetCore.Program", Version = "1.0")]

namespace WolverineEventing.Transport.RabbitMQ.Publish.Api
{
