...
using MudBlazor.Sample.Application.Customers;
using MudBlazor.Sample.Application.Customers.CreateCustomer;
using MudBlazor.Sample.Application.Customers.DeleteCustomer;
using MudBlazor.Sample.Application.Customers.GetCustomerById;
using MudBlazor.Sample.Application.Customers.GetCustomers;
using MudBlazor.Sample.Application.Customers.GetCustomersLookup;
using MudBlazor.Sample.Application.Customers.UpdateCustomer;
