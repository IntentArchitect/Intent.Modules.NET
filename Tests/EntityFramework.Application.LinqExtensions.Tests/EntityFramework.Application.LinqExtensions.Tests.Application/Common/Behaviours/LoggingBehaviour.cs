...
namespace EntityFramework.Application.LinqExtensions.Tests.Application.Common.Behaviours
{
        ...
        where TRequest : notnull
    {
        ...
        public Task Process(TRequest request, CancellationToken cancellationToken)
        {
            ...
            {
                _logger.LogInformation("EntityFramework.Application.LinqExtensions.Tests Request: {Name} {@UserId} {@UserName} {@Request}", requestName, userId, userName, request);
            }
            else
            {
                _logger.LogInformation("EntityFramework.Application.LinqExtensions.Tests Request: {Name} {@UserId} {@UserName}", requestName, userId, userName);
            }
