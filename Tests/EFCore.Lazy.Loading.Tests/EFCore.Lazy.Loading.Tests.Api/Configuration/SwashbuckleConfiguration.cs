...
using EFCore.Lazy.Loading.Tests.Api.Filters;
using EFCore.Lazy.Loading.Tests.Application;
using EFCore.Lazy.Loading.Tests.Domain.Common.Exceptions;
...
namespace EFCore.Lazy.Loading.Tests.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("EFCore.Lazy.Loading.Tests API");
