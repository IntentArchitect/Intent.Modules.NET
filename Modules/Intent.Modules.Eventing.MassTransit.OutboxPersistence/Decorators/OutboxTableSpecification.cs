...
using Intent.Modules.Eventing.MassTransit.OutboxPersistence.Settings;
...
namespace Intent.Modules.Eventing.MassTransit.OutboxPersistence.Decorators
{
    [IntentManaged(Mode.Merge)]
    public class OutboxTableSpecification : DbContextDecoratorBase
    {
        [IntentManaged(Mode.Fully)] public const string DecoratorId = "Intent.Eventing.MassTransit.OutboxPersistence.OutboxTableSpecification";
