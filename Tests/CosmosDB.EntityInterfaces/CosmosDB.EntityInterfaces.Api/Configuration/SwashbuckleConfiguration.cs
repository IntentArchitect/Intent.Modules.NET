...
using CosmosDB.EntityInterfaces.Api.Filters;
using CosmosDB.EntityInterfaces.Application;
...
namespace CosmosDB.EntityInterfaces.Api.Configuration
{
            ...
            services.AddSwaggerGen(
                options =>
                {
                    options.SwaggerDoc(
                        ...
                        {
                            Version = "v1",
                            Title = "CosmosDB.EntityInterfaces API"
                        });
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.SwaggerEndpoint("/swagger/v1/swagger.json", "CosmosDB.EntityInterfaces API V1");
                    options.OAuthAppName("CosmosDB.EntityInterfaces API");
