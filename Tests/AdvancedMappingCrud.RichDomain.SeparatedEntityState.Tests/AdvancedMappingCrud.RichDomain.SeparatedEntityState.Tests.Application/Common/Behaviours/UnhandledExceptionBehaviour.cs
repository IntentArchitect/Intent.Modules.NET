        ...
        where TRequest : notnull
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    _logger.LogError(ex, "AdvancedMappingCrud.RichDomain.SeparatedEntityState.Tests Request: Unhandled Exception for Request {Name} {@Request}", requestName, request);
                }
                else
                {
                    _logger.LogError(ex, "AdvancedMappingCrud.RichDomain.SeparatedEntityState.Tests Request: Unhandled Exception for Request {Name}", requestName);
                }
                throw;
            }
        }
