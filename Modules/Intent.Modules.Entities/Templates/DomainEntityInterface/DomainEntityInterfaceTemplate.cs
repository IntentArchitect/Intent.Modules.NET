...
namespace Intent.Modules.Entities.Templates.DomainEntityInterface
{
    ...
    public partial class DomainEntityInterfaceTemplate : CSharpTemplateBase<Intent.Modelers.Domain.Api.ClassModel>
    {
#line hidden
        /// <summary>
        ...
        public override string TransformText()
        {
            ...
            #line 18 "C:\Dev\Intent.Modules.NET\Modules\Intent.Modules.Entities\Templates\DomainEntityInterface\DomainEntityInterfaceTemplate.tt"
  ...
  foreach (var attribute in Model.Attributes)
    {
        ...
        if (!CanWriteDefaultAttribute(attribute)) 
        {
            ...
            #line 30 "C:\Dev\Intent.Modules.NET\Modules\Intent.Modules.Entities\Templates\DomainEntityInterface\DomainEntityInterfaceTemplate.tt"
            ...
            #line 31 "C:\Dev\Intent.Modules.NET\Modules\Intent.Modules.Entities\Templates\DomainEntityInterface\DomainEntityInterfaceTemplate.tt"
    ...
    foreach (var associatedClass in Model.AssociatedClasses)
    {
        ...
        if (!CanWriteDefaultAssociation(associatedClass) || !associatedClass.IsNavigable) 
        {
            ...
            #line 41 "C:\Dev\Intent.Modules.NET\Modules\Intent.Modules.Entities\Templates\DomainEntityInterface\DomainEntityInterfaceTemplate.tt"
            ...
            #line 42 "C:\Dev\Intent.Modules.NET\Modules\Intent.Modules.Entities\Templates\DomainEntityInterface\DomainEntityInterfaceTemplate.tt"
  ...
  foreach (var operation in Model.Operations)
    {
        ...
        string parameterDefinitions = operation.Parameters.Any() ? operation.Parameters.Select(x => Types.Get(x.TypeReference) + " " + x.Name.ToCamelCase()).Aggregate((x, y) => x + ", " + y) : "";
            ...
            #line 52 "C:\Dev\Intent.Modules.NET\Modules\Intent.Modules.Entities\Templates\DomainEntityInterface\DomainEntityInterfaceTemplate.tt"
