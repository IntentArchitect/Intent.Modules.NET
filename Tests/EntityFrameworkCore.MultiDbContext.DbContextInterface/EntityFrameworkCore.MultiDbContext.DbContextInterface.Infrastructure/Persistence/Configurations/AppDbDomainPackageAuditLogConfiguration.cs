...
{
    public class AppDbDomainPackageAuditLogConfiguration : IEntityTypeConfiguration<AppDbDomainPackageAuditLog>
    {
        public void Configure(EntityTypeBuilder<AppDbDomainPackageAuditLog> builder)
        {
