...
namespace Intent.Eventing.Wolverine.Api
{
    ...
    {
        public static WolverineMessage GetWolverineMessage(this IntegrationCommandModel model)
        {
        ...
        public static bool HasWolverineMessage(this IntegrationCommandModel model)
        {
            return model.HasStereotype(WolverineMessage.DefinitionId);
        }

        public static bool TryGetWolverineMessage(this IntegrationCommandModel model, out WolverineMessage stereotype)
        {
