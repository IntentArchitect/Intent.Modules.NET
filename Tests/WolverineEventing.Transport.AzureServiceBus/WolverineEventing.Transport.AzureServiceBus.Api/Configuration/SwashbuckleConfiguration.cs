...
using WolverineEventing.Transport.AzureServiceBus.Api.Filters;
using WolverineEventing.Transport.AzureServiceBus.Application;
using WolverineEventing.Transport.AzureServiceBus.Domain.Common.Exceptions;

[assembly: DefaultIntentManaged(Mode.Fully)]
[assembly: IntentTemplate("Intent.AspNetCore.Swashbuckle.SwashbuckleConfiguration", Version = "1.0")]

namespace WolverineEventing.Transport.AzureServiceBus.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("WolverineEventing.Transport.AzureServiceBus API");
