...
using CosmosDBMultiTenancy.Api.Controllers.ResponseTypes;
using CosmosDBMultiTenancy.Application.Invoices;
using CosmosDBMultiTenancy.Application.Invoices.CreateInvoice;
using CosmosDBMultiTenancy.Application.Invoices.DeleteInvoice;
using CosmosDBMultiTenancy.Application.Invoices.GetInvoiceById;
using CosmosDBMultiTenancy.Application.Invoices.GetInvoices;
using CosmosDBMultiTenancy.Application.Invoices.UpdateInvoice;
...
namespace CosmosDBMultiTenancy.Api.Controllers
{
    [ApiController]
