...
namespace AdvancedMappingCrud.Cosmos.Tests.IntegrationTests.Tests
{
    ...
    public class FindCustomerByNameOrSurnameTests : BaseIntegrationTest
    {
        public FindCustomerByNameOrSurnameTests(IntegrationTestWebAppFactory factory) : base(factory)
        {
        }
        ...
        public async Task FindCustomerByNameOrSurname_ShouldFindCustomerByNameOrSurname()
        {
            //Arrange
            ...
            //Act
            var foundCustomer = await client.FindCustomerByNameOrSurnameAsync(customer.Name, null);
