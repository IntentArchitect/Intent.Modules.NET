...
namespace Intent.AzureFunctions.OpenApi.Api
{
    ...
    {
        public static OpenAPIOperation GetOpenAPIOperation(this QueryModel model)
        {
        ...
        public static bool HasOpenAPIOperation(this QueryModel model)
        {
            return model.HasStereotype(OpenAPIOperation.DefinitionId);
        }

        public static bool TryGetOpenAPIOperation(this QueryModel model, out OpenAPIOperation stereotype)
        {
