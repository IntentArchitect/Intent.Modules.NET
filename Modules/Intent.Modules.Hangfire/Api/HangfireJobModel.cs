...
namespace Intent.Hangfire.Api
{
    ...
    public class HangfireJobModel : IMetadataModel, IHasStereotypes, IHasName, IElementWrapper, IHasFolder
    {
        ...
        public HangfireJobModel(IElement element, string requiredType = SpecializationTypeId)
        {
