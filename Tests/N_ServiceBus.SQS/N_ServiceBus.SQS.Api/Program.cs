...
using N_ServiceBus.SQS.Api.Configuration;
using N_ServiceBus.SQS.Api.Filters;
using N_ServiceBus.SQS.Api.Logging;
using N_ServiceBus.SQS.Application;
using N_ServiceBus.SQS.Infrastructure;
using Serilog;
...
namespace N_ServiceBus.SQS.Api
{
