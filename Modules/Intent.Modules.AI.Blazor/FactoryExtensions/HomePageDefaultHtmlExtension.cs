...
namespace Intent.Modules.AI.Blazor.FactoryExtensions
{
    ...
    {
        public override string Id => "Intent.AI.Blazor.HomePageBentoBoxExtension";
        ...
        protected override void OnAfterTemplateExecution(IApplication application)
        {
            ...
            if (homeTemplate is null) return;
            ...
            {
                var bento = GetBentoBoxContent();
                change.ChangeContent(bento, bento);
            }
            else
            {
        ...
        private static string GetBentoBoxContent() =>
            """
            @page "/"
