...
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Patch.CustomResponse200;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Patch.CustomResponse200WithResponse;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Patch.CustomResponse201;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Patch.CustomResponse201WithResponse;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Patch.CustomResponse202;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Patch.CustomResponse202WithResponse;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Patch.CustomResponse203;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Patch.CustomResponse203WithResponse;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Patch.CustomResponse204;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Patch.CustomResponse204WithResponse;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Patch.CustomResponse205;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Patch.CustomResponse205WithResponse;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Patch.CustomResponse206;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Patch.CustomResponse206WithResponse;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Patch.CustomResponse207;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Patch.CustomResponse207WithResponse;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Patch.CustomResponse208;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Patch.CustomResponse208WithResponse;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Patch.CustomResponse226;
...
{
    [ApiController]
    public class CustomResponseCodesPatchController : ControllerBase
    {
        private readonly ISender _mediator;

        public CustomResponseCodesPatchController(ISender mediator)
        {
        ...
        [HttpPatch("api/custom-response-codes/custom-response200")]
        ...
        /// </summary>
        /// <response code="200">Successfully updated.</response>
        [HttpPatch("api/custom-response-codes/custom-response200-response")]
        ...
        [HttpPatch("api/custom-response-codes/custom-response201")]
        ...
        /// </summary>
        /// <response code="201">Successfully updated.</response>
        [HttpPatch("api/custom-response-codes/custom-response201-response")]
        ...
        [HttpPatch("api/custom-response-codes/custom-response202")]
        ...
        /// </summary>
        /// <response code="202">Successfully updated.</response>
        [HttpPatch("api/custom-response-codes/custom-response202-response")]
        ...
        [HttpPatch("api/custom-response-codes/custom-response203")]
        ...
        /// </summary>
        /// <response code="203">Successfully updated.</response>
        [HttpPatch("api/custom-response-codes/custom-response203-response")]
        ...
        [HttpPatch("api/custom-response-codes/custom-response204")]
        ...
        /// </summary>
        /// <response code="204">Successfully updated.</response>
        [HttpPatch("api/custom-response-codes/custom-response204-response")]
        ...
        [HttpPatch("api/custom-response-codes/custom-response205")]
        ...
        /// </summary>
        /// <response code="205">Successfully updated.</response>
        [HttpPatch("api/custom-response-codes/custom-response205-response")]
        ...
        [HttpPatch("api/custom-response-codes/custom-response206")]
        ...
        /// </summary>
        /// <response code="206">Successfully updated.</response>
        [HttpPatch("api/custom-response-codes/custom-response206-response")]
        ...
        [HttpPatch("api/custom-response-codes/custom-response207")]
        ...
        /// </summary>
        /// <response code="207">Successfully updated.</response>
        [HttpPatch("api/custom-response-codes/custom-response207-response")]
        ...
        [HttpPatch("api/custom-response-codes/custom-response208")]
        ...
        /// </summary>
        /// <response code="208">Successfully updated.</response>
        [HttpPatch("api/custom-response-codes/custom-response208-response")]
        ...
        [HttpPatch("api/custom-response-codes/custom-response226")]
        ...
        /// </summary>
        /// <response code="226">Successfully updated.</response>
        [HttpPatch("api/custom-response-codes/custom-response226-response")]
        ...
        /// </summary>
        /// <response code="204">Successfully updated.</response>
        [HttpPatch("api/custom-response-codes/custom-response-default")]
        [ProducesResponseType(StatusCodes.Status204NoContent)]
        [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status500InternalServerError)]
        ...
        /// </summary>
        /// <response code="200">Successfully updated.</response>
        [HttpPatch("api/custom-response-codes/custom-response-default-response")]
        [ProducesResponseType(typeof(string), StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status500InternalServerError)]
