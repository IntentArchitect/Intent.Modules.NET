...
namespace Intent.Modules.Blazor.Templates.Templates.Client.Page
{
    ...
    public partial class PageTemplate : ComponentRazorTemplateBase
    {
        /// <inheritdoc cref="IntentTemplateBase.Id"/>
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Intent.Blazor.Templates.Client.PageTemplate";

        /// <summary>
        /// Creates a new instance of <see cref="PageTemplate"/>.
        /// </summary>
        [IntentManaged(Mode.Fully, Body = Mode.Ignore)]
        public PageTemplate(IOutputTarget outputTarget, ComponentModel model) : base(TemplateId, outputTarget, model)
        {
        }
        ...
        protected override string CodeBehindTemplateId => PageCodeBehindTemplate.TemplateId;
    }
}
