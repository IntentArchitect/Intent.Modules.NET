using Blazor.ProductService.Api.Configuration;
using Blazor.ProductService.Api.Filters;
using Blazor.ProductService.Api.Logging;
using Blazor.ProductService.Application;
using Blazor.ProductService.Infrastructure;
...
namespace Blazor.ProductService.Api
{
