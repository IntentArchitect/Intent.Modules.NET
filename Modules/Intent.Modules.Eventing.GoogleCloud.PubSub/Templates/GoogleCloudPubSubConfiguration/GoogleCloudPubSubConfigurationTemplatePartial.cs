...
namespace Intent.Modules.Eventing.GoogleCloud.PubSub.Templates.GoogleCloudPubSubConfiguration
{
    ...
    {
        public const string TemplateId = "Intent.Eventing.GoogleCloud.PubSub.GoogleCloudPubSubConfiguration";
