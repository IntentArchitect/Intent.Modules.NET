...
namespace Intent.Modules.UnitTesting.Templates.UnitTestInstruction
{
    [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
    public class UnitTestInstructionTemplate : MarkdownBaseTemplate<object>, IMarkdownFileBuilderTemplate
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Intent.UnitTesting.UnitTestInstructionTemplate";

        [IntentManaged(Mode.Fully, Body = Mode.Ignore)]
        public UnitTestInstructionTemplate(IOutputTarget outputTarget, object model = null) : base(TemplateId, outputTarget, model)
        {
            WithContentHashing = true;
            MarkdownFile = new MarkdownFile($"unit-test-guidelines", relativeLocation: "")
                .FromMarkdown($$"""
---
