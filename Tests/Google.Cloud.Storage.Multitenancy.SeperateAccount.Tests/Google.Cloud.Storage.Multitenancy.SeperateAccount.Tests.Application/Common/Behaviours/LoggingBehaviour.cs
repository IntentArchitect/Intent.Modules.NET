...
namespace Google.Cloud.Storage.Multitenancy.SeperateAccount.Tests.Application.Common.Behaviours
{
        ...
        where TRequest : notnull
    {
        ...
        public Task Process(TRequest request, CancellationToken cancellationToken)
        {
            ...
            {
                _logger.LogInformation("Google.Cloud.Storage.Multitenancy.SeperateAccount.Tests Request: {Name} {@UserId} {@UserName} {@Request}", requestName, userId, userName, request);
            }
            else
            {
                _logger.LogInformation("Google.Cloud.Storage.Multitenancy.SeperateAccount.Tests Request: {Name} {@UserId} {@UserName}", requestName, userId, userName);
            }
