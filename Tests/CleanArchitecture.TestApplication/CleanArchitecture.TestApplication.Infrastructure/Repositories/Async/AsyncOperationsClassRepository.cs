...
namespace CleanArchitecture.TestApplication.Infrastructure.Repositories.Async
{
    ...
    {
        public AsyncOperationsClassRepository(ApplicationDbContext dbContext) : base(dbContext)
        {
        }
