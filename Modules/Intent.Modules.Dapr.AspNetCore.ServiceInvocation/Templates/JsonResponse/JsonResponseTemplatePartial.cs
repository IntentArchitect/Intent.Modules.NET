...
namespace Intent.Modules.Dapr.AspNetCore.ServiceInvocation.Templates.JsonResponse
{
    [IntentManaged(Mode.Ignore)]
    public class JsonResponseTemplate : JsonResponseTemplateBase
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Intent.Dapr.AspNetCore.ServiceInvocation.JsonResponse";
