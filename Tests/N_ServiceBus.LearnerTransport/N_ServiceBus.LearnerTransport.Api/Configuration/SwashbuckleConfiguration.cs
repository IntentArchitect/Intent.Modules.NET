...
using N_ServiceBus.LearnerTransport.Domain.Common.Exceptions;
...
namespace N_ServiceBus.LearnerTransport.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("N_ServiceBus.LearnerTransport API");
