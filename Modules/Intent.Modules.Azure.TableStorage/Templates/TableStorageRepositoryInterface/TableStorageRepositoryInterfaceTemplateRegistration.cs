...
namespace Intent.Modules.Azure.TableStorage.Templates.TableStorageRepositoryInterface
{
    ...
    public class TableStorageRepositoryInterfaceTemplateRegistration : SingleFileListModelTemplateRegistration<ClassModel>
    {
        private readonly IMetadataManager _metadataManager;

        public TableStorageRepositoryInterfaceTemplateRegistration(IMetadataManager metadataManager)
        {
            _metadataManager = metadataManager;
        }

        public override string TemplateId => TableStorageRepositoryInterfaceTemplate.TemplateId;

        [IntentManaged(Mode.Fully)]
        public override ITemplate CreateTemplateInstance(IOutputTarget outputTarget, IList<ClassModel> model)
        {
            return new TableStorageRepositoryInterfaceTemplate(outputTarget, model);
        }
