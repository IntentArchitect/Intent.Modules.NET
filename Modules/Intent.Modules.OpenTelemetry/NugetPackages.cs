        ...
        public void RegisterPackages()
        {
            NugetRegistry.Register(AzureMonitorOpenTelemetryAspNetCorePackageName,
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 10, >= 0) => new PackageVersion("1.5.0")
                            .WithNugetDependency("Azure.Core", "1.54.0")
                            .WithNugetDependency("Azure.Monitor.OpenTelemetry.Exporter", "1.8.0")
                            .WithNugetDependency("OpenTelemetry.Extensions.Hosting", "1.15.3")
                            .WithNugetDependency("OpenTelemetry.Instrumentation.AspNetCore", "1.15.2")
            ...
            NugetRegistry.Register(AzureMonitorOpenTelemetryExporterPackageName,
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 10, >= 0) => new PackageVersion("1.8.2")
                            .WithNugetDependency("Azure.Core", "1.59.0")
                            .WithNugetDependency("OpenTelemetry.Extensions.Hosting", "1.15.3")
                            .WithNugetDependency("OpenTelemetry.PersistentStorage.FileSystem", "1.0.3"),
                        ( >= 8, >= 0) => new PackageVersion("1.8.2")
                            .WithNugetDependency("Azure.Core", "1.59.0")
                            .WithNugetDependency("OpenTelemetry.Extensions.Hosting", "1.15.3")
                            .WithNugetDependency("OpenTelemetry.PersistentStorage.FileSystem", "1.0.3"),
                        ( >= 2, >= 0) => new PackageVersion("1.8.2")
                            .WithNugetDependency("Azure.Core", "1.59.0")
                            .WithNugetDependency("OpenTelemetry.Extensions.Hosting", "1.15.3")
                            .WithNugetDependency("OpenTelemetry.PersistentStorage.FileSystem", "1.0.3"),
            ...
            NugetRegistry.Register(OpenTelemetryPackageName,
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 10, >= 0) => new PackageVersion("1.16.0")
                            .WithNugetDependency("OpenTelemetry.Api.ProviderBuilderExtensions", "1.16.0")
            ...
            NugetRegistry.Register(OpenTelemetryExporterConsolePackageName,
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 10, >= 0) => new PackageVersion("1.16.0")
                            .WithNugetDependency("OpenTelemetry", "1.16.0"),
                        ( >= 9, >= 0) => new PackageVersion("1.16.0")
                            .WithNugetDependency("OpenTelemetry", "1.16.0"),
                        ( >= 8, >= 0) => new PackageVersion("1.16.0")
                            .WithNugetDependency("OpenTelemetry", "1.16.0"),
            ...
            NugetRegistry.Register(OpenTelemetryInstrumentationProcessPackageName,
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 10, >= 0) => new PackageVersion("1.16.0-beta.1")
                            .WithNugetDependency("OpenTelemetry.Api", "1.16.0"),
                        ( >= 8, >= 0) => new PackageVersion("1.16.0-beta.1")
                            .WithNugetDependency("OpenTelemetry.Api", "1.16.0"),
                        ( >= 2, >= 0) => new PackageVersion("1.16.0-beta.1")
                            .WithNugetDependency("OpenTelemetry.Api", "1.16.0"),
            ...
            NugetRegistry.Register(OpenTelemetryInstrumentationRuntimePackageName,
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 10, >= 0) => new PackageVersion("1.15.1")
                            .WithNugetDependency("OpenTelemetry.Api", "1.15.3"),
                        ( >= 8, >= 0) => new PackageVersion("1.15.1")
                            .WithNugetDependency("OpenTelemetry.Api", "1.15.3"),
                        ( >= 2, >= 0) => new PackageVersion("1.15.1")
                            .WithNugetDependency("OpenTelemetry.Api", "1.15.3"),
