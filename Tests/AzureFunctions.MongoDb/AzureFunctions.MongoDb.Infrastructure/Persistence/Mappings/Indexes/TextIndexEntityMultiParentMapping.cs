...
{
    public class TextIndexEntityMultiParentMapping : IMongoMappingConfiguration<TextIndexEntityMultiParent>
    {
        public string CollectionName => "TextIndexEntityMultiParents";

        public void RegisterCollectionMap()
        {
            if (!BsonClassMap.IsClassMapRegistered(typeof(TextIndexEntityMultiParent)))
            {
                BsonClassMap.RegisterClassMap<TextIndexEntityMultiParent>(
                    mapping =>
                    {
                        mapping.AutoMap();
