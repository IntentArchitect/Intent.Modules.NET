...
namespace CompositePublishTest.Infrastructure.Eventing.Solace
{
    public class MessageRegistry
    {
        ...
        public MessageRegistry(IConfiguration configuration, MessageBrokerRegistry messageBrokerRegistry)
        {
            ...
            RegisterMessageTypes(messageBrokerRegistry);
        }
        ...
        private void RegisterMessageTypes(MessageBrokerRegistry messageBrokerRegistry)
        {
            ...
            //messageBrokerRegistry.Register<PurchaseCreated, SolaceMessageBus>();
        }
