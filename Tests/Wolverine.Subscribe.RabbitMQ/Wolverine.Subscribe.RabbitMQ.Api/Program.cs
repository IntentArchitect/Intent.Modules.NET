...
using Wolverine;
using Wolverine.Subscribe.RabbitMQ.Api.Configuration;
using Wolverine.Subscribe.RabbitMQ.Api.Filters;
using Wolverine.Subscribe.RabbitMQ.Api.Logging;
using Wolverine.Subscribe.RabbitMQ.Application;
using Wolverine.Subscribe.RabbitMQ.Infrastructure;
using Wolverine.Subscribe.RabbitMQ.Infrastructure.Configuration;
using Wolverine.Subscribe.RabbitMQ.Infrastructure.Eventing;

[assembly: DefaultIntentManaged(Mode.Fully)]
[assembly: IntentTemplate("Intent.AspNetCore.Program", Version = "1.0")]

namespace Wolverine.Subscribe.RabbitMQ.Api
{
