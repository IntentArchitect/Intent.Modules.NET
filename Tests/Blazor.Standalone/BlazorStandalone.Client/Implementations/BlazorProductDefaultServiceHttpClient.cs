...
using BlazorStandalone.Client.Common;
...
namespace BlazorStandalone.Client.Implementations
{
    public class BlazorProductDefaultServiceHttpClient : IBlazorProductDefaultService
    {
        private const string JSON_MEDIA_TYPE = "application/json";
        private readonly HttpClient _httpClient;
        private readonly JsonSerializerOptions _serializerOptions;

        public BlazorProductDefaultServiceHttpClient(HttpClient httpClient)
        {
