...
namespace Intent.Modules.AspNetCore.Grpc.Api
{
    ...
    {
        public static ExposeWithGRPC GetExposeWithGRPC(this QueryModel model)
        {
        ...
        public static bool HasExposeWithGRPC(this QueryModel model)
        {
            return model.HasStereotype(ExposeWithGRPC.DefinitionId);
        }

        public static bool TryGetExposeWithGRPC(this QueryModel model, out ExposeWithGRPC stereotype)
        {
