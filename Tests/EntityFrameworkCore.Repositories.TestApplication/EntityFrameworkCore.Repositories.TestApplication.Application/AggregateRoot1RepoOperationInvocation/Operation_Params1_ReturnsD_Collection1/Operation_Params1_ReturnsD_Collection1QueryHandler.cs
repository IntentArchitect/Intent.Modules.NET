...
namespace EntityFrameworkCore.Repositories.TestApplication.Application.AggregateRoot1RepoOperationInvocation.Operation_Params1_ReturnsD_Collection1
{
    ...
    public class Operation_Params1_ReturnsD_Collection1QueryHandler : IRequestHandler<Operation_Params1_ReturnsD_Collection1Query, List<SpResultDto>>
    {
        ...
        public Operation_Params1_ReturnsD_Collection1QueryHandler(IAggregateRoot1Repository aggregateRoot1Repository,
            IMapper mapper)
        {
        ...
        {
            var result = _aggregateRoot1Repository.Operation_Params1_ReturnsD_Collection1(new SpParameter(
