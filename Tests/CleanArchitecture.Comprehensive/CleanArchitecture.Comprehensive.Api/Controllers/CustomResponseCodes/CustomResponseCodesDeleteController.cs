...
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Delete.CustomResponse200;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Delete.CustomResponse200WithResponse;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Delete.CustomResponse201;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Delete.CustomResponse201WithResponse;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Delete.CustomResponse202;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Delete.CustomResponse202WithResponse;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Delete.CustomResponse203;
...
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Delete.CustomResponse204WithResponse;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Delete.CustomResponse205;
...
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Delete.CustomResponse206WithResponse;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Delete.CustomResponse207;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Delete.CustomResponse207WithResponse;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Delete.CustomResponse208;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Delete.CustomResponse208WithResponse;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Delete.CustomResponse226;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Delete.CustomResponse226WithResponse;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Delete.CustomResponseDefault;
using CleanArchitecture.Comprehensive.Application.CustomResponseCodes.Delete.CustomResponseDefaultWithResponse;
...
{
    [ApiController]
    public class CustomResponseCodesDeleteController : ControllerBase
    {
        private readonly ISender _mediator;

        public CustomResponseCodesDeleteController(ISender mediator)
        {
        ...
        [HttpDelete("api/custom-response-codes/custom-response200")]
        ...
        /// </summary>
        /// <response code="200">Successfully deleted.</response>
        [HttpDelete("api/custom-response-codes/custom-response200-response")]
        ...
        [HttpDelete("api/custom-response-codes/custom-response201")]
        ...
        /// </summary>
        /// <response code="201">Successfully deleted.</response>
        [HttpDelete("api/custom-response-codes/custom-response201-response")]
        ...
        [HttpDelete("api/custom-response-codes/custom-response202")]
        ...
        /// </summary>
        /// <response code="202">Successfully deleted.</response>
        [HttpDelete("api/custom-response-codes/custom-response202-response")]
        ...
        /// <summary>
        /// </summary>
        /// <response code="203">Successfully deleted.</response>
        [HttpDelete("api/custom-response-codes/custom-response203")]
        ...
        /// </summary>
        /// <response code="203">Successfully deleted.</response>
        [HttpDelete("api/custom-response-codes/custom-response203-response")]
        ...
        [HttpDelete("api/custom-response-codes/custom-response204")]
        ...
        /// </summary>
        /// <response code="204">Successfully deleted.</response>
        [HttpDelete("api/custom-response-codes/custom-response204-response")]
        ...
        /// <summary>
        /// </summary>
        /// <response code="205">Successfully deleted.</response>
        [HttpDelete("api/custom-response-codes/custom-response205")]
        ...
        /// </summary>
        /// <response code="205">Successfully deleted.</response>
        [HttpDelete("api/custom-response-codes/custom-response205-response")]
        ...
        /// <summary>
        /// </summary>
        /// <response code="206">Successfully deleted.</response>
        [HttpDelete("api/custom-response-codes/custom-response206")]
        ...
        /// </summary>
        /// <response code="206">Successfully deleted.</response>
        [HttpDelete("api/custom-response-codes/custom-response206-response")]
        ...
        /// <summary>
        /// </summary>
        /// <response code="207">Successfully deleted.</response>
        [HttpDelete("api/custom-response-codes/custom-response207")]
        ...
        /// </summary>
        /// <response code="207">Successfully deleted.</response>
        [HttpDelete("api/custom-response-codes/custom-response207-response")]
        ...
        /// <summary>
        /// </summary>
        /// <response code="208">Successfully deleted.</response>
        [HttpDelete("api/custom-response-codes/custom-response208")]
        ...
        /// </summary>
        /// <response code="208">Successfully deleted.</response>
        [HttpDelete("api/custom-response-codes/custom-response208-response")]
        ...
        /// <summary>
        /// </summary>
        /// <response code="226">Successfully deleted.</response>
        [HttpDelete("api/custom-response-codes/custom-response226")]
        ...
        /// </summary>
        /// <response code="226">Successfully deleted.</response>
        [HttpDelete("api/custom-response-codes/custom-response226-response")]
        ...
        /// </summary>
        /// <response code="200">Successfully deleted.</response>
        [HttpDelete("api/custom-response-codes/custom-response-default")]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status500InternalServerError)]
        ...
        /// </summary>
        /// <response code="200">Successfully deleted.</response>
        [HttpDelete("api/custom-response-codes/custom-response-default-response")]
        [ProducesResponseType(typeof(string), StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status500InternalServerError)]
