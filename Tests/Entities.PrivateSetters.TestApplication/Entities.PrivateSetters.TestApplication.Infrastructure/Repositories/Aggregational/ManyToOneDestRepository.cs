...
namespace Entities.PrivateSetters.TestApplication.Infrastructure.Repositories.Aggregational
{
    ...
    {
        public ManyToOneDestRepository(ApplicationDbContext dbContext, IMapper mapper) : base(dbContext, mapper)
        {
        }
        ...
        public async Task<ManyToOneDest?> FindByIdAsync(
            Guid id,
            Func<IQueryable<ManyToOneDest>, IQueryable<ManyToOneDest>> queryOptions,
            CancellationToken cancellationToken = default)
        {
