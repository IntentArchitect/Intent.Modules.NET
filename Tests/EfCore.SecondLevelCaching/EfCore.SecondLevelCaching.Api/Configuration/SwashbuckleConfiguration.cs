...
using EfCore.SecondLevelCaching.Api.Filters;
using EfCore.SecondLevelCaching.Application;
...
namespace EfCore.SecondLevelCaching.Api.Configuration
{
            ...
            services.AddSwaggerGen(
                options =>
                {
                    options.SwaggerDoc(
                        ...
                        {
                            Version = "v1",
                            Title = "EfCore.SecondLevelCaching API"
                        });
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.SwaggerEndpoint("/swagger/v1/swagger.json", "EfCore.SecondLevelCaching API V1");
                    options.OAuthAppName("EfCore.SecondLevelCaching API");
