                ...
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 9, >= 0) => new PackageVersion("3.15.0")
                            ...
                            .WithNugetDependency("Quartz.Extensions.Hosting", "3.15.0"),
                        ( >= 8, >= 0) => new PackageVersion("3.15.0")
                ...
                (framework) => (framework.Major, framework.Minor) switch
                    {
                        ( >= 9, >= 0) => new PackageVersion("3.15.0")
                            ...
                            .WithNugetDependency("Quartz.Extensions.DependencyInjection", "3.15.0"),
                        ( >= 8, >= 0) => new PackageVersion("3.15.0")
