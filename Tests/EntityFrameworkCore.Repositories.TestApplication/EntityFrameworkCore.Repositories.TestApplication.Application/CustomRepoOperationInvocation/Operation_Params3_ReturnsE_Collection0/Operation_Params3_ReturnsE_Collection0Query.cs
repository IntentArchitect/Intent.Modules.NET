...
{
    public class Operation_Params3_ReturnsE_Collection0Query : IRequest<AggregateRoot1Dto>, IQuery
    {
        public Operation_Params3_ReturnsE_Collection0Query(byte[] attributeBinary,
            bool attributeBool,
            byte attributeByte,
