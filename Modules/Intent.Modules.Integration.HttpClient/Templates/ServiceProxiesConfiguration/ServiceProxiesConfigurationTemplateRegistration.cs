...
namespace Intent.Modules.Integration.HttpClient.Templates.ServiceProxiesConfiguration
{
    ...
    public class ServiceProxiesConfigurationTemplateRegistration : SingleFileListModelTemplateRegistration<ServiceProxyModel>
    {
        private readonly IMetadataManager _metadataManager;

        public ServiceProxiesConfigurationTemplateRegistration(IMetadataManager metadataManager)
        {
            _metadataManager = metadataManager;
        }

        public override string TemplateId => ServiceProxiesConfigurationTemplate.TemplateId;

        public override ITemplate CreateTemplateInstance(IOutputTarget outputTarget, IList<ServiceProxyModel> model)
        {
            return new ServiceProxiesConfigurationTemplate(outputTarget, model);
        }
