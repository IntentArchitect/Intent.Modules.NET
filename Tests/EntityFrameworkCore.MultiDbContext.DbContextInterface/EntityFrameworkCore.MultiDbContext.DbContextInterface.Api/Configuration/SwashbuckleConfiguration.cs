...
namespace EntityFrameworkCore.MultiDbContext.DbContextInterface.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("EntityFrameworkCore.MultiDbContext.DbContextInterface API");
