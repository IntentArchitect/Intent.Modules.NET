...
using EntityFrameworkCore.SqlServer.EF8.Domain.Repositories.Accounts.NotSchema;
...
using EntityFrameworkCore.SqlServer.EF8.Infrastructure.Repositories.SoftDelete;
using EntityFrameworkCore.SqlServer.EF8.Infrastructure.Repositories.TimeConcepts;
using EntityFrameworkCore.SqlServer.EF8.Infrastructure.Repositories.TPC.InheritanceAssociations;
using EntityFrameworkCore.SqlServer.EF8.Infrastructure.Repositories.TPC.Polymorphic;
using EntityFrameworkCore.SqlServer.EF8.Infrastructure.Repositories.TPH.InheritanceAssociations;
using EntityFrameworkCore.SqlServer.EF8.Infrastructure.Repositories.TPH.Polymorphic;
using EntityFrameworkCore.SqlServer.EF8.Infrastructure.Repositories.TPT.InheritanceAssociations;
using EntityFrameworkCore.SqlServer.EF8.Infrastructure.Repositories.TPT.Polymorphic;
using EntityFrameworkCore.SqlServer.EF8.Infrastructure.Repositories.ValueObjects;
...
namespace EntityFrameworkCore.SqlServer.EF8.Infrastructure
{
