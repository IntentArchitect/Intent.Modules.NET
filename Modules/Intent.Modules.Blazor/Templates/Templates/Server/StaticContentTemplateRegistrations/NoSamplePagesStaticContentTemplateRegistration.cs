...
namespace Intent.Modules.Blazor.Templates.Templates.Server.StaticContentTemplateRegistrations
{
    ...
    {
        public new const string TemplateId = "Intent.Modules.Blazor.Templates.Templates.Server.StaticContentTemplateRegistrations.NoSamplePagesStaticContentTemplateRegistration";
