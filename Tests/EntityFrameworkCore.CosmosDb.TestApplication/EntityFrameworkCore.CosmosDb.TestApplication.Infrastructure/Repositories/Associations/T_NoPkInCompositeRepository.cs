...
namespace EntityFrameworkCore.CosmosDb.TestApplication.Infrastructure.Repositories.Associations
{
    ...
    public class T_NoPkInCompositeRepository : RepositoryBase<T_NoPkInComposite, T_NoPkInComposite, ApplicationDbContext>, IT_NoPkInCompositeRepository
    {
        public T_NoPkInCompositeRepository(ApplicationDbContext dbContext, IMapper mapper) : base(dbContext, mapper)
        {
        }
        ...
        public async Task<T_NoPkInComposite?> FindByIdAsync(Guid id, CancellationToken cancellationToken = default)
        {
