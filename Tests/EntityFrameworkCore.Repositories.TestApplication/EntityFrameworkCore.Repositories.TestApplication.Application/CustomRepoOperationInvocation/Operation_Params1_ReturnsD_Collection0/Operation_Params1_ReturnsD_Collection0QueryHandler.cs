...
namespace EntityFrameworkCore.Repositories.TestApplication.Application.CustomRepoOperationInvocation.Operation_Params1_ReturnsD_Collection0
{
    ...
    public class Operation_Params1_ReturnsD_Collection0QueryHandler : IRequestHandler<Operation_Params1_ReturnsD_Collection0Query, SpResultDto>
    {
        ...
        public Operation_Params1_ReturnsD_Collection0QueryHandler(ICustomRepository customRepository, IMapper mapper)
        {
        ...
        {
            var result = _customRepository.Operation_Params1_ReturnsD_Collection0(new SpParameter(
