...
namespace Intent.Modules.MongoDb.MongoFramework.Templates.MongoDbUnitOfWorkInterface
{
    [IntentManaged(Mode.Fully, Body = Mode.Merge)]
    public partial class MongoDbUnitOfWorkInterfaceTemplate : CSharpTemplateBase<object>, ICSharpFileBuilderTemplate
    {
        public const string TemplateId = "Intent.MongoDb.MongoFramework.MongoDbUnitOfWorkInterface";
