...
namespace Intent.AspNetCore.OutputCaching.Redis.Api
{
    ...
    {
        public static CacheEviction GetCacheEviction(this QueryModel model)
        {
        ...
        public static bool HasCacheEviction(this QueryModel model)
        {
            return model.HasStereotype(CacheEviction.DefinitionId);
        }

        public static bool TryGetCacheEviction(this QueryModel model, out CacheEviction stereotype)
        {
        ...
        public static Caching GetCaching(this QueryModel model)
        {
        ...
        public static bool HasCaching(this QueryModel model)
        {
            return model.HasStereotype(Caching.DefinitionId);
        }

        public static bool TryGetCaching(this QueryModel model, out Caching stereotype)
        {
            if (!HasCaching(model))
            {
                stereotype = null;
