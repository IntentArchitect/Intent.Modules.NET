...
using System.Linq;
using Intent.Engine;
using Intent.Eventing.Contracts.EntityMapping.Api;
...
namespace Intent.Modules.Eventing.Contracts.EntityMapping.Templates.MessageExtensions
{
    [IntentManaged(Mode.Fully, Body = Mode.Merge)]
    partial class MessageExtensionsTemplate : CSharpTemplateBase<MessageModel>, ICSharpFileBuilderTemplate
    {
        public const string TemplateId = "Intent.Eventing.Contracts.EntityMapping.MessageExtensions";
