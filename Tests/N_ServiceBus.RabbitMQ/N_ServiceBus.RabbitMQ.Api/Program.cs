...
using N_ServiceBus.RabbitMQ.Api.Configuration;
using N_ServiceBus.RabbitMQ.Api.Filters;
using N_ServiceBus.RabbitMQ.Api.Logging;
using N_ServiceBus.RabbitMQ.Application;
using N_ServiceBus.RabbitMQ.Infrastructure;
using Serilog;
...
namespace N_ServiceBus.RabbitMQ.Api
{
