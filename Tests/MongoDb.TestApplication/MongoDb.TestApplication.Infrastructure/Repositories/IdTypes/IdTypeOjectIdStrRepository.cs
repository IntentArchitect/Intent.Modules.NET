...
{
    public class IdTypeOjectIdStrRepository : MongoRepositoryBase<IdTypeOjectIdStr, IdTypeOjectIdStr>, IIdTypeOjectIdStrRepository
    {
        public IdTypeOjectIdStrRepository(ApplicationMongoDbContext context) : base(context)
        {
        }
