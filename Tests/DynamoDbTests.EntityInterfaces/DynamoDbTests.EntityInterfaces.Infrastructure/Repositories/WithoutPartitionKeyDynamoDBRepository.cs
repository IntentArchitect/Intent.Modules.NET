...
{
    internal class WithoutPartitionKeyDynamoDBRepository : DynamoDBRepositoryBase<IWithoutPartitionKey, WithoutPartitionKey, WithoutPartitionKeyDocument, string, object>, IWithoutPartitionKeyRepository
    {
