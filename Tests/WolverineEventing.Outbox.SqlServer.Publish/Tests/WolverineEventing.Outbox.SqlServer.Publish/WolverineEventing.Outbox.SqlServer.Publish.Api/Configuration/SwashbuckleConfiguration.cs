...
using WolverineEventing.Outbox.SqlServer.Publish.Api.Filters;
using WolverineEventing.Outbox.SqlServer.Publish.Application;
using WolverineEventing.Outbox.SqlServer.Publish.Domain.Common.Exceptions;

[assembly: DefaultIntentManaged(Mode.Fully)]
[assembly: IntentTemplate("Intent.AspNetCore.Swashbuckle.SwashbuckleConfiguration", Version = "1.0")]

namespace WolverineEventing.Outbox.SqlServer.Publish.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("WolverineEventing.Outbox.SqlServer.Publish API");
