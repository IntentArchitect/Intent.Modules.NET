...
{
    public class Operation_Params3_ReturnsD_Collection0Query : IRequest<SpResultDto>, IQuery
    {
        public Operation_Params3_ReturnsD_Collection0Query(byte[] attributeBinary,
            bool attributeBool,
            byte attributeByte,
