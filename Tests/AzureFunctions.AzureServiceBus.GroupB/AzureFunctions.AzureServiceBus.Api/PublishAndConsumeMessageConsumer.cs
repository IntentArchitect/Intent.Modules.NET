...
{
    public class PublishAndConsumeMessageConsumer
    {
        private readonly IAzureServiceBusMessageDispatcher _dispatcher;
        private readonly ILogger<PublishAndConsumeMessageConsumer> _logger;
        private readonly IEventBus _eventBus;
        private readonly IServiceProvider _serviceProvider;
        private readonly IUnitOfWork _unitOfWork;

        public PublishAndConsumeMessageConsumer(IAzureServiceBusMessageDispatcher dispatcher,
            ILogger<PublishAndConsumeMessageConsumer> logger,
            IEventBus eventBus,
        ...
        [Function("PublishAndConsumeMessageConsumer")]
        public async Task Run(
            [ServiceBusTrigger("%AzureServiceBus:PublishAndConsume%", "%AzureServiceBus:PublishAndConsumeSubscription%", Connection = "AzureServiceBus:ConnectionString")] ServiceBusReceivedMessage message,
            CancellationToken cancellationToken)
        {
            ...
            {
                _logger.LogError(ex, "Error processing PublishAndConsumeMessageConsumer");
                throw;
            }
        }
    }
