...
using RichDomain.Api.Controllers.ResponseTypes;
using RichDomain.Application.People;
using RichDomain.Application.People.CreatePerson;
...
using RichDomain.Application.People.UpdatePersonPerson;
...
namespace RichDomain.Api.Controllers
{
    ...
    public class PeopleController : ControllerBase
    {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status500InternalServerError)]
        public async Task<ActionResult> UpdatePersonPerson(
            [FromRoute] Guid id,
