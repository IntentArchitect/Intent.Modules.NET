...
{
    public class GetTestNullabilityWithNullReturnEndpoint : Endpoint<GetTestNullabilityWithNullReturn, TestNullablityDto?>
    {
        private readonly ISender _mediator;

        public GetTestNullabilityWithNullReturnEndpoint(ISender mediator)
        {
        ...
        {
            Get("api/test-nullablity-with-null-return/{id}");
            Description(b =>
            {
                b.WithTags("TestNullablities");
                b.Accepts<GetTestNullabilityWithNullReturn>();
        ...
        public override async Task HandleAsync(GetTestNullabilityWithNullReturn req, CancellationToken ct)
        {
