...
{
    public class UpdateIntegrationTriggeringCommandValidatorTests
    {
        ...
        public async Task Validate_WithValidCommand_PassesValidation(UpdateIntegrationTriggeringCommand testCommand)
        {
            // Arrange
        ...
        {
            var fixture = new Fixture();
            fixture.Customize<UpdateIntegrationTriggeringCommand>(comp => comp.With(x => x.Value, () => default));
            var testCommand = fixture.Create<UpdateIntegrationTriggeringCommand>();
        ...
        private ValidationBehaviour<UpdateIntegrationTriggeringCommand, Unit> GetValidationBehaviour()
        {
            return new ValidationBehaviour<UpdateIntegrationTriggeringCommand, Unit>(new[] { new UpdateIntegrationTriggeringCommandValidator() });
        }
    }
}