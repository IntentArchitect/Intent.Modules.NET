...
{
    public class CreateOrderComboStaticCommand : IRequest<Guid>, ICommand
    {
        public CreateOrderComboStaticCommand(string refNo, DateTime orderDate, List<CreateOrderOrderItemDto> orderItems)
        {
            RefNo = refNo;
            OrderDate = orderDate;
