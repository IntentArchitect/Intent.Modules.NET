...
namespace Intent.QuartzScheduler.Api
{
    public static class ScheduledCommandPublishModelAssociationExtensions
    {
        ...
        public static IList<ScheduledCommandPublishTargetEndModel> ScheduledCommandPublishTargets(this ScheduledJobModel model)
        {
        ...
        [IntentManaged(Mode.Fully)]
        public static IList<ScheduledCommandPublishSourceEndModel> ScheduledJobs(this CommandModel model)
        {
            return model.InternalElement.AssociatedElements
