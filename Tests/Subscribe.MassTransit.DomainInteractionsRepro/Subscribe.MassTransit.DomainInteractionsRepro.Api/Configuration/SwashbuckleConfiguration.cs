...
using Subscribe.MassTransit.DomainInteractionsRepro.Domain.Common.Exceptions;
...
namespace Subscribe.MassTransit.DomainInteractionsRepro.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("Subscribe.MassTransit.DomainInteractionsRepro API");
