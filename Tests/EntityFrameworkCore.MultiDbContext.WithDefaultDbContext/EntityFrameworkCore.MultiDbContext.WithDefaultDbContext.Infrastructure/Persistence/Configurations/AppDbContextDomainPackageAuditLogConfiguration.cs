...
{
    public class AppDbContextDomainPackageAuditLogConfiguration : IEntityTypeConfiguration<AppDbContextDomainPackageAuditLog>
    {
        public void Configure(EntityTypeBuilder<AppDbContextDomainPackageAuditLog> builder)
        {
