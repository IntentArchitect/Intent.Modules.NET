...
namespace Intent.Modules.Blazor.Templates.Templates.Server.RazorServerPage
{
    ...
    public partial class RazorServerPageTemplate : ServerComponentRazorTemplateBase
    {
        /// <inheritdoc cref="IntentTemplateBase.Id"/>
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Intent.Blazor.Templates.Server.RazorServerPageTemplate";

        /// <summary>
        /// Creates a new instance of <see cref="RazorServerPageTemplate"/>.
        /// </summary>
        [IntentManaged(Mode.Fully, Body = Mode.Ignore)]
        public RazorServerPageTemplate(IOutputTarget outputTarget, ComponentModel model) : base(TemplateId, outputTarget, model)
        {
        }
        ...
        protected override string CodeBehindTemplateId => RazorServerPageCodeBehindTemplate.TemplateId;
    }
}
