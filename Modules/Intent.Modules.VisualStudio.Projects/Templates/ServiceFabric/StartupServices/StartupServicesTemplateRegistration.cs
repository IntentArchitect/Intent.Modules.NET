...
namespace Intent.Modules.VisualStudio.Projects.Templates.ServiceFabric.StartupServices
{
    ...
    public class StartupServicesTemplateRegistration : ITemplateRegistration
    {
        private readonly IMetadataManager _metadataManager;

        public StartupServicesTemplateRegistration(IMetadataManager metadataManager)
        {
            _metadataManager = metadataManager;
        }

        public string TemplateId => StartupServicesTemplate.TemplateId;
        ...
        public void DoRegistration(ITemplateInstanceRegistry registry, IApplication applicationManager)
        {
            ...
            foreach (var model in models)
            {
                ...
                registry.Register(TemplateId, project, p => new StartupServicesTemplate(p, model));
            }
        }
    }
}