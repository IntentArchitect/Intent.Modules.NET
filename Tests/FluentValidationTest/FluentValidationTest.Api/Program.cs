using FluentValidationTest.Api.Configuration;
using FluentValidationTest.Api.Filters;
using FluentValidationTest.Api.Logging;
using FluentValidationTest.Application;
using FluentValidationTest.Infrastructure;
...
namespace FluentValidationTest.Api
{
