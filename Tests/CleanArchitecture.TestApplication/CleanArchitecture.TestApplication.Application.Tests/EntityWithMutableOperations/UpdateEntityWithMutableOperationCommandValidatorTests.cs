...
{
    public class UpdateEntityWithMutableOperationCommandValidatorTests
    {
        ...
        public async Task Validate_WithValidCommand_PassesValidation(UpdateEntityWithMutableOperationCommand testCommand)
        {
            // Arrange
        ...
        {
            var fixture = new Fixture();
            fixture.Customize<UpdateEntityWithMutableOperationCommand>(comp => comp.With(x => x.Name, () => default));
            var testCommand = fixture.Create<UpdateEntityWithMutableOperationCommand>();
        ...
        public async Task Validate_WithInvalidCommand_FailsValidation(UpdateEntityWithMutableOperationCommand testCommand, string expectedPropertyName, string expectedPhrase)
        {
            // Arrange
            var validator = GetValidationBehaviour();
            // Act
        ...
        private ValidationBehaviour<UpdateEntityWithMutableOperationCommand, Unit> GetValidationBehaviour()
        {
            return new ValidationBehaviour<UpdateEntityWithMutableOperationCommand, Unit>(new[] { new UpdateEntityWithMutableOperationCommandValidator() });
        }
    }
}