...
{
    public class CreateAdvAggregateWithUniqueConstraintIndexStereotypeCommandEndpoint : Endpoint<CreateAdvAggregateWithUniqueConstraintIndexStereotypeCommand, JsonResponse<Guid>>
    {
        private readonly ISender _mediator;

        public CreateAdvAggregateWithUniqueConstraintIndexStereotypeCommandEndpoint(ISender mediator)
        {
        ...
        {
            Post("api/adv-unique-index-constraint-stereotype");
            Description(b =>
            {
                b.WithTags("UniqueIndexConstraintAdvancedMapping");
                b.Accepts<CreateAdvAggregateWithUniqueConstraintIndexStereotypeCommand>(MediaTypeNames.Application.Json);
        ...
        public override async Task HandleAsync(
            CreateAdvAggregateWithUniqueConstraintIndexStereotypeCommand req,
