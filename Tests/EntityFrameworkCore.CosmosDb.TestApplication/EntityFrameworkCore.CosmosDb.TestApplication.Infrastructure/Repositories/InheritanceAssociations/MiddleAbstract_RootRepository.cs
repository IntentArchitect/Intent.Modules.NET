...
namespace EntityFrameworkCore.CosmosDb.TestApplication.Infrastructure.Repositories.InheritanceAssociations
{
    ...
    {
        public MiddleAbstract_RootRepository(ApplicationDbContext dbContext, IMapper mapper) : base(dbContext, mapper)
        {
        }
        ...
        public async Task<MiddleAbstract_Root?> FindByIdAsync(
            Guid id,
            Func<IQueryable<MiddleAbstract_Root>, IQueryable<MiddleAbstract_Root>> queryOptions,
            CancellationToken cancellationToken = default)
        {
