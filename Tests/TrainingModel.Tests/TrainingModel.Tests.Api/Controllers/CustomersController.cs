...
using TrainingModel.Tests.Application.Customers;
using TrainingModel.Tests.Application.Customers.CreateCustomer;
using TrainingModel.Tests.Application.Customers.DeleteCustomer;
using TrainingModel.Tests.Application.Customers.GetCustomerById;
using TrainingModel.Tests.Application.Customers.GetCustomers;
using TrainingModel.Tests.Application.Customers.GetCustomersPaginated;
using TrainingModel.Tests.Application.Customers.UpdateCustomer;
...
namespace TrainingModel.Tests.Api.Controllers
{
    ...
    public class CustomersController : ControllerBase
    {
        ...
        /// <response code="400">One or more validation errors have occurred.</response>
        [HttpGet("api/customer/paginated")]
        ...
        public async Task<ActionResult<PagedResult<CustomerDto>>> GetCustomersPaginated(
            ...
            CancellationToken cancellationToken = default)
        {
            var result = await _mediator.Send(new GetCustomersPaginatedQuery(pageNo: pageNo, pageSize: pageSize), cancellationToken);
            return Ok(result);
        }
