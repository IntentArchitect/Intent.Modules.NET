...
namespace AdvancedMappingCrud.RichDomain.ServiceModel.Tests.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("AdvancedMappingCrud.RichDomain.ServiceModel.Tests API");
