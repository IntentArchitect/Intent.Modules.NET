...
{
    internal class ManualWithValueCosmosDBRepository : CosmosDBRepositoryBase<IManualWithValue, ManualWithValue, ManualWithValueDocument, IManualWithValueDocument>, IManualWithValueRepository
    {
        ...
        public async Task<IManualWithValue?> FindByIdAsync(string id, CancellationToken cancellationToken = default) => await base.FindByIdAsync(id: id, cancellationToken: cancellationToken);
    }
}